...
`).filter(e=>e.includes(`X =`)),n=[];t.forEach((e,t)=>{let r=e.split(/[X,Y,Z, =]/).filter(e=>e.trim()),i=parseFloat(r[0]),a=parseFloat(r[1]),o=parseFloat(r[2]);n.push({x:i,y:a,z:o,day:t+1})}),l.pathPoints=Pm(n.map(e=>new W(e.x*90,e.z*90,e.y*90)).reverse()),l.todayRow=Kf(new Date),await Rm(o,l)}else console.error(`データの取得に失敗しました:`,e)}catch(e){console.error(`API呼び出し中にエラーが発生しました:`,e)}finally{return l}},Hm=({parent:e,commandKey:t,planetPositionsRes:n,radius:r=1,color:i})=>{let a=new ni(new ma(r,32,32),new Wr({color:i??Tm(t),depthTest:!1,depthWrite:!1}));a.name=`${t}-current-position`,a.renderOrder=999;let{pathPoints:o,todayRow:s}=n,c=o.length-1,l=s-1,u=Cm(t),d=Math.floor(l/u)%c,f=(d+1)%c,p=l%u/u,m=o[d],h=o[f],g=new W().fromArray(m.toArray()).lerp(new W().fromArray(h.toArray()),p);return a.position.copy(g),e.add(a),a},$={PLANET_NAME:`Planet`,PLANET_ORBIT_NAME:`PlanetOrbit`,PLANET_RING_NAME:`PlanetRing`,PLANET_AXIS_NAME:`PlanetAxis`,PLANET_SYSTEM_NAME:`PlanetSystem`,PLANET_ATMO_SPHERE_NAME:`PlanetAtmosphere`,PLANET_MOONS_NAME:`PlanetMoons`,PLANET_LABEL_NAME:`PlanetLabel`},Um={MERCURY:`Mercury（水星）`,VENUS:`Venus（金星）`,EARTH:`Earth（地球）`,MARS:`Mars（火星）`,JUPITER:`Jupiter（木星）`,SATURN:`Saturn（土星）`,URANUS:`Uranus（天王星）`,NEPTUNE:`Neptune（海王星）`,PLUTO:`Pluto（冥王星）`},Wm=(e,t,n,r,i,a,o,s,c,l,u,d=!1)=>{let f=new oo,p;p=a instanceof Fr?a:o?new Da({map:f.load(Om(a)),bumpMap:f.load(Om(o)),bumpScale:.7}):new Da({map:f.load(Om(a))});let m=new ni(new ma(n,32,20),p);m.rotation.z=Em(r),m.castShadow=!0,m.receiveShadow=!0,m.name=$.PLANET_NAME;let h=new On;h.name=$.PLANET_SYSTEM_NAME;let g=u.pathPoints.length-1,_=u.todayRow-1,v=Cm(e),y=Math.floor(_/v)%g,b=(y+1)%g,x=_%v/v,S=u.pathPoints[y],C=u.pathPoints[b],w=new W().fromArray(S.toArray()).lerp(new W().fromArray(C.toArray()),x);h.position.copy(w),h.add(m);let T=document.createElement(`div`);T.className=`planet-name-label`,T.textContent=Um[e]??t;let E=new af(T);E.name=$.PLANET_LABEL_NAME,E.position.set(0,n+3,0),h.add(E);let D=document.createElement(`div`);D.className=`planet-tilt-label`,D.textContent=`傾き: ${r}°`;let O=new af(D);O.name=$.PLANET_LABEL_NAME,O.position.set(0,-(n+3),0),h.add(O);{let e=.1,t=new ni(new la(e,e,2.8*n,32),new Wr({color:65280}));t.name=$.PLANET_AXIS_NAME,t.rotation.z=Em(r),h.add(t)}if(s){let e=new ni(new pa(s.innerRadius,s.outerRadius,30),new Ta({map:f.load(Om(s.texture)),side:2}));e.name=$.PLANET_RING_NAME,e.rotation.x=Em(90),e.rotation.y=Em(r),h.add(e);let t=3.6;e.scale.set(t,t,t)}if(c){let e=new ni(new ma(n+.1,32,20),new Da({map:f.load(Om(c)),transparent:!0,opacity:.4,depthTest:!0,depthWrite:!1}));e.name=$.PLANET_ATMO_SPHERE_NAME,e.rotation.z=.41,m.add(e)}let k=0;for(let e of l){let t;if(e.texture===void 0)continue;t=e.bump?new Ta({map:f.load(Om(e.texture)),bumpMap:f.load(Om(e.bump)),bumpScale:.5}):new Ta({map:f.load(Om(e.texture))});let r=new ni(new ma(e.size,32,20),t);r.name=`${$.PLANET_MOONS_NAME}_${k}`,r.castShadow=!0,r.receiveShadow=!0,k++;let i=n*1.5;r.position.set(i,0,0),h.add(r),e.mesh=r}let A=new On;A.add(h),A.name=t,A.userData={planetPositionsRes:u};let ee=new Gi(new Ar().setFromPoints(u.pathPoints),new Li({color:i,transparent:!0,opacity:.2}));return ee.name=$.PLANET_ORBIT_NAME,A.add(ee),d&&Hm({parent:A,commandKey:e,planetPositionsRes:u}),A},Gm={MOON:`${$.PLANET_MOONS_NAME}_Moon`},Km=[{size:Np,texture:`/images/moonmap.jpg`,bump:`/images/moonbump.jpg`,orbitSpeed:.001*Q.accelerationOrbit,orbitRadius:10,orbitalPeriodDays:27.322}],qm=async(e,t)=>{let n=new oo,r=new Ca({uniforms:{dayTexture:{value:n.load(Om(`/images/earth_daymap.jpg`))},nightTexture:{value:n.load(Om(`/images/earth_nightmap.jpg`))},sunPosition:{value:e}},vertexShader:`
      ...
      `}),i=await Vm(`EARTH`),a=Wm(`EARTH`,jp,kp,Ap,Tm(`EARTH`),r,null,null,`/images/earth_atmosphere.jpg`,Km,i,t),o=a.getObjectByName($.PLANET_SYSTEM_NAME).children.find(e=>e.name.startsWith($.PLANET_MOONS_NAME));return o&&(o.name=Gm.MOON),a},Jm=(e,t,n)=>{let r=window.innerWidth,i=window.innerHeight;t.setSize(r,i),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),n?.setSize(r,i),e.aspect=r/i,e.updateProjectionMatrix()},Ym=e=>{let t=new Date().getFullYear();return yp(yf(new Date(t,0,1),e),`yyyy年MM月dd日`)},Xm=e=>{let t=document.createElement(`div`);t.className=`current-index-label`,t.setAttribute(`aria-live`,`polite`);let n=document.createElement(`span`);n.className=`current-index-label__caption`,n.textContent=`現在日付`;let r=document.createElement(`span`);return r.className=`current-index-label__value`,r.textContent=Ym(e),t.append(n,r),t},Zm=(e,t)=>{let n=e.querySelector(`.current-index-label__value`);n&&(n.textContent=Ym(t))},Qm={...Q},$m=null,eh=null,th=null,nh=null,rh=null,ih=null,ah=!1,oh=0,sh=!1,ch=()=>{!eh||!th||!nh||(eh.classList.toggle(`is-collapsed`,ah),th.hidden=ah,nh.textContent=ah?`展開`:`折りたたむ`,nh.setAttribute(`aria-expanded`,String(!ah)))},lh=()=>{rh&&(rh.textContent=Q.isAnimating?`アニメーション停止`:`アニメーション再生`,rh.classList.toggle(`is-active`,Q.isAnimating),rh.setAttribute(`aria-pressed`,String(Q.isAnimating)),rh.title=sh?`惑星ズーム中は操作できません`:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,ih?.classList.toggle(`is-animating`,Q.isAnimating))},uh=e=>{oh=e,ih&&Zm(ih,e)},dh=e=>{sh=e,rh&&(rh.disabled=e,rh.classList.toggle(`is-disabled`,e),rh.setAttribute(`aria-disabled`,String(e)),lh())},fh=()=>{$m&&($m.lerpFrame.value=String(Q.lerpFrame),$m.lerpFrameValue.value=String(Q.lerpFrame),$m.lerpFrameValue.textContent=String(Q.lerpFrame),$m.accelerationOrbit.value=String(Q.accelerationOrbit),$m.accelerationOrbitValue.value=String(Q.accelerationOrbit),$m.accelerationOrbitValue.textContent=String(Q.accelerationOrbit),$m.accelerationRotation.value=String(Q.accelerationRotation),$m.accelerationRotationValue.value=String(Q.accelerationRotation),$m.accelerationRotationValue.textContent=String(Q.accelerationRotation),$m.sunIntensity.value=String(Q.sunIntensity),$m.sunIntensityValue.value=String(Q.sunIntensity),$m.sunIntensityValue.textContent=String(Q.sunIntensity),lh(),$m.showOrbits.checked=Q.showOrbits,$m.showLabels.checked=Q.showLabels,$m.showPlanets.checked=Q.showPlanets,uh(oh),ch())},ph=e=>{let{label:t,min:n,max:r,step:i,value:a,onChange:o}=e,s=document.createElement(`label`);s.className=`settings-menu__row settings-menu__row--range`;let c=document.createElement(`span`);c.className=`settings-menu__label`,c.textContent=t;let l=document.createElement(`input`);l.type=`range`,l.min=String(n),l.max=String(r),l.step=String(i),l.value=String(a),l.className=`settings-menu__range`;let u=document.createElement(`output`);return u.className=`settings-menu__value`,u.value=String(a),u.textContent=String(a),l.addEventListener(`input`,()=>{let e=Number(l.value);u.value=l.value,u.textContent=l.value,o(e)}),s.append(c,l,u),{row:s,input:l,output:u}},mh=e=>{let{label:t,checked:n,onChange:r}=e,i=document.createElement(`label`);i.className=`settings-menu__row settings-menu__row--toggle`;let a=document.createElement(`input`);a.type=`checkbox`,a.checked=n,a.className=`settings-menu__checkbox`,a.addEventListener(`change`,()=>r(a.checked));let o=document.createElement(`span`);return o.className=`settings-menu__label`,o.textContent=t,i.append(a,o),{row:i,input:a}},hh=e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`settings-menu__button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick),t},gh=(e,t,n,r)=>{e.setSize(n,r),e.setClearColor(0,1),document.body.appendChild(e.domElement),t.background=new ao().load([Om(`/images/3.jpg`),Om(`/images/1.jpg`),Om(`/images/2.jpg`),Om(`/images/2.jpg`),Om(`/images/4.jpg`),Om(`/images/2.jpg`)]);let i=new df;i.setSize(n,r),i.domElement.style.position=`absolute`,i.domElement.style.top=`0`,i.domElement.style.left=`0`,i.domElement.style.pointerEvents=`none`,i.domElement.style.zIndex=`10`,document.body.appendChild(i.domElement);let a=new bo(50,n/r,1,5e3);a.position.set(0,20,122),Jm(a,e,i),window.addEventListener(`resize`,()=>Jm(a,e,i));let o=new Au(a,e.domElement),s=yh(e,t,a,n,r);return vh(t),{camera:a,controls:o,composer:s,labelRenderer:i}},_h=e=>{e.reset()},vh=e=>{let t=new Oo(2236962,10);e.add(t)},yh=(e,t,n,r,i)=>{let a=new $d(e);a.addPass(new tf(t,n));let o=new ef(new U(r,i),t,n);o.edgeStrength=3,o.edgeGlow=1,o.visibleEdgeColor.set(16777215),o.hiddenEdgeColor.set(1640965),a.addPass(o);let s=new rf(new U(r,i),1,.4,.85);return s.threshold=1,s.radius=.9,a.addPass(s),a},bh=e=>{let{sunMesh:t,camera:n,controls:r,onExitPlanetZoom:i,setDayIndex:a,setDayFraction:o,setFrameCount:s,userDataEarthPositionRes:c,currentIndex:l}=e,u=document.createElement(`section`);u.className=`settings-menu`,u.setAttribute(`aria-label`,`表示設定メニュー`);let d=document.createElement(`header`);d.className=`settings-menu__header`;let f=document.createElement(`div`);f.className=`settings-menu__heading`;let p=document.createElement(`p`);p.className=`settings-menu__title`,p.textContent=`表示設定`,f.append(p);let m=Xm(l),h=document.createElement(`button`);h.type=`button`,h.className=`settings-menu__collapse-button`,h.addEventListener(`click`,()=>{ah=!ah,ch()}),d.append(f,m,h);let g=document.createElement(`div`);g.className=`settings-menu__sections`;let _=document.createElement(`section`);_.className=`settings-menu__section`;let v=ph({label:`1日のフレーム数`,min:30,max:600,step:30,value:Q.lerpFrame,onChange:e=>{Q.lerpFrame=e}}),y=ph({label:`公転スピード`,min:0,max:10,step:.1,value:Q.accelerationOrbit,onChange:e=>{Q.accelerationOrbit=e}}),b=ph({label:`自転スピード`,min:0,max:10,step:.1,value:Q.accelerationRotation,onChange:e=>{Q.accelerationRotation=e}}),x=ph({label:`太陽光強度`,min:0,max:10,step:.1,value:Q.sunIntensity,onChange:e=>{Q.sunIntensity=e,t.material.emissiveIntensity=e}}),S=hh({label:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,onClick:()=>{Q.isAnimating=!Q.isAnimating,lh()}});S.classList.add(`settings-menu__button--primary`),S.setAttribute(`aria-pressed`,String(Q.isAnimating)),_.append(v.row,y.row,b.row,x.row,S);let C=document.createElement(`section`);C.className=`settings-menu__section`;let w=mh({label:`公転軌道表示`,checked:Q.showOrbits,onChange:e=>{Q.showOrbits=e}}),T=mh({label:`惑星名ラベル表示`,checked:Q.showLabels,onChange:e=>{Q.showLabels=e}}),E=mh({label:`惑星表示`,checked:Q.showPlanets,onChange:e=>{Q.showPlanets=e}});C.append(w.row,T.row,E.row);let D=document.createElement(`section`);D.className=`settings-menu__section settings-menu__section--actions`,D.append(hh({label:`トップビュー`,onClick:()=>{i(),n.position.set(0,190,.01),r.target.set(0,0,0),r.update()}}),hh({label:`サイドビュー`,onClick:()=>{i(),n.position.set(190,0,.01),r.target.set(0,0,0),r.update()}}),hh({label:`視点リセット`,onClick:()=>{i(),_h(r)}}),hh({label:`設定を初期化`,onClick:()=>{Q.lerpFrame=Qm.lerpFrame,Q.accelerationOrbit=Qm.accelerationOrbit,Q.accelerationRotation=Qm.accelerationRotation,Q.sunIntensity=Qm.sunIntensity,Q.isAnimating=Qm.isAnimating,Q.showOrbits=Qm.showOrbits,Q.showLabels=Qm.showLabels,Q.showPlanets=Qm.showPlanets,t.material.emissiveIntensity=Q.sunIntensity;let e=c.todayRow-1;a(e),o(0),s(0),uh(e),fh()}})),g.append(_,C,D),u.append(d,g),document.body.appendChild(u),eh=u,th=g,nh=h,rh=S,ih=m,uh(l),dh(!1),$m={lerpFrame:v.input,lerpFrameValue:v.output,accelerationOrbit:y.input,accelerationOrbitValue:y.output,accelerationRotation:b.input,accelerationRotationValue:b.output,sunIntensity:x.input,sunIntensityValue:x.output,isAnimating:S,showOrbits:w.input,showLabels:T.input,showPlanets:E.input},fh()},xh={IO:`${$.PLANET_MOONS_NAME}_Io`,EUROPA:`${$.PLANET_MOONS_NAME}_Europa`,GANYMEDE:`${$.PLANET_MOONS_NAME}_Ganymede`,CALLISTO:`${$.PLANET_MOONS_NAME}_Callisto`},Sh=[{size:kp*.29,texture:`/images/jupiterIo.jpg`,orbitRadius:20,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.8,xPosition:80},{size:kp*.24,texture:`/images/jupiterEuropa.jpg`,orbitRadius:24,orbitSpeed:25e-5*Q.accelerationOrbit,orbitalPeriodDays:3.5,xPosition:90},{size:kp*.41,texture:`/images/jupiterGanymede.jpg`,orbitRadius:28,orbitSpeed:125e-6*Q.accelerationOrbit,orbitalPeriodDays:7.1,xPosition:110},{size:kp*.34,texture:`/images/jupiterCallisto.jpg`,orbitRadius:32,orbitSpeed:6e-5*Q.accelerationOrbit,orbitalPeriodDays:16.7,xPosition:140}],Ch=async e=>{let t=await Vm(`JUPITER`),n=Wm(`JUPITER`,rm,tm,nm,Tm(`JUPITER`),`/images/jupiter.jpg`,null,null,null,Sh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=xh.IO),e===1&&(t.name=xh.EUROPA),e===2&&(t.name=xh.GANYMEDE),e===3&&(t.name=xh.CALLISTO),t.position.set(Sh[e].xPosition??0,0,0);return n},wh={PHOBOS:`${$.PLANET_MOONS_NAME}_Phobos`,DEIMOS:`${$.PLANET_MOONS_NAME}_Deimos`},Th=[{size:.1,orbitRadius:5,orbitSpeed:.002*Q.accelerationOrbit,orbitalPeriodDays:.319,modelPath:`/images/mars/phobos.glb`,xPosition:6},{size:.1,orbitRadius:12.5,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.263,modelPath:`/images/mars/deimos.glb`,xPosition:14}],Eh=async e=>{let t=await Vm(`MARS`),n=Wm(`MARS`,$p,Zp,Qp,Tm(`MARS`),`/images/marsmap.jpg`,`/images/marsbump.jpg`,null,null,[],t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME);for(let[e,t]of Th.entries())t.modelPath!==void 0&&(t.mesh=(await km(t.modelPath)).children[0],e===0&&(t.mesh.name=wh.PHOBOS),e===1&&(t.mesh.name=wh.DEIMOS),t.mesh.scale.set(t.size,t.size,t.size),t.mesh.position.set(t.xPosition??0,0,0),t.mesh.castShadow=!0,t.mesh.receiveShadow=!0,r.add(t.mesh));return n},Dh=async e=>{let t=await Vm(`MERCURY`);return Wm(`MERCURY`,Gp,Wp,40,Tm(`MERCURY`),`/images/mercurymap.jpg`,`/images/mercurybump.jpg`,null,null,[],t,e)},Oh={TRITON:`${$.PLANET_MOONS_NAME}_Triton`,PROTEUS:`${$.PLANET_MOONS_NAME}_Proteus`,NEREID:`${$.PLANET_MOONS_NAME}_Nereid`},kh=[{size:kp*.21,texture:`/images/Triton-tok.webp`,orbitRadius:14,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:5.88,xPosition:120,retrograde:!0},{size:kp*.033,texture:`/images/Proteus.webp`,orbitRadius:10,orbitSpeed:35e-5*Q.accelerationOrbit,orbitalPeriodDays:1.12,xPosition:150},{size:kp*.053,texture:`/images/Nereidimproved.webp`,orbitRadius:18,orbitSpeed:8e-5*Q.accelerationOrbit,orbitalPeriodDays:360.14,xPosition:210}],Ah=async e=>{let t=await Vm(`NEPTUNE`),n=Wm(`NEPTUNE`,hm,pm,mm,Tm(`NEPTUNE`),`/images/neptune.jpg`,null,null,null,kh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Oh.TRITON),e===1&&(t.name=Oh.PROTEUS),e===2&&(t.name=Oh.NEREID),t.position.set(kh[e].xPosition??0,0,0);return n},jh=e=>{let{renderer:t,camera:n,controls:r,planets:i,onResetView:a}=e,o=new Zo,s=new U,c=null,l=!1,u=Q.isAnimating,d=document.createElement(`button`),f=`PlanetHoverRimLight`,p=new Ca({uniforms:{rimColor:{value:new J(10080767)},rimPower:{value:2.6}},vertexShader:`
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1}),m=e=>{let n=t.domElement.getBoundingClientRect();s.x=(e.clientX-n.left)/n.width*2-1,s.y=-((e.clientY-n.top)/n.height)*2+1};d.type=`button`,d.className=`planet-zoom-close-button`,d.textContent=`視点をリセット`,d.title=`視点をリセット`,d.setAttribute(`aria-label`,`視点をリセット`),d.hidden=!0,d.addEventListener(`click`,()=>{a()}),document.body.appendChild(d);let h=(e,t)=>{let n=e.getObjectByName(f);if(t){if(n)return;let t=new ni(e.geometry,p);t.name=f,t.scale.setScalar(1.04),e.add(t);return}n&&e.remove(n)},g=()=>{c&&=(h(c,!1),null)},_=()=>l?(g(),l=!1,Q.isAnimating=u,fh(),dh(!1),d.hidden=!0,!0):!1,v=()=>{d.hidden=!1},y=e=>{let t=new W;e.getWorldPosition(t);let i=e.geometry;i.computeBoundingSphere();let a=i.boundingSphere?.radius??1,o=new W;e.getWorldScale(o);let s=a*Math.max(o.x,o.y,o.z)/Math.tan(Em(n.fov)/2)*1.35,c=new W().subVectors(n.position,r.target);c.lengthSq()===0&&c.set(0,0,1),c.normalize(),n.position.copy(t).add(c.multiplyScalar(s)),r.target.copy(t),r.update()};return{handleDoubleClickPlanetZoom:e=>{m(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1);if(t.length===0)return;let r=t[0].object;l||(u=Q.isAnimating,Q.isAnimating=!1,fh(),l=!0,dh(!0)),v(),y(r)},handlePlanetHover:e=>{m(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1)[0]?.object;if(!(t instanceof ni)){g();return}c!==t&&(g(),c=t,h(t,!0))},clearPlanetHover:g,exitPlanetZoom:_}},Mh={TITAN:`${$.PLANET_MOONS_NAME}_Titan`,RHEA:`${$.PLANET_MOONS_NAME}_Rhea`,IAPETUS:`${$.PLANET_MOONS_NAME}_Iapetus`,MIMAS:`${$.PLANET_MOONS_NAME}_Mimas`,ENCELADUS:`${$.PLANET_MOONS_NAME}_Enceladus`},Nh=[{size:kp*.4,texture:`/images/RS3_Titan.webp`,orbitRadius:16,orbitSpeed:9e-5*Q.accelerationOrbit,orbitalPeriodDays:15.95,xPosition:137},{size:kp*.12,texture:`/images/RS3_Rhea.webp`,orbitRadius:12,orbitSpeed:18e-5*Q.accelerationOrbit,orbitalPeriodDays:4.52,xPosition:116},{size:kp*.115,texture:`/images/LapetusNew.webp`,orbitRadius:22,orbitSpeed:1e-5*Q.accelerationOrbit,orbitalPeriodDays:79.3,xPosition:180},{size:kp*.031,texture:`/images/RS3_Mimas.webp`,orbitRadius:8,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:.942,xPosition:102},{size:kp*.04,texture:`/images/Enceladus.webp`,orbitRadius:10,orbitSpeed:45e-5*Q.accelerationOrbit,orbitalPeriodDays:1.37,xPosition:110}],Ph=async e=>{let t=await Vm(`SATURN`),n=Wm(`SATURN`,sm,am,om,Tm(`SATURN`),`/images/saturnmap.jpg`,null,{innerRadius:18,outerRadius:29,texture:`/images/saturn_ring.png`},null,Nh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Mh.TITAN),e===1&&(t.name=Mh.RHEA),e===2&&(t.name=Mh.IAPETUS),e===3&&(t.name=Mh.MIMAS),e===4&&(t.name=Mh.ENCELADUS),t.position.set(Nh[e].xPosition??0,0,0);return n},Fh=`Sun`,Ih=new Ta({emissive:Rp,emissiveMap:new oo().load(Om(`/images/sun.jpg`)),emissiveIntensity:Q.sunIntensity}),Lh=()=>{let e=new ni(new ma(Ip,32,20),Ih);e.name=Fh;let t=new wo(zp,100,0,Bp),n=new wo(Vp,20,Hp,Up);return e.add(t),e.add(n),e},Rh={MIRANDA:`${$.PLANET_MOONS_NAME}_Miranda`,ARIEL:`${$.PLANET_MOONS_NAME}_Ariel`,UMBRIEL:`${$.PLANET_MOONS_NAME}_Umbriel`,TITANIA:`${$.PLANET_MOONS_NAME}_Titania`,OBERON:`${$.PLANET_MOONS_NAME}_Oberon`},zh=[{size:kp*.037,texture:`/images/Miranda-0.webp`,orbitRadius:10,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:1.41,xPosition:58},{size:kp*.084,texture:`/images/Ariel-0.webp`,orbitRadius:10,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:2.52,xPosition:90},{size:kp*.07,texture:`/images/Uranus-0.webp`,orbitRadius:10,orbitSpeed:4e-4*Q.accelerationOrbit,orbitalPeriodDays:4.14,xPosition:120},{size:kp*.11,texture:`/images/Titaniamap.webp`,orbitRadius:10,orbitSpeed:3e-4*Q.accelerationOrbit,orbitalPeriodDays:8.71,xPosition:150},{size:kp*.105,texture:`/images/Oberonmap1.webp`,orbitRadius:10,orbitSpeed:2e-4*Q.accelerationOrbit,orbitalPeriodDays:13.46,xPosition:180}],Bh=async e=>{let t=await Vm(`URANUS`),n=Wm(`URANUS`,dm,lm,um,Tm(`URANUS`),`/images/uranus.jpg`,null,{innerRadius:8,outerRadius:10,texture:`/images/uranus_ring.png`},null,zh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Rh.MIRANDA),e===1&&(t.name=Rh.ARIEL),e===2&&(t.name=Rh.UMBRIEL),e===3&&(t.name=Rh.TITANIA),e===4&&(t.name=Rh.OBERON),t.position.set(zh[e].xPosition??0,0,0);return n},Vh=async e=>{let t=await Vm(`VENUS`);return Wm(`VENUS`,Yp,qp,Jp,Tm(`VENUS`),`/images/venusmap.jpg`,`/images/venusbump.jpg`,null,`/images/venus_atmosphere.jpg`,[],t,e)};function Hh(e,t,n){let{earthPlanetSystem:r,earthPlanet:i,earthAtmosphere:a,moon:o}=t;{let t=n.pathPoints.length-1,o=e.dayIndex%t,s=n.pathPoints[o],c=(o+1)%t,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Em(360/Q.lerpFrame*Q.accelerationRotation);i.rotateY(u),a.rotateY(u+Fp)}{let t=Em(5),n=Em(360/(Pp*Q.lerpFrame)*Q.accelerationOrbit),r=e.frameCount*n,{orbitRadius:i}=Km[0],a=i*Math.cos(r),s=i*Math.sin(r)*Math.sin(t),c=i*Math.sin(r)*Math.cos(t);o.position.set(-a,s,c);let l=n;o.rotateY(l)}}function Uh(e,t,n){let{mercuryPlanetSystem:r,mercuryPlanet:i}=t,a=n.pathPoints.length-1,o=e.dayIndex%a,s=n.pathPoints[o],c=(o+1)%a,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Em(360/(Q.lerpFrame*Bm(`MERCURY`))*Q.accelerationRotation);i.rotateY(u)}function Wh(e,t,n){let{venusPlanetSystem:r,venusPlanet:i,venusAtmosphere:a}=t,o=n.pathPoints.length-1,s=e.dayIndex%o,c=n.pathPoints[s],l=(s+1)%o,u=n.pathPoints[l];e.buf.copy(c).lerp(u,e.dayFraction),r.position.copy(e.buf);let d=Em(360/(Q.lerpFrame*Bm(`VENUS`))*Q.accelerationRotation);i.rotateY(d),a.rotateY(d*60)}function Gh(e,t,n){let{marsPlanetSystem:r,marsPlanet:i,phobos:a,deimos:o}=t,s=Cm(`MARS`),c=n.pathPoints.length-1,l=e.dayIndex+e.dayFraction,u=Math.floor(l/s)%c,d=n.pathPoints[u],f=(u+1)%c,p=n.pathPoints[f],m=l%s/s;e.buf.copy(d).lerp(p,m),r.position.copy(e.buf);let h=Em(360/(Q.lerpFrame*Bm(`MARS`))*Q.accelerationRotation);i.rotateY(h);let g=Th[0].orbitRadius,_=Th[1].orbitRadius,v=e.frameCount*Q.accelerationOrbit*4,y=e.frameCount*Q.accelerationOrbit*1,b=g*Math.cos(v),x=g*Math.sin(v);a.position.set(-b,0,x);let S=_*Math.cos(y),C=_*Math.sin(y);o.position.set(-S,0,C)}function Kh(e,t,n){let{jupiterPlanetSystem:r,jupiterPlanet:i,io:a,europa:o,ganymede:s,callisto:c}=t,l=Cm(`JUPITER`),u=n.pathPoints.length-1,d=e.dayIndex+e.dayFraction,f=Math.floor(d/l)%u,p=n.pathPoints[f],m=(f+1)%u,h=n.pathPoints[m],g=d%l/l;e.buf.copy(p).lerp(h,g),r.position.copy(e.buf);let _=Em(360/(Q.lerpFrame*Bm(`JUPITER`))*Q.accelerationRotation);i.rotateY(_);{let t=Sh[0].orbitRadius+(Sh[0].xPosition??0),n=Sh[1].orbitRadius+(Sh[1].xPosition??0),r=Sh[2].orbitRadius+(Sh[2].xPosition??0),i=Sh[3].orbitRadius+(Sh[3].xPosition??0),l=e.frameCount*Q.accelerationOrbit*(1/Sh[0].orbitalPeriodDays),u=e.frameCount*Q.accelerationOrbit*(1/Sh[1].orbitalPeriodDays),d=e.frameCount*Q.accelerationOrbit*(1/Sh[2].orbitalPeriodDays),f=e.frameCount*Q.accelerationOrbit*(1/Sh[3].orbitalPeriodDays),p=t*Math.cos(l),m=t*Math.sin(l);a.position.set(-p,0,m);let h=n*Math.cos(u),g=n*Math.sin(u);o.position.set(-h,0,g);let _=r*Math.cos(d),v=r*Math.sin(d);s.position.set(-_,0,v);let y=i*Math.cos(f),b=i*Math.sin(f);c.position.set(-y,0,b)}}function qh(e,t,n){let{saturnPlanetSystem:r,saturnPlanet:i,titan:a,rhea:o,iapetus:s,mimas:c,enceladus:l}=t,u=Cm(`SATURN`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Em(360/(Q.lerpFrame*Bm(`SATURN`))*Q.accelerationRotation);i.rotateY(v);{let t=Em(om),n=Nh[0].orbitRadius+(Nh[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Nh[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Nh[1].orbitRadius+(Nh[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Nh[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Nh[2].orbitRadius+(Nh[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Nh[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Nh[3].orbitRadius+(Nh[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Nh[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let ee=Nh[4].orbitRadius+(Nh[4].xPosition??0),te=e.frameCount*Q.accelerationOrbit*(1/Nh[4].orbitalPeriodDays),j=-ee*Math.cos(te),ne=ee*Math.sin(te),re=j*Math.cos(t),M=j*Math.sin(t);l.position.set(re,M,ne)}}function Jh(e,t,n){let{uranusPlanetSystem:r,uranusPlanet:i,miranda:a,ariel:o,umbriel:s,titania:c,oberon:l}=t,u=Cm(`URANUS`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Em(360/(Q.lerpFrame*Bm(`URANUS`))*Q.accelerationRotation);i.rotateY(v);{let t=Em(um),n=zh[0].orbitRadius+(zh[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/zh[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=zh[1].orbitRadius+(zh[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/zh[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=zh[2].orbitRadius+(zh[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/zh[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=zh[3].orbitRadius+(zh[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/zh[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let ee=zh[4].orbitRadius+(zh[4].xPosition??0),te=e.frameCount*Q.accelerationOrbit*(1/zh[4].orbitalPeriodDays),j=-ee*Math.cos(te),ne=ee*Math.sin(te),re=j*Math.cos(t),M=j*Math.sin(t);l.position.set(re,M,ne)}}function Yh(e,t,n){let{neptunePlanetSystem:r,neptunePlanet:i,triton:a,proteus:o,nereid:s}=t,c=Cm(`NEPTUNE`),l=n.pathPoints.length-1,u=e.dayIndex+e.dayFraction,d=Math.floor(u/c)%l,f=n.pathPoints[d],p=(d+1)%l,m=n.pathPoints[p],h=u%c/c;e.buf.copy(f).lerp(m,h),r.position.copy(e.buf);let g=Em(360/(Q.lerpFrame*Bm(`NEPTUNE`))*Q.accelerationRotation);i.rotateY(g);{let t=Em(mm),n=kh[0].orbitRadius+(kh[0].xPosition??0),r=(kh[0].retrograde?-1:1)*e.frameCount*Q.accelerationOrbit*(1/kh[0].orbitalPeriodDays),i=-n*Math.cos(r),c=n*Math.sin(r),l=i*Math.cos(t),u=i*Math.sin(t);a.position.set(l,u,c);let d=kh[1].orbitRadius+(kh[1].xPosition??0),f=e.frameCount*Q.accelerationOrbit*(1/kh[1].orbitalPeriodDays),p=-d*Math.cos(f),m=d*Math.sin(f),h=p*Math.cos(t),g=p*Math.sin(t);o.position.set(h,g,m);let _=kh[2].orbitRadius+(kh[2].xPosition??0),v=e.frameCount*Q.accelerationOrbit*(1/kh[2].orbitalPeriodDays),y=-_*Math.cos(v),b=_*Math.sin(v),x=y*Math.cos(t),S=y*Math.sin(t);s.position.set(x,S,b)}}var Xh=5e3,Zh=5,Qh=185,$h=275,eg=30,tg=class{permutation;constructor(e){this.permutation=this.generatePermutation(e)}generatePermutation(e){let t=Array.from({length:256},(e,t)=>t);for(let n=255;n>0;n--){let r=this.seededRandom(e+n),i=Math.floor(r*(n+1));[t[n],t[i]]=[t[i],t[n]]}return[...t,...t]}seededRandom(e){let t=Math.sin(e)*1e4;return t-Math.floor(t)}fade(e){return e*e*e*(e*(e*6-15)+10)}lerp(e,t,n){return t+e*(n-t)}grad(e,t,n,r){let i=e&15,a=i<8?t:n,o=i<8?n:r;return(i&1?-a:a)+(i&2?-o:o)}noise(e,t,n){let r=Math.floor(e)&255,i=Math.floor(t)&255,a=Math.floor(n)&255,o=e-Math.floor(e),s=t-Math.floor(t),c=n-Math.floor(n),l=this.fade(o),u=this.fade(s),d=this.fade(c),f=this.permutation,p=f[f[f[r]+i]+a],m=f[f[f[r]+i+1]+a],h=f[f[f[r]+i]+a+1],g=f[f[f[r]+i+1]+a+1],_=f[f[f[r+1]+i]+a],v=f[f[f[r+1]+i+1]+a],y=f[f[f[r+1]+i]+a+1],b=f[f[f[r+1]+i+1]+a+1],x=this.grad(p,o,s,c),S=this.grad(_,o-1,s,c),C=this.grad(m,o,s-1,c),w=this.grad(v,o-1,s-1,c),T=this.grad(h,o,s,c-1),E=this.grad(y,o-1,s,c-1),D=this.grad(g,o,s-1,c-1),O=this.grad(b,o-1,s-1,c-1),k=this.lerp(l,x,S),A=this.lerp(l,C,w),ee=this.lerp(u,k,A),te=this.lerp(l,T,E),j=this.lerp(l,D,O),ne=this.lerp(u,te,j);return this.lerp(d,ee,ne)}fbm(e,t,n,r=4){let i=0,a=1,o=1,s=0;for(let c=0;c<r;c++)i+=a*this.noise(e*o,t*o,n*o),s+=a,a*=.5,o*=2;return i/s}};function ng(e){let t=new da(1,4),n=t.getAttribute(`position`),r=n.array,i=new tg(e);for(let e=0;e<r.length;e+=3){let t=r[e],n=r[e+1],a=r[e+2],o=Math.sqrt(t*t+n*n+a*a),s=t/o,c=n/o,l=a/o,u=i.fbm(t*2,n*2,a*2,3)*.3;r[e]=t+s*u,r[e+1]=n+c*u,r[e+2]=a+l*u}return n.needsUpdate=!0,t.computeVertexNormals(),t}var rg=class{group;instancedMeshes=[];constructor(){this.group=new On,this.group.name=`AsteroidBelt`,this.initAsteroidBelt()}initAsteroidBelt(){let e=[];for(let t=0;t<Zh;t++)e.push(ng(t*12345));let t=Math.floor(Xh/Zh);e.forEach((e,n)=>{let r=new Oi(e,this.createRockMaterial(n),t);r.castShadow=!0,r.receiveShadow=!0;let i=new q;for(let e=0;e<t;e++){let t=Math.random()*Math.PI*2,n=Qh+Math.random()*($h-Qh),a=(Math.random()-.5)*eg,o=Math.cos(t)*n,s=Math.sin(t)*n,c=a,l=new Mt;l.setFromEuler(new un(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2));let u=.3+Math.random()*.7,d=u*(.8+Math.random()*.4),f=u*(.8+Math.random()*.4),p=u*(.8+Math.random()*.4);i.compose(new W(o,c,s),l,new W(d,f,p)),r.setMatrixAt(e,i)}r.instanceMatrix.needsUpdate=!0,this.instancedMeshes.push(r),this.group.add(r)})}createRockMaterial(e){let t=[9139029,6908265,8421504,7036244,4868682];return new Ta({color:t[e%t.length],metalness:.3+Math.random()*.2,roughness:.7+Math.random()*.2})}animate(e=.016){this.instancedMeshes.forEach(t=>{t.rotation.y+=e*.015})}getGroup(){return this.group}},ig=!0,ag=class{loadingScreen=document.getElementById(`loading-screen`);loadingStatus=document.getElementById(`loading-status`);renderer=new yu;scene=new In;camera;controls;composer;labelRenderer;zoomablePlanets=[];planetInteractionController;sunMesh;earthGroup;mercuryGroup;venusGroup;marsGroup;jupiterGroup;saturnGroup;uranusGroup;neptuneGroup;asteroidBelt;dayFraction=0;dayIndex=0;timer=new Io;frameCount=0;_cachedMeshes;_interpolatedPos=new W;_prevShowOrbits=Q.showOrbits;_prevShowLabels=Q.showLabels;_prevShowPlanets=Q.showPlanets;resetPlanetZoomView=()=>{this.planetInteractionController.exitPlanetZoom()&&_h(this.controls)};constructor(){let{camera:e,controls:t,composer:n,labelRenderer:r}=gh(this.renderer,this.scene,this.width,this.height);this.camera=e,this.controls=t,this.composer=n,this.labelRenderer=r,this.updateLoadingState(`太陽系データを読み込み中...`),this.initPlanets().catch(e=>{this.showLoadingError(`読み込みに失敗しました。ページを再読み込みしてください。`)})}get userDataEarthPositionRes(){return this.earthGroup.userData.planetPositionsRes}get width(){return window.innerWidth}get height(){return window.innerHeight}async initPlanets(){this.updateLoadingState(`太陽と地球を読み込み中...`),this.sunMesh=Lh(),this.scene.add(this.sunMesh),this.earthGroup=await qm(this.sunMesh.position,ig),this.dayIndex=this.userDataEarthPositionRes.todayRow-1,this.scene.add(this.earthGroup),this.updateLoadingState(`水星を読み込み中...`);let e=await Dh(ig);this.updateLoadingState(`金星を読み込み中...`);let t=await Vh(ig);this.updateLoadingState(`火星を読み込み中...`);let n=await Eh(ig);this.updateLoadingState(`木星を読み込み中...`);let r=await Ch(ig);this.updateLoadingState(`土星を読み込み中...`);let i=await Ph(ig);this.updateLoadingState(`天王星を読み込み中...`);let a=await Bh(ig);this.updateLoadingState(`海王星を読み込み中...`);let o=await Ah(ig);this.mercuryGroup=e,this.scene.add(e),this.venusGroup=t,this.scene.add(t),this.marsGroup=n,this.scene.add(n),this.jupiterGroup=r,this.scene.add(r),this.saturnGroup=i,this.scene.add(i),this.uranusGroup=a,this.scene.add(a),this.neptuneGroup=o,this.scene.add(o),this.updateLoadingState(`小惑星帯を生成中...`),this.asteroidBelt=new rg,this.scene.add(this.asteroidBelt.getGroup()),this.initDoubleClickZoom(),bh({sunMesh:this.sunMesh,camera:this.camera,controls:this.controls,onExitPlanetZoom:()=>{this.planetInteractionController.exitPlanetZoom()},setDayIndex:e=>{this.dayIndex=e},setDayFraction:e=>{this.dayFraction=e},setFrameCount:e=>{this.frameCount=e},userDataEarthPositionRes:this.userDataEarthPositionRes,currentIndex:this.dayIndex}),this._initMeshCache(),this.updateLoadingState(`描画を開始中...`),this.renderer.setAnimationLoop(()=>this.render()),this.render(),window.requestAnimationFrame(()=>this.hideLoadingScreen())}updateLoadingState(e){this.loadingStatus&&(this.loadingStatus.textContent=e)}hideLoadingScreen(){this.loadingScreen&&(this.loadingScreen.classList.add(`is-hidden`),window.setTimeout(()=>this.loadingScreen?.remove(),400))}showLoadingError(e){this.loadingScreen&&(this.loadingScreen.classList.add(`is-error`),this.updateLoadingState(e))}_initMeshCache(){this._cachedMeshes={earthPlanetSystem:this.earthGroup.getObjectByName($.PLANET_SYSTEM_NAME),earthPlanet:this.earthGroup.getObjectByName($.PLANET_NAME),earthAtmosphere:this.earthGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),moon:this.earthGroup.getObjectByName(Gm.MOON),mercuryPlanetSystem:this.mercuryGroup.getObjectByName($.PLANET_SYSTEM_NAME),mercuryPlanet:this.mercuryGroup.getObjectByName($.PLANET_NAME),venusPlanetSystem:this.venusGroup.getObjectByName($.PLANET_SYSTEM_NAME),venusPlanet:this.venusGroup.getObjectByName($.PLANET_NAME),venusAtmosphere:this.venusGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),marsPlanetSystem:this.marsGroup.getObjectByName($.PLANET_SYSTEM_NAME),marsPlanet:this.marsGroup.getObjectByName($.PLANET_NAME),phobos:this.marsGroup.getObjectByName(wh.PHOBOS),deimos:this.marsGroup.getObjectByName(wh.DEIMOS),jupiterPlanetSystem:this.jupiterGroup.getObjectByName($.PLANET_SYSTEM_NAME),jupiterPlanet:this.jupiterGroup.getObjectByName($.PLANET_NAME),io:this.jupiterGroup.getObjectByName(xh.IO),europa:this.jupiterGroup.getObjectByName(xh.EUROPA),ganymede:this.jupiterGroup.getObjectByName(xh.GANYMEDE),callisto:this.jupiterGroup.getObjectByName(xh.CALLISTO),saturnPlanetSystem:this.saturnGroup.getObjectByName($.PLANET_SYSTEM_NAME),saturnPlanet:this.saturnGroup.getObjectByName($.PLANET_NAME),titan:this.saturnGroup.getObjectByName(Mh.TITAN),rhea:this.saturnGroup.getObjectByName(Mh.RHEA),iapetus:this.saturnGroup.getObjectByName(Mh.IAPETUS),mimas:this.saturnGroup.getObjectByName(Mh.MIMAS),enceladus:this.saturnGroup.getObjectByName(Mh.ENCELADUS),uranusPlanetSystem:this.uranusGroup.getObjectByName($.PLANET_SYSTEM_NAME),uranusPlanet:this.uranusGroup.getObjectByName($.PLANET_NAME),miranda:this.uranusGroup.getObjectByName(Rh.MIRANDA),ariel:this.uranusGroup.getObjectByName(Rh.ARIEL),umbriel:this.uranusGroup.getObjectByName(Rh.UMBRIEL),titania:this.uranusGroup.getObjectByName(Rh.TITANIA),oberon:this.uranusGroup.getObjectByName(Rh.OBERON),neptunePlanetSystem:this.neptuneGroup.getObjectByName($.PLANET_SYSTEM_NAME),neptunePlanet:this.neptuneGroup.getObjectByName($.PLANET_NAME),triton:this.neptuneGroup.getObjectByName(Oh.TRITON),proteus:this.neptuneGroup.getObjectByName(Oh.PROTEUS),nereid:this.neptuneGroup.getObjectByName(Oh.NEREID)}}initDoubleClickZoom(){let e=this.earthGroup.getObjectByName($.PLANET_NAME),t=this.mercuryGroup.getObjectByName($.PLANET_NAME),n=this.venusGroup.getObjectByName($.PLANET_NAME),r=this.marsGroup.getObjectByName($.PLANET_NAME),i=this.jupiterGroup.getObjectByName($.PLANET_NAME),a=this.saturnGroup.getObjectByName($.PLANET_NAME),o=this.uranusGroup.getObjectByName($.PLANET_NAME),s=this.neptuneGroup.getObjectByName($.PLANET_NAME);this.zoomablePlanets=[e,t,n,r,i,a,o,s].filter(e=>e instanceof ni),this.planetInteractionController=jh({renderer:this.renderer,camera:this.camera,controls:this.controls,planets:this.zoomablePlanets,onResetView:this.resetPlanetZoomView}),this.renderer.domElement.addEventListener(`dblclick`,this.planetInteractionController.handleDoubleClickPlanetZoom),this.renderer.domElement.addEventListener(`pointermove`,this.planetInteractionController.handlePlanetHover),this.renderer.domElement.addEventListener(`pointerleave`,this.planetInteractionController.clearPlanetHover)}render(){this.controls.update(),this.composer.render(),this.labelRenderer.render(this.scene,this.camera),Q.isAnimating&&this.animate(),this.#e()}#e(){(Q.showOrbits!==this._prevShowOrbits||Q.showLabels!==this._prevShowLabels||Q.showPlanets!==this._prevShowPlanets)&&(this._prevShowOrbits=Q.showOrbits,this._prevShowLabels=Q.showLabels,this._prevShowPlanets=Q.showPlanets,[this.earthGroup,this.mercuryGroup,this.venusGroup,this.marsGroup,this.jupiterGroup,this.saturnGroup,this.uranusGroup,this.neptuneGroup].forEach(e=>{let t=e.getObjectByName($.PLANET_ORBIT_NAME);t&&(t.visible=Q.showOrbits),e.traverse(e=>{(e.name===$.PLANET_NAME||e.name===$.PLANET_RING_NAME||e.name===$.PLANET_AXIS_NAME||e.name===$.PLANET_ATMO_SPHERE_NAME||e.name.startsWith($.PLANET_MOONS_NAME)||e.name.endsWith(`-current-position`))&&(e.visible=Q.showPlanets),e.name===$.PLANET_LABEL_NAME&&(e.visible=Q.showLabels)})}))}animate(){this.frameCount++,this.sunMesh.rotateY(Lp*Q.accelerationRotation),uh(this.dayIndex),this.dayFraction=Number(((this.dayFraction+1/Q.lerpFrame)*Q.accelerationOrbit).toFixed(3)),this.dayFraction>=1&&(this.dayIndex+=1,this.dayFraction=0);let e={dayIndex:this.dayIndex,dayFraction:this.dayFraction,frameCount:this.frameCount,buf:this._interpolatedPos};Hh(e,this._cachedMeshes,this.userDataEarthPositionRes),Uh(e,this._cachedMeshes,this.mercuryGroup.userData.planetPositionsRes),Wh(e,this._cachedMeshes,this.venusGroup.userData.planetPositionsRes),Gh(e,this._cachedMeshes,this.marsGroup.userData.planetPositionsRes),Kh(e,this._cachedMeshes,this.jupiterGroup.userData.planetPositionsRes),qh(e,this._cachedMeshes,this.saturnGroup.userData.planetPositionsRes),Jh(e,this._cachedMeshes,this.uranusGroup.userData.planetPositionsRes),Yh(e,this._cachedMeshes,this.neptuneGroup.userData.planetPositionsRes),this.asteroidBelt.animate(.016)}};window.addEventListener(`DOMContentLoaded`,()=>{new ag});