...
`).filter(e=>e.includes(`X =`)),n=[];t.forEach((e,t)=>{let r=e.split(/[X,Y,Z, =]/).filter(e=>e.trim()),i=parseFloat(r[0]),a=parseFloat(r[1]),o=parseFloat(r[2]);n.push({x:i,y:a,z:o,day:t+1})}),l.pathPoints=Fm(n.map(e=>new W(e.x*90,e.z*90,e.y*90)).reverse()),l.todayRow=Lm(),await Bm(o,l)}else console.error(`データの取得に失敗しました:`,e)}catch(e){console.error(`API呼び出し中にエラーが発生しました:`,e)}finally{return l}},Wm=({parent:e,commandKey:t,planetPositionsRes:n,radius:r=1,color:i})=>{let a=new ni(new ma(r,32,32),new Wr({color:i??Em(t),depthTest:!1,depthWrite:!1}));a.name=`${t}-current-position`,a.renderOrder=999;let{pathPoints:o,todayRow:s}=n,c=o.length-1,l=s-1,u=wm(t),d=Math.floor(l/u)%c,f=(d+1)%c,p=l%u/u,m=o[d],h=o[f],g=new W().fromArray(m.toArray()).lerp(new W().fromArray(h.toArray()),p);return a.position.copy(g),e.add(a),a},$={PLANET_NAME:`Planet`,PLANET_ORBIT_NAME:`PlanetOrbit`,PLANET_RING_NAME:`PlanetRing`,PLANET_AXIS_NAME:`PlanetAxis`,PLANET_SYSTEM_NAME:`PlanetSystem`,PLANET_ATMO_SPHERE_NAME:`PlanetAtmosphere`,PLANET_MOONS_NAME:`PlanetMoons`,PLANET_LABEL_NAME:`PlanetLabel`},Gm={MERCURY:`Mercury（水星）`,VENUS:`Venus（金星）`,EARTH:`Earth（地球）`,MARS:`Mars（火星）`,JUPITER:`Jupiter（木星）`,SATURN:`Saturn（土星）`,URANUS:`Uranus（天王星）`,NEPTUNE:`Neptune（海王星）`,PLUTO:`Pluto（冥王星）`},Km=(e,t,n,r,i,a,o,s,c,l,u,d=!1)=>{let f=new oo,p;p=a instanceof Fr?a:o?new Da({map:f.load(km(a)),bumpMap:f.load(km(o)),bumpScale:.7}):new Da({map:f.load(km(a))});let m=new ni(new ma(n,32,20),p);m.rotation.z=Dm(r),m.castShadow=!0,m.receiveShadow=!0,m.name=$.PLANET_NAME;let h=new On;h.name=$.PLANET_SYSTEM_NAME;let g=u.pathPoints.length-1,_=u.todayRow-1,v=wm(e),y=Math.floor(_/v)%g,b=(y+1)%g,x=_%v/v,S=u.pathPoints[y],C=u.pathPoints[b],w=new W().fromArray(S.toArray()).lerp(new W().fromArray(C.toArray()),x);h.position.copy(w),h.add(m);let T=document.createElement(`div`);T.className=`planet-name-label`,T.textContent=Gm[e]??t;let E=new af(T);E.name=$.PLANET_LABEL_NAME,E.position.set(0,n+3,0),h.add(E);let D=document.createElement(`div`);D.className=`planet-tilt-label`,D.textContent=`傾き: ${r}°`;let O=new af(D);O.name=$.PLANET_LABEL_NAME,O.position.set(0,-(n+3),0),h.add(O);{let e=.1,t=new ni(new la(e,e,2.8*n,32),new Wr({color:65280}));t.name=$.PLANET_AXIS_NAME,t.rotation.z=Dm(r),h.add(t)}if(s){let e=new ni(new pa(s.innerRadius,s.outerRadius,30),new Ta({map:f.load(km(s.texture)),side:2}));e.name=$.PLANET_RING_NAME,e.rotation.x=Dm(90),e.rotation.y=Dm(r),h.add(e);let t=3.6;e.scale.set(t,t,t)}if(c){let e=new ni(new ma(n+.1,32,20),new Da({map:f.load(km(c)),transparent:!0,opacity:.4,depthTest:!0,depthWrite:!1}));e.name=$.PLANET_ATMO_SPHERE_NAME,e.rotation.z=.41,m.add(e)}let k=0;for(let e of l){let t;if(e.texture===void 0)continue;t=e.bump?new Ta({map:f.load(km(e.texture)),bumpMap:f.load(km(e.bump)),bumpScale:.5}):new Ta({map:f.load(km(e.texture))});let r=new ni(new ma(e.size,32,20),t);r.name=`${$.PLANET_MOONS_NAME}_${k}`,r.castShadow=!0,r.receiveShadow=!0,k++;let i=n*1.5;r.position.set(i,0,0),h.add(r),e.mesh=r}let A=new On;A.add(h),A.name=t,A.userData={planetPositionsRes:u};let j=new Gi(new Ar().setFromPoints(u.pathPoints),new Li({color:i,transparent:!0,opacity:.2}));return j.name=$.PLANET_ORBIT_NAME,A.add(j),d&&Wm({parent:A,commandKey:e,planetPositionsRes:u}),A},qm={MOON:`${$.PLANET_MOONS_NAME}_Moon`},Jm=[{size:Np,texture:`/images/moonmap.jpg`,bump:`/images/moonbump.jpg`,orbitSpeed:.001*Q.accelerationOrbit,orbitRadius:10,orbitalPeriodDays:27.322}],Ym=async(e,t)=>{let n=new oo,r=new Ca({uniforms:{dayTexture:{value:n.load(km(`/images/earth_daymap.jpg`))},nightTexture:{value:n.load(km(`/images/earth_nightmap.jpg`))},sunPosition:{value:e}},vertexShader:`
      ...
      `}),i=await Um(`EARTH`),a=Km(`EARTH`,jp,kp,Ap,Em(`EARTH`),r,null,null,`/images/earth_atmosphere.jpg`,Jm,i,t),o=a.getObjectByName($.PLANET_SYSTEM_NAME).children.find(e=>e.name.startsWith($.PLANET_MOONS_NAME));return o&&(o.name=qm.MOON),a},Xm=(e,t,n)=>{e.position.set(...n),e.up.set(0,1,0),t.target.set(0,0,0),t.update()},Zm=(e,t)=>{Xm(e,t,[190,0,.01])},Qm=(e,t)=>{Xm(e,t,[0,20,122])},$m=(e,t,n)=>{let r=window.innerWidth,i=window.innerHeight;t.setSize(r,i),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),n?.setSize(r,i),e.aspect=r/i,e.updateProjectionMatrix()},eh=e=>{let t=new Date().getFullYear();return yp(yf(new Date(t,0,1),e),`yyyy年MM月dd日`)},th=(e,t)=>{let n=document.createElement(`div`);n.className=`current-index-label`,n.setAttribute(`aria-live`,`polite`);let r=document.createElement(`div`);r.className=`current-index-label__chip current-index-label__chip--date`;let i=document.createElement(`span`);i.className=`current-index-label__caption`,i.textContent=`現在日付`;let a=document.createElement(`span`);a.className=`current-index-label__value`,a.textContent=eh(e),r.append(i,a);let o=document.createElement(`div`);o.className=`current-index-label__chip current-index-label__chip--zoom`;let s=document.createElement(`span`);s.className=`current-index-label__caption`,s.textContent=`ズーム距離`;let c=document.createElement(`span`);return c.className=`current-index-label__zoom`,c.textContent=`Zoom ${t}`,o.append(s,c),n.append(r,o),n},nh=(e,t)=>{let n=e.querySelector(`.current-index-label__value`);n&&(n.textContent=eh(t))},rh=(e,t)=>{let n=e.querySelector(`.current-index-label__zoom`);n&&(n.textContent=`Zoom ${t}`)},ih={...Q},ah=null,oh=null,sh=null,ch=null,lh=null,uh=null,dh=null,fh=null,ph=!1,mh=0,hh=!1,gh=new W,_h=e=>e.toFixed(1),vh=()=>!dh||!fh?0:dh.position.distanceTo(fh.target),yh=()=>{let e=_h(vh());uh&&rh(uh,e)},bh=e=>{if(!fh||(fh.minDistance=Q.zoomMinDistance,fh.maxDistance=Q.zoomMaxDistance,!e?.clampCamera||!dh))return;gh.subVectors(dh.position,fh.target),gh.lengthSq()===0&&gh.set(0,0,Q.zoomMinDistance);let t=gh.length(),n=jt.clamp(t,Q.zoomMinDistance,Q.zoomMaxDistance);if(Math.abs(n-t)<2**-52){yh();return}gh.setLength(n),dh.position.copy(fh.target).add(gh),fh.update()},xh=()=>{!oh||!sh||!ch||(oh.classList.toggle(`is-collapsed`,ph),sh.hidden=ph,ch.classList.toggle(`is-collapsed`,ph),ch.textContent=ph?`設定を展開`:`設定を折りたたむ`,ch.setAttribute(`aria-expanded`,String(!ph)))},Sh=()=>{lh&&(lh.textContent=Q.isAnimating?`アニメーション停止`:`アニメーション再生`,lh.classList.toggle(`is-active`,Q.isAnimating),lh.setAttribute(`aria-pressed`,String(Q.isAnimating)),lh.title=hh?`惑星ズーム中は操作できません`:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,uh?.classList.toggle(`is-animating`,Q.isAnimating))},Ch=e=>{mh=e,uh&&nh(uh,e)},wh=e=>{hh=e,lh&&(lh.disabled=e,lh.classList.toggle(`is-disabled`,e),lh.setAttribute(`aria-disabled`,String(e)),Sh())},Th=()=>{ah&&(ah.accelerationOrbit.value=String(Q.accelerationOrbit),ah.accelerationOrbitValue.value=String(Q.accelerationOrbit),ah.accelerationOrbitValue.textContent=String(Q.accelerationOrbit),ah.accelerationRotation.value=String(Q.accelerationRotation),ah.accelerationRotationValue.value=String(Q.accelerationRotation),ah.accelerationRotationValue.textContent=String(Q.accelerationRotation),ah.sunIntensity.value=String(Q.sunIntensity),ah.sunIntensityValue.value=String(Q.sunIntensity),ah.sunIntensityValue.textContent=String(Q.sunIntensity),bh({clampCamera:!0}),yh(),Sh(),ah.showOrbits.checked=Q.showOrbits,ah.showLabels.checked=Q.showLabels,Ch(mh),xh())},Eh=e=>{let{label:t,min:n,max:r,step:i,value:a,onChange:o}=e,s=document.createElement(`label`);s.className=`settings-menu__row settings-menu__row--range`;let c=document.createElement(`span`);c.className=`settings-menu__label`,c.textContent=t;let l=document.createElement(`input`);l.type=`range`,l.min=String(n),l.max=String(r),l.step=String(i),l.value=String(a),l.className=`settings-menu__range`;let u=document.createElement(`output`);return u.className=`settings-menu__value`,u.value=String(a),u.textContent=String(a),l.addEventListener(`input`,()=>{let e=Number(l.value);u.value=l.value,u.textContent=l.value,o(e)}),s.append(c,l,u),{row:s,input:l,output:u}},Dh=e=>{let{label:t,checked:n,onChange:r}=e,i=document.createElement(`label`);i.className=`settings-menu__row settings-menu__row--toggle`;let a=document.createElement(`input`);a.type=`checkbox`,a.checked=n,a.className=`settings-menu__checkbox`,a.addEventListener(`change`,()=>r(a.checked));let o=document.createElement(`span`);return o.className=`settings-menu__label`,o.textContent=t,i.append(a,o),{row:i,input:a}},Oh=e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`settings-menu__button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick),t},kh=e=>{let t=document.createElement(`p`);return t.className=`settings-menu__subtitle`,t.textContent=e,t},Ah=(e,t,n,r)=>{e.setSize(n,r),e.setClearColor(0,1),document.body.appendChild(e.domElement),t.background=new ao().load([km(`/images/3.jpg`),km(`/images/1.jpg`),km(`/images/2.jpg`),km(`/images/2.jpg`),km(`/images/4.jpg`),km(`/images/2.jpg`)]);let i=new df;i.setSize(n,r),i.domElement.style.position=`absolute`,i.domElement.style.top=`0`,i.domElement.style.left=`0`,i.domElement.style.pointerEvents=`none`,i.domElement.style.zIndex=`10`,document.body.appendChild(i.domElement);let a=new bo(50,n/r,1,5e3);a.position.set(0,20,122),$m(a,e,i),window.addEventListener(`resize`,()=>$m(a,e,i));let o=new Au(a,e.domElement);o.minDistance=Q.zoomMinDistance,o.maxDistance=Q.zoomMaxDistance;let s=Mh(e,t,a,n,r);return jh(t),{camera:a,controls:o,composer:s,labelRenderer:i}},jh=e=>{let t=new Oo(2236962,10);e.add(t)},Mh=(e,t,n,r,i)=>{let a=new $d(e);a.addPass(new tf(t,n));let o=new ef(new U(r,i),t,n);o.edgeStrength=3,o.edgeGlow=1,o.visibleEdgeColor.set(16777215),o.hiddenEdgeColor.set(1640965),a.addPass(o);let s=new rf(new U(r,i),1,.4,.85);return s.threshold=1,s.radius=.9,a.addPass(s),a},Nh=e=>{let{sunMesh:t,camera:n,controls:r,onExitPlanetZoom:i,setDayIndex:a,setDayFraction:o,setFrameCount:s,userDataEarthPositionRes:c,currentIndex:l}=e,u=document.createElement(`section`);u.className=`settings-menu`,u.setAttribute(`aria-label`,`表示設定メニュー`);let d=document.createElement(`header`);d.className=`settings-menu__header`;let f=document.createElement(`div`);f.className=`settings-menu__heading`;let p=document.createElement(`p`);p.className=`settings-menu__title`,p.textContent=`表示設定`,f.append(p);let m=th(l,_h(n.position.distanceTo(r.target))),h=document.createElement(`button`);h.type=`button`,h.className=`settings-menu__collapse-button`,h.addEventListener(`click`,()=>{ph=!ph,xh()}),d.append(f,m);let g=document.createElement(`div`);g.className=`settings-menu__sections`;let _=document.createElement(`section`);_.className=`settings-menu__section`;let v=kh(`アニメーション`),y=Eh({label:`公転スピード`,min:0,max:10,step:.1,value:Q.accelerationOrbit,onChange:e=>{Q.accelerationOrbit=e}}),b=Eh({label:`自転スピード`,min:0,max:10,step:.1,value:Q.accelerationRotation,onChange:e=>{Q.accelerationRotation=e}}),x=Eh({label:`太陽光強度`,min:0,max:10,step:.1,value:Q.sunIntensity,onChange:e=>{Q.sunIntensity=e,t.material.emissiveIntensity=e}}),S=Oh({label:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,onClick:()=>{Q.isAnimating=!Q.isAnimating,Sh()}});S.classList.add(`settings-menu__button--primary`),S.setAttribute(`aria-pressed`,String(Q.isAnimating)),_.append(v,y.row,b.row,x.row,S);let C=document.createElement(`section`);C.className=`settings-menu__section`;let w=kh(`表示`),T=document.createElement(`div`);T.className=`settings-menu__toggle-group`;let E=Dh({label:`公転軌道`,checked:Q.showOrbits,onChange:e=>{Q.showOrbits=e}}),D=Dh({label:`惑星名`,checked:Q.showLabels,onChange:e=>{Q.showLabels=e}});T.append(E.row,D.row),C.append(w,T);let O=document.createElement(`section`);O.className=`settings-menu__section settings-menu__section--actions`;let k=kh(`視点`);O.append(k,Oh({label:`トップ`,onClick:()=>{i(),n.position.set(0,190,.01),r.target.set(0,0,0),r.update()}}),Oh({label:`サイド`,onClick:()=>{i(),Zm(n,r)}}),Oh({label:`リセット`,onClick:()=>{i(),Qm(n,r)}}),Oh({label:`設定を初期化`,onClick:()=>{Q.lerpFrame=ih.lerpFrame,Q.accelerationOrbit=ih.accelerationOrbit,Q.accelerationRotation=ih.accelerationRotation,Q.sunIntensity=ih.sunIntensity,Q.zoomMinDistance=ih.zoomMinDistance,Q.zoomMaxDistance=ih.zoomMaxDistance,Q.isAnimating=ih.isAnimating,Q.showOrbits=ih.showOrbits,Q.showLabels=ih.showLabels,Q.showPlanets=ih.showPlanets,t.material.emissiveIntensity=Q.sunIntensity,i(),Qm(n,r);let e=c.todayRow-1;a(e),o(0),s(0),Ch(e),Th()}})),u.append(d,g,h),g.append(_,O,C),document.body.appendChild(u),oh=u,sh=g,ch=h,lh=S,uh=m,dh=n,fh=r,Ch(l),wh(!1),ah={accelerationOrbit:y.input,accelerationOrbitValue:y.output,accelerationRotation:b.input,accelerationRotationValue:b.output,sunIntensity:x.input,sunIntensityValue:x.output,isAnimating:S,showOrbits:E.input,showLabels:D.input},r.addEventListener(`change`,yh),Th()},Ph={IO:`${$.PLANET_MOONS_NAME}_Io`,EUROPA:`${$.PLANET_MOONS_NAME}_Europa`,GANYMEDE:`${$.PLANET_MOONS_NAME}_Ganymede`,CALLISTO:`${$.PLANET_MOONS_NAME}_Callisto`},Fh=[{size:kp*.29,texture:`/images/jupiterIo.jpg`,orbitRadius:20,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.8,xPosition:80},{size:kp*.24,texture:`/images/jupiterEuropa.jpg`,orbitRadius:24,orbitSpeed:25e-5*Q.accelerationOrbit,orbitalPeriodDays:3.5,xPosition:90},{size:kp*.41,texture:`/images/jupiterGanymede.jpg`,orbitRadius:28,orbitSpeed:125e-6*Q.accelerationOrbit,orbitalPeriodDays:7.1,xPosition:110},{size:kp*.34,texture:`/images/jupiterCallisto.jpg`,orbitRadius:32,orbitSpeed:6e-5*Q.accelerationOrbit,orbitalPeriodDays:16.7,xPosition:140}],Ih=async e=>{let t=await Um(`JUPITER`),n=Km(`JUPITER`,im,nm,rm,Em(`JUPITER`),`/images/jupiter.jpg`,null,null,null,Fh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Ph.IO),e===1&&(t.name=Ph.EUROPA),e===2&&(t.name=Ph.GANYMEDE),e===3&&(t.name=Ph.CALLISTO),t.position.set(Fh[e].xPosition??0,0,0);return n},Lh={PHOBOS:`${$.PLANET_MOONS_NAME}_Phobos`,DEIMOS:`${$.PLANET_MOONS_NAME}_Deimos`},Rh=[{size:.1,orbitRadius:5,orbitSpeed:.002*Q.accelerationOrbit,orbitalPeriodDays:.319,modelPath:`/images/mars/phobos.glb`,xPosition:6},{size:.1,orbitRadius:12.5,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.263,modelPath:`/images/mars/deimos.glb`,xPosition:14}],zh=async e=>{let t=await Um(`MARS`),n=Km(`MARS`,em,Qp,$p,Em(`MARS`),`/images/marsmap.jpg`,`/images/marsbump.jpg`,null,null,[],t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME);for(let[e,t]of Rh.entries())t.modelPath!==void 0&&(t.mesh=(await Am(t.modelPath)).children[0],e===0&&(t.mesh.name=Lh.PHOBOS),e===1&&(t.mesh.name=Lh.DEIMOS),t.mesh.scale.set(t.size,t.size,t.size),t.mesh.position.set(t.xPosition??0,0,0),t.mesh.castShadow=!0,t.mesh.receiveShadow=!0,r.add(t.mesh));return n},Bh=async e=>{let t=await Um(`MERCURY`);return Km(`MERCURY`,Kp,Wp,Gp,Em(`MERCURY`),`/images/mercurymap.jpg`,`/images/mercurybump.jpg`,null,null,[],t,e)},Vh={TRITON:`${$.PLANET_MOONS_NAME}_Triton`,PROTEUS:`${$.PLANET_MOONS_NAME}_Proteus`,NEREID:`${$.PLANET_MOONS_NAME}_Nereid`},Hh=[{size:kp*.21,texture:`/images/Triton-tok.webp`,orbitRadius:14,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:5.88,xPosition:120,retrograde:!0},{size:kp*.033,texture:`/images/Proteus.webp`,orbitRadius:10,orbitSpeed:35e-5*Q.accelerationOrbit,orbitalPeriodDays:1.12,xPosition:150},{size:kp*.053,texture:`/images/Nereidimproved.webp`,orbitRadius:18,orbitSpeed:8e-5*Q.accelerationOrbit,orbitalPeriodDays:360.14,xPosition:210}],Uh=async e=>{let t=await Um(`NEPTUNE`),n=Km(`NEPTUNE`,gm,mm,hm,Em(`NEPTUNE`),`/images/neptune.jpg`,null,null,null,Hh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Vh.TRITON),e===1&&(t.name=Vh.PROTEUS),e===2&&(t.name=Vh.NEREID),t.position.set(Hh[e].xPosition??0,0,0);return n},Wh=e=>{let{renderer:t,camera:n,controls:r,planets:i,onResetView:a}=e,o=new Zo,s=new U,c=null,l=!1,u=Q.isAnimating,d=document.createElement(`button`),f=`PlanetHoverRimLight`,p=new Ca({uniforms:{rimColor:{value:new J(10080767)},rimPower:{value:2.6}},vertexShader:`
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1}),m=e=>{let n=t.domElement.getBoundingClientRect();s.x=(e.clientX-n.left)/n.width*2-1,s.y=-((e.clientY-n.top)/n.height)*2+1};d.type=`button`,d.className=`planet-zoom-close-button`,d.textContent=`視点をリセット`,d.title=`視点をリセット`,d.setAttribute(`aria-label`,`視点をリセット`),d.hidden=!0,d.addEventListener(`click`,()=>{a()}),document.body.appendChild(d);let h=(e,t)=>{let n=e.getObjectByName(f);if(t){if(n)return;let t=new ni(e.geometry,p);t.name=f,t.scale.setScalar(1.04),e.add(t);return}n&&e.remove(n)},g=()=>{c&&=(h(c,!1),null)},_=()=>l?(g(),l=!1,Q.isAnimating=u,Th(),wh(!1),d.hidden=!0,!0):!1,v=()=>{d.hidden=!1},y=e=>{let t=new W;e.getWorldPosition(t);let i=e.geometry;i.computeBoundingSphere();let a=i.boundingSphere?.radius??1,o=new W;e.getWorldScale(o);let s=a*Math.max(o.x,o.y,o.z)/Math.tan(Dm(n.fov)/2)*1.35,c=new W().subVectors(n.position,r.target);c.lengthSq()===0&&c.set(0,0,1),c.normalize(),n.position.copy(t).add(c.multiplyScalar(s)),r.target.copy(t),r.update()};return{handleDoubleClickPlanetZoom:e=>{m(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1);if(t.length===0)return;let r=t[0].object;l||(u=Q.isAnimating,Q.isAnimating=!1,Th(),l=!0,wh(!0)),v(),y(r)},handlePlanetHover:e=>{m(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1)[0]?.object;if(!(t instanceof ni)){g();return}c!==t&&(g(),c=t,h(t,!0))},clearPlanetHover:g,exitPlanetZoom:_}},Gh={TITAN:`${$.PLANET_MOONS_NAME}_Titan`,RHEA:`${$.PLANET_MOONS_NAME}_Rhea`,IAPETUS:`${$.PLANET_MOONS_NAME}_Iapetus`,MIMAS:`${$.PLANET_MOONS_NAME}_Mimas`,ENCELADUS:`${$.PLANET_MOONS_NAME}_Enceladus`},Kh=[{size:kp*.4,texture:`/images/RS3_Titan.webp`,orbitRadius:16,orbitSpeed:9e-5*Q.accelerationOrbit,orbitalPeriodDays:15.95,xPosition:137},{size:kp*.12,texture:`/images/RS3_Rhea.webp`,orbitRadius:12,orbitSpeed:18e-5*Q.accelerationOrbit,orbitalPeriodDays:4.52,xPosition:116},{size:kp*.115,texture:`/images/LapetusNew.webp`,orbitRadius:22,orbitSpeed:1e-5*Q.accelerationOrbit,orbitalPeriodDays:79.3,xPosition:180},{size:kp*.031,texture:`/images/RS3_Mimas.webp`,orbitRadius:8,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:.942,xPosition:102},{size:kp*.04,texture:`/images/Enceladus.webp`,orbitRadius:10,orbitSpeed:45e-5*Q.accelerationOrbit,orbitalPeriodDays:1.37,xPosition:110}],qh=async e=>{let t=await Um(`SATURN`),n=Km(`SATURN`,cm,om,sm,Em(`SATURN`),`/images/saturnmap.jpg`,null,{innerRadius:18,outerRadius:29,texture:`/images/saturn_ring.png`},null,Kh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Gh.TITAN),e===1&&(t.name=Gh.RHEA),e===2&&(t.name=Gh.IAPETUS),e===3&&(t.name=Gh.MIMAS),e===4&&(t.name=Gh.ENCELADUS),t.position.set(Kh[e].xPosition??0,0,0);return n},Jh=`Sun`,Yh=new Ta({emissive:Rp,emissiveMap:new oo().load(km(`/images/sun.jpg`)),emissiveIntensity:Q.sunIntensity}),Xh=()=>{let e=new ni(new ma(Ip,32,20),Yh);e.name=Jh;let t=new wo(zp,100,0,Bp),n=new wo(Vp,20,Hp,Up);return e.add(t),e.add(n),e},Zh={MIRANDA:`${$.PLANET_MOONS_NAME}_Miranda`,ARIEL:`${$.PLANET_MOONS_NAME}_Ariel`,UMBRIEL:`${$.PLANET_MOONS_NAME}_Umbriel`,TITANIA:`${$.PLANET_MOONS_NAME}_Titania`,OBERON:`${$.PLANET_MOONS_NAME}_Oberon`},Qh=[{size:kp*.037,texture:`/images/Miranda-0.webp`,orbitRadius:10,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:1.41,xPosition:58},{size:kp*.084,texture:`/images/Ariel-0.webp`,orbitRadius:10,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:2.52,xPosition:90},{size:kp*.07,texture:`/images/Uranus-0.webp`,orbitRadius:10,orbitSpeed:4e-4*Q.accelerationOrbit,orbitalPeriodDays:4.14,xPosition:120},{size:kp*.11,texture:`/images/Titaniamap.webp`,orbitRadius:10,orbitSpeed:3e-4*Q.accelerationOrbit,orbitalPeriodDays:8.71,xPosition:150},{size:kp*.105,texture:`/images/Oberonmap1.webp`,orbitRadius:10,orbitSpeed:2e-4*Q.accelerationOrbit,orbitalPeriodDays:13.46,xPosition:180}],$h=async e=>{let t=await Um(`URANUS`),n=Km(`URANUS`,fm,um,dm,Em(`URANUS`),`/images/uranus.jpg`,null,{innerRadius:8,outerRadius:10,texture:`/images/uranus_ring.png`},null,Qh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Zh.MIRANDA),e===1&&(t.name=Zh.ARIEL),e===2&&(t.name=Zh.UMBRIEL),e===3&&(t.name=Zh.TITANIA),e===4&&(t.name=Zh.OBERON),t.position.set(Qh[e].xPosition??0,0,0);return n},eg=async e=>{let t=await Um(`VENUS`);return Km(`VENUS`,Xp,Jp,Yp,Em(`VENUS`),`/images/venusmap.jpg`,`/images/venusbump.jpg`,null,`/images/venus_atmosphere.jpg`,[],t,e)};function tg(e,t,n){let{earthPlanetSystem:r,earthPlanet:i,earthAtmosphere:a,moon:o}=t;{let t=n.pathPoints.length-1,o=e.dayIndex%t,s=n.pathPoints[o],c=(o+1)%t,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Dm(360/Q.lerpFrame*Q.accelerationRotation);i.rotateY(u),a.rotateY(u+Fp)}{let t=Dm(5),n=Dm(360/(Pp*Q.lerpFrame)*Q.accelerationOrbit),r=e.frameCount*n,{orbitRadius:i}=Jm[0],a=i*Math.cos(r),s=i*Math.sin(r)*Math.sin(t),c=i*Math.sin(r)*Math.cos(t);o.position.set(-a,s,c);let l=n;o.rotateY(l)}}function ng(e,t,n){let{mercuryPlanetSystem:r,mercuryPlanet:i}=t,a=n.pathPoints.length-1,o=e.dayIndex%a,s=n.pathPoints[o],c=(o+1)%a,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Dm(360/(Q.lerpFrame*Hm(`MERCURY`))*Q.accelerationRotation);i.rotateY(u)}function rg(e,t,n){let{venusPlanetSystem:r,venusPlanet:i,venusAtmosphere:a}=t,o=n.pathPoints.length-1,s=e.dayIndex%o,c=n.pathPoints[s],l=(s+1)%o,u=n.pathPoints[l];e.buf.copy(c).lerp(u,e.dayFraction),r.position.copy(e.buf);let d=Dm(360/(Q.lerpFrame*Hm(`VENUS`))*Q.accelerationRotation);i.rotateY(d),a.rotateY(d*60)}function ig(e,t,n){let{marsPlanetSystem:r,marsPlanet:i,phobos:a,deimos:o}=t,s=wm(`MARS`),c=n.pathPoints.length-1,l=e.dayIndex+e.dayFraction,u=Math.floor(l/s)%c,d=n.pathPoints[u],f=(u+1)%c,p=n.pathPoints[f],m=l%s/s;e.buf.copy(d).lerp(p,m),r.position.copy(e.buf);let h=Dm(360/(Q.lerpFrame*Hm(`MARS`))*Q.accelerationRotation);i.rotateY(h);let g=Rh[0].orbitRadius,_=Rh[1].orbitRadius,v=e.frameCount*Q.accelerationOrbit*4,y=e.frameCount*Q.accelerationOrbit*1,b=g*Math.cos(v),x=g*Math.sin(v);a.position.set(-b,0,x);let S=_*Math.cos(y),C=_*Math.sin(y);o.position.set(-S,0,C)}function ag(e,t,n){let{jupiterPlanetSystem:r,jupiterPlanet:i,io:a,europa:o,ganymede:s,callisto:c}=t,l=wm(`JUPITER`),u=n.pathPoints.length-1,d=e.dayIndex+e.dayFraction,f=Math.floor(d/l)%u,p=n.pathPoints[f],m=(f+1)%u,h=n.pathPoints[m],g=d%l/l;e.buf.copy(p).lerp(h,g),r.position.copy(e.buf);let _=Dm(360/(Q.lerpFrame*Hm(`JUPITER`))*Q.accelerationRotation);i.rotateY(_);{let t=Fh[0].orbitRadius+(Fh[0].xPosition??0),n=Fh[1].orbitRadius+(Fh[1].xPosition??0),r=Fh[2].orbitRadius+(Fh[2].xPosition??0),i=Fh[3].orbitRadius+(Fh[3].xPosition??0),l=e.frameCount*Q.accelerationOrbit*(1/Fh[0].orbitalPeriodDays),u=e.frameCount*Q.accelerationOrbit*(1/Fh[1].orbitalPeriodDays),d=e.frameCount*Q.accelerationOrbit*(1/Fh[2].orbitalPeriodDays),f=e.frameCount*Q.accelerationOrbit*(1/Fh[3].orbitalPeriodDays),p=t*Math.cos(l),m=t*Math.sin(l);a.position.set(-p,0,m);let h=n*Math.cos(u),g=n*Math.sin(u);o.position.set(-h,0,g);let _=r*Math.cos(d),v=r*Math.sin(d);s.position.set(-_,0,v);let y=i*Math.cos(f),b=i*Math.sin(f);c.position.set(-y,0,b)}}function og(e,t,n){let{saturnPlanetSystem:r,saturnPlanet:i,titan:a,rhea:o,iapetus:s,mimas:c,enceladus:l}=t,u=wm(`SATURN`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Dm(360/(Q.lerpFrame*Hm(`SATURN`))*Q.accelerationRotation);i.rotateY(v);{let t=Dm(sm),n=Kh[0].orbitRadius+(Kh[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Kh[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Kh[1].orbitRadius+(Kh[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Kh[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Kh[2].orbitRadius+(Kh[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Kh[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Kh[3].orbitRadius+(Kh[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Kh[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=Kh[4].orbitRadius+(Kh[4].xPosition??0),ee=e.frameCount*Q.accelerationOrbit*(1/Kh[4].orbitalPeriodDays),M=-j*Math.cos(ee),te=j*Math.sin(ee),ne=M*Math.cos(t),N=M*Math.sin(t);l.position.set(ne,N,te)}}function sg(e,t,n){let{uranusPlanetSystem:r,uranusPlanet:i,miranda:a,ariel:o,umbriel:s,titania:c,oberon:l}=t,u=wm(`URANUS`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Dm(360/(Q.lerpFrame*Hm(`URANUS`))*Q.accelerationRotation);i.rotateY(v);{let t=Dm(dm),n=Qh[0].orbitRadius+(Qh[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Qh[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Qh[1].orbitRadius+(Qh[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Qh[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Qh[2].orbitRadius+(Qh[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Qh[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Qh[3].orbitRadius+(Qh[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Qh[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=Qh[4].orbitRadius+(Qh[4].xPosition??0),ee=e.frameCount*Q.accelerationOrbit*(1/Qh[4].orbitalPeriodDays),M=-j*Math.cos(ee),te=j*Math.sin(ee),ne=M*Math.cos(t),N=M*Math.sin(t);l.position.set(ne,N,te)}}function cg(e,t,n){let{neptunePlanetSystem:r,neptunePlanet:i,triton:a,proteus:o,nereid:s}=t,c=wm(`NEPTUNE`),l=n.pathPoints.length-1,u=e.dayIndex+e.dayFraction,d=Math.floor(u/c)%l,f=n.pathPoints[d],p=(d+1)%l,m=n.pathPoints[p],h=u%c/c;e.buf.copy(f).lerp(m,h),r.position.copy(e.buf);let g=Dm(360/(Q.lerpFrame*Hm(`NEPTUNE`))*Q.accelerationRotation);i.rotateY(g);{let t=Dm(hm),n=Hh[0].orbitRadius+(Hh[0].xPosition??0),r=(Hh[0].retrograde?-1:1)*e.frameCount*Q.accelerationOrbit*(1/Hh[0].orbitalPeriodDays),i=-n*Math.cos(r),c=n*Math.sin(r),l=i*Math.cos(t),u=i*Math.sin(t);a.position.set(l,u,c);let d=Hh[1].orbitRadius+(Hh[1].xPosition??0),f=e.frameCount*Q.accelerationOrbit*(1/Hh[1].orbitalPeriodDays),p=-d*Math.cos(f),m=d*Math.sin(f),h=p*Math.cos(t),g=p*Math.sin(t);o.position.set(h,g,m);let _=Hh[2].orbitRadius+(Hh[2].xPosition??0),v=e.frameCount*Q.accelerationOrbit*(1/Hh[2].orbitalPeriodDays),y=-_*Math.cos(v),b=_*Math.sin(v),x=y*Math.cos(t),S=y*Math.sin(t);s.position.set(x,S,b)}}var lg=5e3,ug=5,dg=185,fg=275,pg=30,mg=class{permutation;constructor(e){this.permutation=this.generatePermutation(e)}generatePermutation(e){let t=Array.from({length:256},(e,t)=>t);for(let n=255;n>0;n--){let r=this.seededRandom(e+n),i=Math.floor(r*(n+1));[t[n],t[i]]=[t[i],t[n]]}return[...t,...t]}seededRandom(e){let t=Math.sin(e)*1e4;return t-Math.floor(t)}fade(e){return e*e*e*(e*(e*6-15)+10)}lerp(e,t,n){return t+e*(n-t)}grad(e,t,n,r){let i=e&15,a=i<8?t:n,o=i<8?n:r;return(i&1?-a:a)+(i&2?-o:o)}noise(e,t,n){let r=Math.floor(e)&255,i=Math.floor(t)&255,a=Math.floor(n)&255,o=e-Math.floor(e),s=t-Math.floor(t),c=n-Math.floor(n),l=this.fade(o),u=this.fade(s),d=this.fade(c),f=this.permutation,p=f[f[f[r]+i]+a],m=f[f[f[r]+i+1]+a],h=f[f[f[r]+i]+a+1],g=f[f[f[r]+i+1]+a+1],_=f[f[f[r+1]+i]+a],v=f[f[f[r+1]+i+1]+a],y=f[f[f[r+1]+i]+a+1],b=f[f[f[r+1]+i+1]+a+1],x=this.grad(p,o,s,c),S=this.grad(_,o-1,s,c),C=this.grad(m,o,s-1,c),w=this.grad(v,o-1,s-1,c),T=this.grad(h,o,s,c-1),E=this.grad(y,o-1,s,c-1),D=this.grad(g,o,s-1,c-1),O=this.grad(b,o-1,s-1,c-1),k=this.lerp(l,x,S),A=this.lerp(l,C,w),j=this.lerp(u,k,A),ee=this.lerp(l,T,E),M=this.lerp(l,D,O),te=this.lerp(u,ee,M);return this.lerp(d,j,te)}fbm(e,t,n,r=4){let i=0,a=1,o=1,s=0;for(let c=0;c<r;c++)i+=a*this.noise(e*o,t*o,n*o),s+=a,a*=.5,o*=2;return i/s}};function hg(e){let t=new da(1,4),n=t.getAttribute(`position`),r=n.array,i=new mg(e);for(let e=0;e<r.length;e+=3){let t=r[e],n=r[e+1],a=r[e+2],o=Math.sqrt(t*t+n*n+a*a),s=t/o,c=n/o,l=a/o,u=i.fbm(t*2,n*2,a*2,3)*.3;r[e]=t+s*u,r[e+1]=n+c*u,r[e+2]=a+l*u}return n.needsUpdate=!0,t.computeVertexNormals(),t}var gg=class{group;instancedMeshes=[];constructor(){this.group=new On,this.group.name=`AsteroidBelt`,this.initAsteroidBelt()}initAsteroidBelt(){let e=[];for(let t=0;t<ug;t++)e.push(hg(t*12345));let t=Math.floor(lg/ug);e.forEach((e,n)=>{let r=new Oi(e,this.createRockMaterial(n),t);r.castShadow=!0,r.receiveShadow=!0;let i=new q;for(let e=0;e<t;e++){let t=Math.random()*Math.PI*2,n=dg+Math.random()*(fg-dg),a=(Math.random()-.5)*pg,o=Math.cos(t)*n,s=Math.sin(t)*n,c=a,l=new Mt;l.setFromEuler(new un(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2));let u=.3+Math.random()*.7,d=u*(.8+Math.random()*.4),f=u*(.8+Math.random()*.4),p=u*(.8+Math.random()*.4);i.compose(new W(o,c,s),l,new W(d,f,p)),r.setMatrixAt(e,i)}r.instanceMatrix.needsUpdate=!0,this.instancedMeshes.push(r),this.group.add(r)})}createRockMaterial(e){let t=[9139029,6908265,8421504,7036244,4868682];return new Ta({color:t[e%t.length],metalness:.3+Math.random()*.2,roughness:.7+Math.random()*.2})}animate(e=.016){this.instancedMeshes.forEach(t=>{t.rotation.y+=e*.015})}getGroup(){return this.group}},_g=!0,vg=class{loadingScreen=document.getElementById(`loading-screen`);loadingStatus=document.getElementById(`loading-status`);renderer=new yu;scene=new In;camera;controls;composer;labelRenderer;zoomablePlanets=[];planetInteractionController;sunMesh;earthGroup;mercuryGroup;venusGroup;marsGroup;jupiterGroup;saturnGroup;uranusGroup;neptuneGroup;asteroidBelt;dayFraction=0;dayIndex=0;timer=new Io;frameCount=0;_cachedMeshes;_interpolatedPos=new W;_prevShowOrbits=Q.showOrbits;_prevShowLabels=Q.showLabels;_prevShowPlanets=Q.showPlanets;resetPlanetZoomView=()=>{this.planetInteractionController.exitPlanetZoom()&&Qm(this.camera,this.controls)};constructor(){let{camera:e,controls:t,composer:n,labelRenderer:r}=Ah(this.renderer,this.scene,this.width,this.height);this.camera=e,this.controls=t,this.composer=n,this.labelRenderer=r,this.updateLoadingState(`太陽系データを読み込み中...`),this.initPlanets().catch(e=>{this.showLoadingError(`読み込みに失敗しました。ページを再読み込みしてください。`)})}get userDataEarthPositionRes(){return this.earthGroup.userData.planetPositionsRes}get width(){return window.innerWidth}get height(){return window.innerHeight}async initPlanets(){this.updateLoadingState(`太陽と地球を読み込み中...`),this.sunMesh=Xh(),this.scene.add(this.sunMesh),this.earthGroup=await Ym(this.sunMesh.position,_g),this.dayIndex=this.userDataEarthPositionRes.todayRow-1,this.scene.add(this.earthGroup),this.updateLoadingState(`水星を読み込み中...`);let e=await Bh(_g);this.updateLoadingState(`金星を読み込み中...`);let t=await eg(_g);this.updateLoadingState(`火星を読み込み中...`);let n=await zh(_g);this.updateLoadingState(`木星を読み込み中...`);let r=await Ih(_g);this.updateLoadingState(`土星を読み込み中...`);let i=await qh(_g);this.updateLoadingState(`天王星を読み込み中...`);let a=await $h(_g);this.updateLoadingState(`海王星を読み込み中...`);let o=await Uh(_g);this.mercuryGroup=e,this.scene.add(e),this.venusGroup=t,this.scene.add(t),this.marsGroup=n,this.scene.add(n),this.jupiterGroup=r,this.scene.add(r),this.saturnGroup=i,this.scene.add(i),this.uranusGroup=a,this.scene.add(a),this.neptuneGroup=o,this.scene.add(o),this.updateLoadingState(`小惑星帯を生成中...`),this.asteroidBelt=new gg,this.scene.add(this.asteroidBelt.getGroup()),this.initDoubleClickZoom(),Nh({sunMesh:this.sunMesh,camera:this.camera,controls:this.controls,onExitPlanetZoom:()=>{this.planetInteractionController.exitPlanetZoom()},setDayIndex:e=>{this.dayIndex=e},setDayFraction:e=>{this.dayFraction=e},setFrameCount:e=>{this.frameCount=e},userDataEarthPositionRes:this.userDataEarthPositionRes,currentIndex:this.dayIndex}),this._initMeshCache(),this.updateLoadingState(`描画を開始中...`),this.renderer.setAnimationLoop(()=>this.render()),this.render(),window.requestAnimationFrame(()=>this.hideLoadingScreen())}updateLoadingState(e){this.loadingStatus&&(this.loadingStatus.textContent=e)}hideLoadingScreen(){this.loadingScreen&&(this.loadingScreen.classList.add(`is-hidden`),window.setTimeout(()=>this.loadingScreen?.remove(),400))}showLoadingError(e){this.loadingScreen&&(this.loadingScreen.classList.add(`is-error`),this.updateLoadingState(e))}_initMeshCache(){this._cachedMeshes={earthPlanetSystem:this.earthGroup.getObjectByName($.PLANET_SYSTEM_NAME),earthPlanet:this.earthGroup.getObjectByName($.PLANET_NAME),earthAtmosphere:this.earthGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),moon:this.earthGroup.getObjectByName(qm.MOON),mercuryPlanetSystem:this.mercuryGroup.getObjectByName($.PLANET_SYSTEM_NAME),mercuryPlanet:this.mercuryGroup.getObjectByName($.PLANET_NAME),venusPlanetSystem:this.venusGroup.getObjectByName($.PLANET_SYSTEM_NAME),venusPlanet:this.venusGroup.getObjectByName($.PLANET_NAME),venusAtmosphere:this.venusGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),marsPlanetSystem:this.marsGroup.getObjectByName($.PLANET_SYSTEM_NAME),marsPlanet:this.marsGroup.getObjectByName($.PLANET_NAME),phobos:this.marsGroup.getObjectByName(Lh.PHOBOS),deimos:this.marsGroup.getObjectByName(Lh.DEIMOS),jupiterPlanetSystem:this.jupiterGroup.getObjectByName($.PLANET_SYSTEM_NAME),jupiterPlanet:this.jupiterGroup.getObjectByName($.PLANET_NAME),io:this.jupiterGroup.getObjectByName(Ph.IO),europa:this.jupiterGroup.getObjectByName(Ph.EUROPA),ganymede:this.jupiterGroup.getObjectByName(Ph.GANYMEDE),callisto:this.jupiterGroup.getObjectByName(Ph.CALLISTO),saturnPlanetSystem:this.saturnGroup.getObjectByName($.PLANET_SYSTEM_NAME),saturnPlanet:this.saturnGroup.getObjectByName($.PLANET_NAME),titan:this.saturnGroup.getObjectByName(Gh.TITAN),rhea:this.saturnGroup.getObjectByName(Gh.RHEA),iapetus:this.saturnGroup.getObjectByName(Gh.IAPETUS),mimas:this.saturnGroup.getObjectByName(Gh.MIMAS),enceladus:this.saturnGroup.getObjectByName(Gh.ENCELADUS),uranusPlanetSystem:this.uranusGroup.getObjectByName($.PLANET_SYSTEM_NAME),uranusPlanet:this.uranusGroup.getObjectByName($.PLANET_NAME),miranda:this.uranusGroup.getObjectByName(Zh.MIRANDA),ariel:this.uranusGroup.getObjectByName(Zh.ARIEL),umbriel:this.uranusGroup.getObjectByName(Zh.UMBRIEL),titania:this.uranusGroup.getObjectByName(Zh.TITANIA),oberon:this.uranusGroup.getObjectByName(Zh.OBERON),neptunePlanetSystem:this.neptuneGroup.getObjectByName($.PLANET_SYSTEM_NAME),neptunePlanet:this.neptuneGroup.getObjectByName($.PLANET_NAME),triton:this.neptuneGroup.getObjectByName(Vh.TRITON),proteus:this.neptuneGroup.getObjectByName(Vh.PROTEUS),nereid:this.neptuneGroup.getObjectByName(Vh.NEREID)}}initDoubleClickZoom(){let e=this.earthGroup.getObjectByName($.PLANET_NAME),t=this.mercuryGroup.getObjectByName($.PLANET_NAME),n=this.venusGroup.getObjectByName($.PLANET_NAME),r=this.marsGroup.getObjectByName($.PLANET_NAME),i=this.jupiterGroup.getObjectByName($.PLANET_NAME),a=this.saturnGroup.getObjectByName($.PLANET_NAME),o=this.uranusGroup.getObjectByName($.PLANET_NAME),s=this.neptuneGroup.getObjectByName($.PLANET_NAME);this.zoomablePlanets=[e,t,n,r,i,a,o,s].filter(e=>e instanceof ni),this.planetInteractionController=Wh({renderer:this.renderer,camera:this.camera,controls:this.controls,planets:this.zoomablePlanets,onResetView:this.resetPlanetZoomView}),this.renderer.domElement.addEventListener(`dblclick`,this.planetInteractionController.handleDoubleClickPlanetZoom),this.renderer.domElement.addEventListener(`pointermove`,this.planetInteractionController.handlePlanetHover),this.renderer.domElement.addEventListener(`pointerleave`,this.planetInteractionController.clearPlanetHover)}render(){this.controls.update(),this.composer.render(),this.labelRenderer.render(this.scene,this.camera),Q.isAnimating&&this.animate(),this.#e()}#e(){(Q.showOrbits!==this._prevShowOrbits||Q.showLabels!==this._prevShowLabels||Q.showPlanets!==this._prevShowPlanets)&&(this._prevShowOrbits=Q.showOrbits,this._prevShowLabels=Q.showLabels,this._prevShowPlanets=Q.showPlanets,[this.earthGroup,this.mercuryGroup,this.venusGroup,this.marsGroup,this.jupiterGroup,this.saturnGroup,this.uranusGroup,this.neptuneGroup].forEach(e=>{let t=e.getObjectByName($.PLANET_ORBIT_NAME);t&&(t.visible=Q.showOrbits),e.traverse(e=>{(e.name===$.PLANET_NAME||e.name===$.PLANET_RING_NAME||e.name===$.PLANET_AXIS_NAME||e.name===$.PLANET_ATMO_SPHERE_NAME||e.name.startsWith($.PLANET_MOONS_NAME)||e.name.endsWith(`-current-position`))&&(e.visible=Q.showPlanets),e.name===$.PLANET_LABEL_NAME&&(e.visible=Q.showLabels)})}))}animate(){this.frameCount++,this.sunMesh.rotateY(Lp*Q.accelerationRotation),Ch(this.dayIndex),this.dayFraction=Number(((this.dayFraction+1/Q.lerpFrame)*Q.accelerationOrbit).toFixed(3)),this.dayFraction>=1&&(this.dayIndex+=1,this.dayFraction=0);let e={dayIndex:this.dayIndex,dayFraction:this.dayFraction,frameCount:this.frameCount,buf:this._interpolatedPos};tg(e,this._cachedMeshes,this.userDataEarthPositionRes),ng(e,this._cachedMeshes,this.mercuryGroup.userData.planetPositionsRes),rg(e,this._cachedMeshes,this.venusGroup.userData.planetPositionsRes),ig(e,this._cachedMeshes,this.marsGroup.userData.planetPositionsRes),ag(e,this._cachedMeshes,this.jupiterGroup.userData.planetPositionsRes),og(e,this._cachedMeshes,this.saturnGroup.userData.planetPositionsRes),sg(e,this._cachedMeshes,this.uranusGroup.userData.planetPositionsRes),cg(e,this._cachedMeshes,this.neptuneGroup.userData.planetPositionsRes),this.asteroidBelt.animate(.016)}};window.addEventListener(`DOMContentLoaded`,()=>{new vg});