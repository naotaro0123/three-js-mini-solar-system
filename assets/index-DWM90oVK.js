...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function js(e,t,n){let r=new Float32Array(_s),i=new W(0,1,0);return new Ca({name:`SphericalGaussianBlur`,defines:{n:_s,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ps(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ms(){return new Ca({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ps(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ns(){return new Ca({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ps(),fragmentShader:`
	...
	`}var Fs=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ol={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function sl(e,t){let n=ol[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var cl=new W;function ll(){return K.getLuminanceCoefficients(cl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${cl.x.toFixed(4)}, ${cl.y.toFixed(4)}, ${cl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};rf.BlurDirectionX=new U(1,0),rf.BlurDirectionY=new U(0,1);var af=class extends Dn{constructor(e=document.createElement(`div`)){super(),this.isCSS2DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.center=new U(.5,.5),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element&&e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this.center=e.center,this}},of=new W,sf=new q,cf=new q,lf=new W,uf=new W,df=class{constructor(e={}){let t=this,n,r,i,a,o={objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s,this.sortObjects=!0,this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),sf.copy(t.matrixWorldInverse),cf.multiplyMatrices(t.projectionMatrix,sf),l(e,e,t),this.sortObjects&&f(e)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`};function c(e){e.isCSS2DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)c(e.children[t])}function l(e,n,r){if(e.visible===!1){c(e);return}if(e.isCSS2DObject){of.setFromMatrixPosition(e.matrixWorld),of.applyMatrix4(cf);let c=of.z>=-1&&of.z<=1&&e.layers.test(r.layers)===!0,l=e.element;l.style.display=c===!0?``:`none`,c===!0&&(e.onBeforeRender(t,n,r),l.style.transform=`translate(`+-100*e.center.x+`%,`+-100*e.center.y+`%)translate(`+(of.x*i+i)+`px,`+(-of.y*a+a)+`px)`,l.parentNode!==s&&s.appendChild(l),e.onAfterRender(t,n,r));let d={distanceToCameraSquared:u(r,e)};o.objects.set(e,d)}for(let t=0,i=e.children.length;t<i;t++)l(e.children[t],n,r)}function u(e,t){return lf.setFromMatrixPosition(e.matrixWorld),uf.setFromMatrixPosition(t.matrixWorld),lf.distanceToSquared(uf)}function d(e){let t=[];return e.traverseVisible(function(e){e.isCSS2DObject&&t.push(e)}),t}function f(e){let t=d(e).sort(function(e,t){return e.renderOrder===t.renderOrder?o.objects.get(e).distanceToCameraSquared-o.objects.get(t).distanceToCameraSquared:t.renderOrder-e.renderOrder}),n=t.length;for(let e=0,r=t.length;e<r;e++)t[e].element.style.zIndex=n-e}}},ff=365.2425,pf=6048e5,mf=864e5,hf=3600*24;hf*7,hf*ff/12*3;var gf=Symbol.for(`constructDateFrom`);function _f(e,t){return typeof e==`function`?e(t):e&&typeof e==`object`&&gf in e?e[gf](t):e instanceof Date?new e.constructor(t):new Date(t)}function vf(e,t){return _f(t||e,e)}function yf(e,t,n){let r=vf(e,n?.in);return isNaN(t)?_f(n?.in||e,NaN):(t&&r.setDate(r.getDate()+t),r)}var bf={};function xf(){return bf}function Sf(e,t){let n=xf(),r=t?.weekStartsOn??t?.locale?.options?.weekStartsOn??n.weekStartsOn??n.locale?.options?.weekStartsOn??0,i=vf(e,t?.in),a=i.getDay(),o=(a<r?7:0)+a-r;return i.setDate(i.getDate()-o),i.setHours(0,0,0,0),i}function Cf(e,t){return Sf(e,{...t,weekStartsOn:1})}function wf(e,t){let n=vf(e,t?.in),r=n.getFullYear(),i=_f(n,0);i.setFullYear(r+1,0,4),i.setHours(0,0,0,0);let a=Cf(i),o=_f(n,0);o.setFullYear(r,0,4),o.setHours(0,0,0,0);let s=Cf(o);return n.getTime()>=a.getTime()?r+1:n.getTime()>=s.getTime()?r:r-1}function Tf(e){let t=vf(e),n=new Date(Date.UTC(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds(),t.getMilliseconds()));return n.setUTCFullYear(t.getFullYear()),e-+n}function Ef(e,...t){let n=_f.bind(null,e||t.find(e=>typeof e==`object`));return t.map(n)}function Df(e,t){let n=vf(e,t?.in);return n.setHours(0,0,0,0),n}function Of(e,t,n){let[r,i]=Ef(n?.in,e,t),a=Df(r),o=Df(i),s=+a-Tf(a),c=+o-Tf(o);return Math.round((s-c)/mf)}function kf(e,t){let n=wf(e,t),r=_f(t?.in||e,0);return r.setFullYear(n,0,4),r.setHours(0,0,0,0),Cf(r)}function Af(e){return e instanceof Date||typeof e==`object`&&Object.prototype.toString.call(e)===`[object Date]`}function jf(e){return!(!Af(e)&&typeof e!=`number`||isNaN(+vf(e)))}function Mf(e,t){let n=vf(e,t?.in);return n.setFullYear(n.getFullYear(),0,1),n.setHours(0,0,0,0),n}var Nf={lessThanXSeconds:{one:`less than a second`,other:`less than {{count}} seconds`},xSeconds:{one:`1 second`,other:`{{count}} seconds`},halfAMinute:`half a minute`,lessThanXMinutes:{one:`less than a minute`,other:`less than {{count}} minutes`},xMinutes:{one:`1 minute`,other:`{{count}} minutes`},aboutXHours:{one:`about 1 hour`,other:`about {{count}} hours`},xHours:{one:`1 hour`,other:`{{count}} hours`},xDays:{one:`1 day`,other:`{{count}} days`},aboutXWeeks:{one:`about 1 week`,other:`about {{count}} weeks`},xWeeks:{one:`1 week`,other:`{{count}} weeks`},aboutXMonths:{one:`about 1 month`,other:`about {{count}} months`},xMonths:{one:`1 month`,other:`{{count}} months`},aboutXYears:{one:`about 1 year`,other:`about {{count}} years`},xYears:{one:`1 year`,other:`{{count}} years`},overXYears:{one:`over 1 year`,other:`over {{count}} years`},almostXYears:{one:`almost 1 year`,other:`almost {{count}} years`}},Pf=(e,t,n)=>{let r,i=Nf[e];return r=typeof i==`string`?i:t===1?i.one:i.other.replace(`{{count}}`,t.toString()),n?.addSuffix?n.comparison&&n.comparison>0?`in `+r:r+` ago`:r};function Ff(e){return(t={})=>{let n=t.width?String(t.width):e.defaultWidth;return e.formats[n]||e.formats[e.defaultWidth]}}var If={date:Ff({formats:{full:`EEEE, MMMM do, y`,long:`MMMM do, y`,medium:`MMM d, y`,short:`MM/dd/yyyy`},defaultWidth:`full`}),time:Ff({formats:{full:`h:mm:ss a zzzz`,long:`h:mm:ss a z`,medium:`h:mm:ss a`,short:`h:mm a`},defaultWidth:`full`}),dateTime:Ff({formats:{full:`{{date}} 'at' {{time}}`,long:`{{date}} 'at' {{time}}`,medium:`{{date}}, {{time}}`,short:`{{date}}, {{time}}`},defaultWidth:`full`})},Lf={lastWeek:`'last' eeee 'at' p`,yesterday:`'yesterday at' p`,today:`'today at' p`,tomorrow:`'tomorrow at' p`,nextWeek:`eeee 'at' p`,other:`P`},Rf=(e,t,n,r)=>Lf[e];function zf(e){return(t,n)=>{let r=n?.context?String(n.context):`standalone`,i;if(r===`formatting`&&e.formattingValues){let t=e.defaultFormattingWidth||e.defaultWidth,r=n?.width?String(n.width):t;i=e.formattingValues[r]||e.formattingValues[t]}else{let t=e.defaultWidth,r=n?.width?String(n.width):e.defaultWidth;i=e.values[r]||e.values[t]}let a=e.argumentCallback?e.argumentCallback(t):t;return i[a]}}var Bf={ordinalNumber:(e,t)=>{let n=Number(e),r=n%100;if(r>20||r<10)switch(r%10){case 1:return n+`st`;case 2:return n+`nd`;case 3:return n+`rd`}return n+`th`},era:zf({values:{narrow:[`B`,`A`],abbreviated:[`BC`,`AD`],wide:[`Before Christ`,`Anno Domini`]},defaultWidth:`wide`}),quarter:zf({values:{narrow:[`1`,`2`,`3`,`4`],abbreviated:[`Q1`,`Q2`,`Q3`,`Q4`],wide:[`1st quarter`,`2nd quarter`,`3rd quarter`,`4th quarter`]},defaultWidth:`wide`,argumentCallback:e=>e-1}),month:zf({values:{narrow:[`J`,`F`,`M`,`A`,`M`,`J`,`J`,`A`,`S`,`O`,`N`,`D`],abbreviated:[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`],wide:[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`]},defaultWidth:`wide`}),day:zf({values:{narrow:[`S`,`M`,`T`,`W`,`T`,`F`,`S`],short:[`Su`,`Mo`,`Tu`,`We`,`Th`,`Fr`,`Sa`],abbreviated:[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`],wide:[`Sunday`,`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`]},defaultWidth:`wide`}),dayPeriod:zf({values:{narrow:{am:`a`,pm:`p`,midnight:`mi`,noon:`n`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},abbreviated:{am:`AM`,pm:`PM`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},wide:{am:`a.m.`,pm:`p.m.`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`}},defaultWidth:`wide`,formattingValues:{narrow:{am:`a`,pm:`p`,midnight:`mi`,noon:`n`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`},abbreviated:{am:`AM`,pm:`PM`,midnight:`midnight`,noon:`noon`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`},wide:{am:`a.m.`,pm:`p.m.`,midnight:`midnight`,noon:`noon`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`}},defaultFormattingWidth:`wide`})};function Vf(e){return(t,n={})=>{let r=n.width,i=r&&e.matchPatterns[r]||e.matchPatterns[e.defaultMatchWidth],a=t.match(i);if(!a)return null;let o=a[0],s=r&&e.parsePatterns[r]||e.parsePatterns[e.defaultParseWidth],c=Array.isArray(s)?Uf(s,e=>e.test(o)):Hf(s,e=>e.test(o)),l;l=e.valueCallback?e.valueCallback(c):c,l=n.valueCallback?n.valueCallback(l):l;let u=t.slice(o.length);return{value:l,rest:u}}}function Hf(e,t){for(let n in e)if(Object.prototype.hasOwnProperty.call(e,n)&&t(e[n]))return n}function Uf(e,t){for(let n=0;n<e.length;n++)if(t(e[n]))return n}function Wf(e){return(t,n={})=>{let r=t.match(e.matchPattern);if(!r)return null;let i=r[0],a=t.match(e.parsePattern);if(!a)return null;let o=e.valueCallback?e.valueCallback(a[0]):a[0];o=n.valueCallback?n.valueCallback(o):o;let s=t.slice(i.length);return{value:o,rest:s}}}var Gf={code:`en-US`,formatDistance:Pf,formatLong:If,formatRelative:Rf,localize:Bf,match:{ordinalNumber:Wf({matchPattern:/^(\d+)(th|st|nd|rd)?/i,parsePattern:/\d+/i,valueCallback:e=>parseInt(e,10)}),era:Vf({matchPatterns:{narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},defaultMatchWidth:`wide`,parsePatterns:{any:[/^b/i,/^(a|c)/i]},defaultParseWidth:`any`}),quarter:Vf({matchPatterns:{narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},defaultMatchWidth:`wide`,parsePatterns:{any:[/1/i,/2/i,/3/i,/4/i]},defaultParseWidth:`any`,valueCallback:e=>e+1}),month:Vf({matchPatterns:{narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},defaultMatchWidth:`wide`,parsePatterns:{narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},defaultParseWidth:`any`}),day:Vf({matchPatterns:{narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},defaultMatchWidth:`wide`,parsePatterns:{narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},defaultParseWidth:`any`}),dayPeriod:Vf({matchPatterns:{narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},defaultMatchWidth:`any`,parsePatterns:{any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},defaultParseWidth:`any`})},options:{weekStartsOn:0,firstWeekContainsDate:1}};function Kf(e,t){let n=vf(e,t?.in);return Of(n,Mf(n))+1}function qf(e,t){let n=vf(e,t?.in),r=Cf(n)-+kf(n);return Math.round(r/pf)+1}function Jf(e,t){let n=vf(e,t?.in),r=n.getFullYear(),i=xf(),a=t?.firstWeekContainsDate??t?.locale?.options?.firstWeekContainsDate??i.firstWeekContainsDate??i.locale?.options?.firstWeekContainsDate??1,o=_f(t?.in||e,0);o.setFullYear(r+1,0,a),o.setHours(0,0,0,0);let s=Sf(o,t),c=_f(t?.in||e,0);c.setFullYear(r,0,a),c.setHours(0,0,0,0);let l=Sf(c,t);return+n>=+s?r+1:+n>=+l?r:r-1}function Yf(e,t){let n=xf(),r=t?.firstWeekContainsDate??t?.locale?.options?.firstWeekContainsDate??n.firstWeekContainsDate??n.locale?.options?.firstWeekContainsDate??1,i=Jf(e,t),a=_f(t?.in||e,0);return a.setFullYear(i,0,r),a.setHours(0,0,0,0),Sf(a,t)}function Xf(e,t){let n=vf(e,t?.in),r=Sf(n,t)-+Yf(n,t);return Math.round(r/pf)+1}function Zf(e,t){return(e<0?`-`:``)+Math.abs(e).toString().padStart(t,`0`)}var Qf={y(e,t){let n=e.getFullYear(),r=n>0?n:1-n;return Zf(t===`yy`?r%100:r,t.length)},M(e,t){let n=e.getMonth();return t===`M`?String(n+1):Zf(n+1,2)},d(e,t){return Zf(e.getDate(),t.length)},a(e,t){let n=e.getHours()/12>=1?`pm`:`am`;switch(t){case`a`:case`aa`:return n.toUpperCase();case`aaa`:return n;case`aaaaa`:return n[0];default:return n===`am`?`a.m.`:`p.m.`}},h(e,t){return Zf(e.getHours()%12||12,t.length)},H(e,t){return Zf(e.getHours(),t.length)},m(e,t){return Zf(e.getMinutes(),t.length)},s(e,t){return Zf(e.getSeconds(),t.length)},S(e,t){let n=t.length,r=e.getMilliseconds();return Zf(Math.trunc(r*10**(n-3)),t.length)}},$f={am:`am`,pm:`pm`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},ep={G:function(e,t,n){let r=+(e.getFullYear()>0);switch(t){case`G`:case`GG`:case`GGG`:return n.era(r,{width:`abbreviated`});case`GGGGG`:return n.era(r,{width:`narrow`});default:return n.era(r,{width:`wide`})}},y:function(e,t,n){if(t===`yo`){let t=e.getFullYear(),r=t>0?t:1-t;return n.ordinalNumber(r,{unit:`year`})}return Qf.y(e,t)},Y:function(e,t,n,r){let i=Jf(e,r),a=i>0?i:1-i;return t===`YY`?Zf(a%100,2):t===`Yo`?n.ordinalNumber(a,{unit:`year`}):Zf(a,t.length)},R:function(e,t){return Zf(wf(e),t.length)},u:function(e,t){return Zf(e.getFullYear(),t.length)},Q:function(e,t,n){let r=Math.ceil((e.getMonth()+1)/3);switch(t){case`Q`:return String(r);case`QQ`:return Zf(r,2);case`Qo`:return n.ordinalNumber(r,{unit:`quarter`});case`QQQ`:return n.quarter(r,{width:`abbreviated`,context:`formatting`});case`QQQQQ`:return n.quarter(r,{width:`narrow`,context:`formatting`});default:return n.quarter(r,{width:`wide`,context:`formatting`})}},q:function(e,t,n){let r=Math.ceil((e.getMonth()+1)/3);switch(t){case`q`:return String(r);case`qq`:return Zf(r,2);case`qo`:return n.ordinalNumber(r,{unit:`quarter`});case`qqq`:return n.quarter(r,{width:`abbreviated`,context:`standalone`});case`qqqqq`:return n.quarter(r,{width:`narrow`,context:`standalone`});default:return n.quarter(r,{width:`wide`,context:`standalone`})}},M:function(e,t,n){let r=e.getMonth();switch(t){case`M`:case`MM`:return Qf.M(e,t);case`Mo`:return n.ordinalNumber(r+1,{unit:`month`});case`MMM`:return n.month(r,{width:`abbreviated`,context:`formatting`});case`MMMMM`:return n.month(r,{width:`narrow`,context:`formatting`});default:return n.month(r,{width:`wide`,context:`formatting`})}},L:function(e,t,n){let r=e.getMonth();switch(t){case`L`:return String(r+1);case`LL`:return Zf(r+1,2);case`Lo`:return n.ordinalNumber(r+1,{unit:`month`});case`LLL`:return n.month(r,{width:`abbreviated`,context:`standalone`});case`LLLLL`:return n.month(r,{width:`narrow`,context:`standalone`});default:return n.month(r,{width:`wide`,context:`standalone`})}},w:function(e,t,n,r){let i=Xf(e,r);return t===`wo`?n.ordinalNumber(i,{unit:`week`}):Zf(i,t.length)},I:function(e,t,n){let r=qf(e);return t===`Io`?n.ordinalNumber(r,{unit:`week`}):Zf(r,t.length)},d:function(e,t,n){return t===`do`?n.ordinalNumber(e.getDate(),{unit:`date`}):Qf.d(e,t)},D:function(e,t,n){let r=Kf(e);return t===`Do`?n.ordinalNumber(r,{unit:`dayOfYear`}):Zf(r,t.length)},E:function(e,t,n){let r=e.getDay();switch(t){case`E`:case`EE`:case`EEE`:return n.day(r,{width:`abbreviated`,context:`formatting`});case`EEEEE`:return n.day(r,{width:`narrow`,context:`formatting`});case`EEEEEE`:return n.day(r,{width:`short`,context:`formatting`});default:return n.day(r,{width:`wide`,context:`formatting`})}},e:function(e,t,n,r){let i=e.getDay(),a=(i-r.weekStartsOn+8)%7||7;switch(t){case`e`:return String(a);case`ee`:return Zf(a,2);case`eo`:return n.ordinalNumber(a,{unit:`day`});case`eee`:return n.day(i,{width:`abbreviated`,context:`formatting`});case`eeeee`:return n.day(i,{width:`narrow`,context:`formatting`});case`eeeeee`:return n.day(i,{width:`short`,context:`formatting`});default:return n.day(i,{width:`wide`,context:`formatting`})}},c:function(e,t,n,r){let i=e.getDay(),a=(i-r.weekStartsOn+8)%7||7;switch(t){case`c`:return String(a);case`cc`:return Zf(a,t.length);case`co`:return n.ordinalNumber(a,{unit:`day`});case`ccc`:return n.day(i,{width:`abbreviated`,context:`standalone`});case`ccccc`:return n.day(i,{width:`narrow`,context:`standalone`});case`cccccc`:return n.day(i,{width:`short`,context:`standalone`});default:return n.day(i,{width:`wide`,context:`standalone`})}},i:function(e,t,n){let r=e.getDay(),i=r===0?7:r;switch(t){case`i`:return String(i);case`ii`:return Zf(i,t.length);case`io`:return n.ordinalNumber(i,{unit:`day`});case`iii`:return n.day(r,{width:`abbreviated`,context:`formatting`});case`iiiii`:return n.day(r,{width:`narrow`,context:`formatting`});case`iiiiii`:return n.day(r,{width:`short`,context:`formatting`});default:return n.day(r,{width:`wide`,context:`formatting`})}},a:function(e,t,n){let r=e.getHours()/12>=1?`pm`:`am`;switch(t){case`a`:case`aa`:return n.dayPeriod(r,{width:`abbreviated`,context:`formatting`});case`aaa`:return n.dayPeriod(r,{width:`abbreviated`,context:`formatting`}).toLowerCase();case`aaaaa`:return n.dayPeriod(r,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(r,{width:`wide`,context:`formatting`})}},b:function(e,t,n){let r=e.getHours(),i;switch(i=r===12?$f.noon:r===0?$f.midnight:r/12>=1?`pm`:`am`,t){case`b`:case`bb`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`});case`bbb`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`}).toLowerCase();case`bbbbb`:return n.dayPeriod(i,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(i,{width:`wide`,context:`formatting`})}},B:function(e,t,n){let r=e.getHours(),i;switch(i=r>=17?$f.evening:r>=12?$f.afternoon:r>=4?$f.morning:$f.night,t){case`B`:case`BB`:case`BBB`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`});case`BBBBB`:return n.dayPeriod(i,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(i,{width:`wide`,context:`formatting`})}},h:function(e,t,n){if(t===`ho`){let t=e.getHours()%12;return t===0&&(t=12),n.ordinalNumber(t,{unit:`hour`})}return Qf.h(e,t)},H:function(e,t,n){return t===`Ho`?n.ordinalNumber(e.getHours(),{unit:`hour`}):Qf.H(e,t)},K:function(e,t,n){let r=e.getHours()%12;return t===`Ko`?n.ordinalNumber(r,{unit:`hour`}):Zf(r,t.length)},k:function(e,t,n){let r=e.getHours();return r===0&&(r=24),t===`ko`?n.ordinalNumber(r,{unit:`hour`}):Zf(r,t.length)},m:function(e,t,n){return t===`mo`?n.ordinalNumber(e.getMinutes(),{unit:`minute`}):Qf.m(e,t)},s:function(e,t,n){return t===`so`?n.ordinalNumber(e.getSeconds(),{unit:`second`}):Qf.s(e,t)},S:function(e,t){return Qf.S(e,t)},X:function(e,t,n){let r=e.getTimezoneOffset();if(r===0)return`Z`;switch(t){case`X`:return np(r);case`XXXX`:case`XX`:return rp(r);default:return rp(r,`:`)}},x:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`x`:return np(r);case`xxxx`:case`xx`:return rp(r);default:return rp(r,`:`)}},O:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`O`:case`OO`:case`OOO`:return`GMT`+tp(r,`:`);default:return`GMT`+rp(r,`:`)}},z:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`z`:case`zz`:case`zzz`:return`GMT`+tp(r,`:`);default:return`GMT`+rp(r,`:`)}},t:function(e,t,n){return Zf(Math.trunc(e/1e3),t.length)},T:function(e,t,n){return Zf(+e,t.length)}};function tp(e,t=``){let n=e>0?`-`:`+`,r=Math.abs(e),i=Math.trunc(r/60),a=r%60;return a===0?n+String(i):n+String(i)+t+Zf(a,2)}function np(e,t){return e%60==0?(e>0?`-`:`+`)+Zf(Math.abs(e)/60,2):rp(e,t)}function rp(e,t=``){let n=e>0?`-`:`+`,r=Math.abs(e),i=Zf(Math.trunc(r/60),2),a=Zf(r%60,2);return n+i+t+a}var ip=(e,t)=>{switch(e){case`P`:return t.date({width:`short`});case`PP`:return t.date({width:`medium`});case`PPP`:return t.date({width:`long`});default:return t.date({width:`full`})}},ap=(e,t)=>{switch(e){case`p`:return t.time({width:`short`});case`pp`:return t.time({width:`medium`});case`ppp`:return t.time({width:`long`});default:return t.time({width:`full`})}},op={p:ap,P:(e,t)=>{let n=e.match(/(P+)(p+)?/)||[],r=n[1],i=n[2];if(!i)return ip(e,t);let a;switch(r){case`P`:a=t.dateTime({width:`short`});break;case`PP`:a=t.dateTime({width:`medium`});break;case`PPP`:a=t.dateTime({width:`long`});break;default:a=t.dateTime({width:`full`});break}return a.replace(`{{date}}`,ip(r,t)).replace(`{{time}}`,ap(i,t))}},sp=/^D+$/,cp=/^Y+$/,lp=[`D`,`DD`,`YY`,`YYYY`];function up(e){return sp.test(e)}function dp(e){return cp.test(e)}function fp(e,t,n){let r=pp(e,t,n);if(console.warn(r),lp.includes(e))throw RangeError(r)}function pp(e,t,n){let r=e[0]===`Y`?`years`:`days of the month`;return`Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${r} to the input \`${n}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}var mp=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,hp=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,gp=/^'([^]*?)'?$/,_p=/''/g,vp=/[a-zA-Z]/;function yp(e,t,n){let r=xf(),i=n?.locale??r.locale??Gf,a=n?.firstWeekContainsDate??n?.locale?.options?.firstWeekContainsDate??r.firstWeekContainsDate??r.locale?.options?.firstWeekContainsDate??1,o=n?.weekStartsOn??n?.locale?.options?.weekStartsOn??r.weekStartsOn??r.locale?.options?.weekStartsOn??0,s=vf(e,n?.in);if(!jf(s))throw RangeError(`Invalid time value`);let c=t.match(hp).map(e=>{let t=e[0];if(t===`p`||t===`P`){let n=op[t];return n(e,i.formatLong)}return e}).join(``).match(mp).map(e=>{if(e===`''`)return{isToken:!1,value:`'`};let t=e[0];if(t===`'`)return{isToken:!1,value:bp(e)};if(ep[t])return{isToken:!0,value:e};if(t.match(vp))throw RangeError("Format string contains an unescaped latin alphabet character `"+t+"`");return{isToken:!1,value:e}});i.localize.preprocessor&&(c=i.localize.preprocessor(s,c));let l={firstWeekContainsDate:a,weekStartsOn:o,locale:i};return c.map(r=>{if(!r.isToken)return r.value;let a=r.value;(!n?.useAdditionalWeekYearTokens&&dp(a)||!n?.useAdditionalDayOfYearTokens&&up(a))&&fp(a,t,String(e));let o=ep[a[0]];return o(s,a,i.localize,l)}).join(``)}function bp(e){let t=e.match(gp);return t?t[1].replace(_p,`'`):e}var xp=`/api/v1/planet-position`,Sp=`planet-position-cache-db`,Cp=`planet_positions`,wp=1,Tp=()=>new Promise((e,t)=>{let n=indexedDB.open(Sp,wp);n.onupgradeneeded=()=>{let e=n.result;e.objectStoreNames.contains(Cp)||e.createObjectStore(Cp,{keyPath:`key`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error)}),Ep=async e=>{try{let t=await Tp(),n=await new Promise((n,r)=>{let i=t.transaction(Cp,`readonly`).objectStore(Cp).get(e);i.onsuccess=()=>n(i.result??null),i.onerror=()=>r(i.error)});return t.close(),n}catch{return null}},Dp=async(e,t)=>{let n={key:e,...t};try{let e=await Tp();await new Promise((t,r)=>{let i=e.transaction(Cp,`readwrite`).objectStore(Cp).put(n);i.onsuccess=()=>t(),i.onerror=()=>r(i.error)}),e.close()}catch{}},Op=async e=>{try{let t=await Tp();await new Promise((n,r)=>{let i=t.transaction(Cp,`readwrite`).objectStore(Cp).delete(e);i.onsuccess=()=>n(),i.onerror=()=>r(i.error)}),t.close()}catch{}},kp=e=>{switch(e){case`EARTH`:return 365;case`MERCURY`:return 88;case`VENUS`:return 225;case`MARS`:return 687;case`JUPITER`:return 4333;case`SATURN`:return 10759;case`URANUS`:return 30687;case`NEPTUNE`:return 60190;default:return 364}},Ap=e=>{switch(e){case`EARTH`:return 1;case`MERCURY`:return 58.6;case`VENUS`:return 243;case`MARS`:return 1.03;case`JUPITER`:return .41;case`SATURN`:return .45;case`URANUS`:return .72;case`NEPTUNE`:return .67;default:return 1}},Q={lerpFrame:60,accelerationOrbit:1,accelerationRotation:1,sunIntensity:2.1,zoomMinDistance:5,zoomMaxDistance:4500,isAnimating:!0,isOrbitPausedByZoom:!1,showOrbits:!0,showLabels:!0,showCurrentPosition:!0,showPlanets:!0},jp=6.4,Mp=23.4,Np=`Earth`,Pp=16777215,Fp=jp/3.7,Ip=27.322,Lp=2e-5,Rp=jp*109/40,zp=.001,Bp=16775311,Vp=16646099,Hp=1.4,Up=15265791,Wp=8e4,Gp=.5,Kp=2.4,qp=2.1,Jp=`Mercury`,Yp=39423,Xp=6.1,Zp=177.4,Qp=`Venus`,$p=16766720,em=jp*.53,tm=25.2,nm=`Mars`,rm=16729344,im=jp*11,am=3.13,om=`Jupiter`,sm=39168,cm=jp*9.4,lm=26.7,um=`Saturn`,dm=10053120,fm=jp*4,pm=97.8,mm=`Uranus`,hm=6684825,gm=jp*3.9,_m=28.3,vm=`Neptune`,ym=3368703,bm=1,xm=5,Sm=30,Cm=90,wm=120,Tm=180,Em=e=>{switch(e){case`JUPITER`:return Sm;case`MARS`:return xm;case`SATURN`:return Cm;case`URANUS`:return wm;case`NEPTUNE`:return Tm;default:return bm}},Dm=e=>`${Em(e)}days`,Om=e=>{switch(e){case`EARTH`:return Pp;case`MERCURY`:return Yp;case`VENUS`:return $p;case`MARS`:return rm;case`JUPITER`:return sm;case`SATURN`:return dm;case`URANUS`:return hm;case`NEPTUNE`:return ym;default:return Pp}},km=e=>e*Math.PI/180,Am=e=>new Promise(t=>setTimeout(t,e)),jm=e=>/^(?:https?:)?\/\//.test(e)||e.startsWith(`data:`)||e.startsWith(`blob:`)?e:`/three-js-mini-solar-system/${e.replace(/^\.?\//,``)}`,Mm=e=>new Promise((t,n)=>{new Xu().load(jm(e),e=>{t(e.scene)},void 0,e=>{n(e)})}),Nm=`https://three-js-mini-solar-system.onrender.com`.replace(/\/+$/,``),Pm=`planet-position-cache:v2`,Fm=new Set([429,500,502,503,504]),Im=3,Lm=e=>{if(e.length===0)return e;let t=e[0],n=e[e.length-1];return t.equals(n)?e:[...e,t.clone()]},Rm=async e=>{let t=null;for(let n=0;n<=Im;n++)try{let t=await fetch(e);if(!t.ok){if(Fm.has(t.status)&&n<Im){await Am(300*(n+1));continue}throw Error(`HTTP error! status: ${t.status}`)}return t}catch(e){if(t=e instanceof Error?e:Error(String(e)),n<Im){await Am(300*(n+1));continue}}throw t??Error(`Planet position request failed`)},zm=()=>Kf(new Date),Bm=(e,t,n,r)=>`${Pm}:${e}:${t}:${n}:${r}`,Vm=async e=>{try{let t=await Ep(e);if(!t)return null;if(!Array.isArray(t.pathPoints))return await Op(e),null;let n=t.pathPoints.map(e=>new W(e.x,e.y,e.z));return{todayRow:zm(),pathPoints:n}}catch{return null}},Hm=async(e,t)=>{await Dp(e,{pathPoints:t.pathPoints.map(e=>({x:e.x,y:e.y,z:e.z}))})},Um=async e=>{let t=new Date().getFullYear(),n=new Date(`${t}-01-01`),r=yp(n,`yyyy-MM-dd`),i=yp(yf(n,kp(e)),`yyyy-MM-dd`),a=Dm(e),o=Bm(e,r,i,a),s=await Vm(o);if(s)return s;await Am(50);let c=`${Nm}${xp}?START_TIME=${r}&STOP_TIME=${i}&STEP_SIZE=${a}&COMMAND=${e}`,l={todayRow:0,pathPoints:[]};try{let e=await(await Rm(c)).json();if(e.result){let t=e.result.split(`
`).filter(e=>e.includes(`X =`)),n=[];t.forEach((e,t)=>{let r=e.split(/[X,Y,Z, =]/).filter(e=>e.trim()),i=parseFloat(r[0]),a=parseFloat(r[1]),o=parseFloat(r[2]);n.push({x:i,y:a,z:o,day:t+1})}),l.pathPoints=Lm(n.map(e=>new W(e.x*90,e.z*90,e.y*90)).reverse()),l.todayRow=zm(),await Hm(o,l)}else console.error(`データの取得に失敗しました:`,e)}catch(e){console.error(`API呼び出し中にエラーが発生しました:`,e)}finally{return l}},Wm=e=>`${e}-current-position`,Gm=({parent:e,commandKey:t,planetPositionsRes:n,radius:r=1,color:i})=>{let a=new ni(new ma(r,32,32),new Wr({color:i??Om(t),depthTest:!1,depthWrite:!1}));a.name=Wm(t),a.renderOrder=999;let{pathPoints:o,todayRow:s}=n,c=o.length-1,l=s-1,u=Em(t),d=Math.floor(l/u)%c,f=(d+1)%c,p=l%u/u,m=o[d],h=o[f],g=new W().fromArray(m.toArray()).lerp(new W().fromArray(h.toArray()),p);return a.position.copy(g),e.add(a),a},Km=(e,t)=>{let n=e.getObjectByName(Wm(t));n&&(e.remove(n),n instanceof ni&&(n.geometry.dispose(),Array.isArray(n.material)?n.material.forEach(e=>e.dispose()):n.material.dispose()))},$={PLANET_NAME:`Planet`,PLANET_ORBIT_NAME:`PlanetOrbit`,PLANET_RING_NAME:`PlanetRing`,PLANET_AXIS_NAME:`PlanetAxis`,PLANET_SYSTEM_NAME:`PlanetSystem`,PLANET_ATMO_SPHERE_NAME:`PlanetAtmosphere`,PLANET_MOONS_NAME:`PlanetMoons`,PLANET_LABEL_NAME:`PlanetLabel`},qm={MERCURY:`Mercury（水星）`,VENUS:`Venus（金星）`,EARTH:`Earth（地球）`,MARS:`Mars（火星）`,JUPITER:`Jupiter（木星）`,SATURN:`Saturn（土星）`,URANUS:`Uranus（天王星）`,NEPTUNE:`Neptune（海王星）`,PLUTO:`Pluto（冥王星）`},Jm=(e,t,n,r,i,a,o,s,c,l,u,d=!1)=>{let f=new oo,p;p=a instanceof Fr?a:o?new Da({map:f.load(jm(a)),bumpMap:f.load(jm(o)),bumpScale:.7}):new Da({map:f.load(jm(a))});let m=new ni(new ma(n,32,20),p);m.rotation.z=km(r),m.castShadow=!0,m.receiveShadow=!0,m.name=$.PLANET_NAME;let h=new On;h.name=$.PLANET_SYSTEM_NAME;let g=u.pathPoints.length-1,_=u.todayRow-1,v=Em(e),y=Math.floor(_/v)%g,b=(y+1)%g,x=_%v/v,S=u.pathPoints[y],C=u.pathPoints[b],w=new W().fromArray(S.toArray()).lerp(new W().fromArray(C.toArray()),x);h.position.copy(w),h.add(m);let T=document.createElement(`div`);T.className=`planet-name-label`,T.textContent=qm[e]??t;let E=new af(T);E.name=$.PLANET_LABEL_NAME,E.position.set(0,n+3,0),h.add(E);let D=document.createElement(`div`);D.className=`planet-tilt-label`,D.textContent=`傾き: ${r}°`;let O=new af(D);O.name=$.PLANET_LABEL_NAME,O.position.set(0,-(n+3),0),h.add(O);{let e=.1,t=new ni(new la(e,e,2.8*n,32),new Wr({color:65280}));t.name=$.PLANET_AXIS_NAME,t.rotation.z=km(r),h.add(t)}if(s){let e=new ni(new pa(s.innerRadius,s.outerRadius,30),new Ta({map:f.load(jm(s.texture)),side:2}));e.name=$.PLANET_RING_NAME,e.rotation.x=km(90),e.rotation.y=km(r),h.add(e);let t=3.6;e.scale.set(t,t,t)}if(c){let e=new ni(new ma(n+.1,32,20),new Da({map:f.load(jm(c)),transparent:!0,opacity:.4,depthTest:!0,depthWrite:!1}));e.name=$.PLANET_ATMO_SPHERE_NAME,e.rotation.z=.41,m.add(e)}let k=0;for(let e of l){let t;if(e.texture===void 0)continue;t=e.bump?new Ta({map:f.load(jm(e.texture)),bumpMap:f.load(jm(e.bump)),bumpScale:.5}):new Ta({map:f.load(jm(e.texture))});let r=new ni(new ma(e.size,32,20),t);r.name=`${$.PLANET_MOONS_NAME}_${k}`,r.castShadow=!0,r.receiveShadow=!0,k++;let i=n*1.5;r.position.set(i,0,0),h.add(r),e.mesh=r}let A=new On;A.add(h),A.name=t,A.userData={planetPositionsRes:u,commandKey:e};let j=new Gi(new Ar().setFromPoints(u.pathPoints),new Li({color:i,transparent:!0,opacity:.2}));return j.name=$.PLANET_ORBIT_NAME,A.add(j),d&&Gm({parent:A,commandKey:e,planetPositionsRes:u}),A},Ym={MOON:`${$.PLANET_MOONS_NAME}_Moon`},Xm=[{size:Fp,texture:`/images/moonmap.jpg`,bump:`/images/moonbump.jpg`,orbitSpeed:.001*Q.accelerationOrbit,orbitRadius:10,orbitalPeriodDays:27.322}],Zm=async(e,t)=>{let n=new oo,r=new Ca({uniforms:{dayTexture:{value:n.load(jm(`/images/earth_daymap.jpg`))},nightTexture:{value:n.load(jm(`/images/earth_nightmap.jpg`))},sunPosition:{value:e}},vertexShader:`
        varying vec3 vNormal;
        varying vec2 vUv;
      ...
      `}),i=await Um(`EARTH`),a=Jm(`EARTH`,Np,jp,Mp,Om(`EARTH`),r,null,null,`/images/earth_atmosphere.jpg`,Xm,i,t),o=a.getObjectByName($.PLANET_SYSTEM_NAME).children.find(e=>e.name.startsWith($.PLANET_MOONS_NAME));return o&&(o.name=Ym.MOON),a},Qm=[0,24,150],$m=[0,36,220],eh=.01,th=()=>typeof window>`u`?768:window.innerWidth,nh=(e=th())=>e<=767?$m:Qm,rh=(e=th())=>{let[t,n,r]=nh(e);return Math.hypot(t,n,r)},ih=(e=th())=>[0,rh(e),eh],ah=(e=th())=>[rh(e),0,eh],oh=(e,t,n)=>{e.position.set(...n),e.up.set(0,1,0),t.target.set(0,0,0),t.update()},sh=(e,t,n=th())=>{oh(e,t,ih(n))},ch=(e,t,n=th())=>{oh(e,t,ah(n))},lh=(e,t,n=th())=>{oh(e,t,nh(n))},uh=e=>{let t=new Date().getFullYear();return yp(yf(new Date(t,0,1),e),`yyyy年MM月dd日`)},dh=(e,t)=>{let n=document.createElement(`div`);n.className=`current-index-label`,n.setAttribute(`aria-live`,`polite`);let r=document.createElement(`div`);r.className=`current-index-label__chip current-index-label__chip--date`;let i=document.createElement(`span`);i.className=`current-index-label__caption`,i.textContent=`現在日付`;let a=document.createElement(`span`);a.className=`current-index-label__value`,a.textContent=uh(e),r.append(i,a);let o=document.createElement(`div`);o.className=`current-index-label__chip current-index-label__chip--zoom`;let s=document.createElement(`span`);s.className=`current-index-label__caption`,s.textContent=`ズーム距離`;let c=document.createElement(`span`);return c.className=`current-index-label__zoom`,c.textContent=`Zoom ${t}`,o.append(s,c),n.append(r,o),n},fh=(e,t)=>{let n=e.querySelector(`.current-index-label__value`);n&&(n.textContent=uh(t))},ph=(e,t)=>{let n=e.querySelector(`.current-index-label__zoom`);n&&(n.textContent=`Zoom ${t}`)},mh=(e,t,n)=>{let r=window.innerWidth,i=window.innerHeight;t.setSize(r,i),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),n?.setSize(r,i),e.aspect=r/i,e.updateProjectionMatrix()},hh={...Q},gh=null,_h=null,vh=null,yh=null,bh=null,xh=null,Sh=null,Ch=null,wh=null,Th=null,Eh=null,Dh=null,Oh=null,kh=null,Ah=!0,jh=0,Mh=!1,Nh=new W,Ph=e=>e.toFixed(1),Fh=()=>!Ch||!wh?0:Ch.position.distanceTo(wh.target),Ih=()=>{let e=Ph(Fh());Sh&&ph(Sh,e)},Lh=e=>{if(!wh||(wh.minDistance=Q.zoomMinDistance,wh.maxDistance=Q.zoomMaxDistance,!e?.clampCamera||!Ch))return;Nh.subVectors(Ch.position,wh.target),Nh.lengthSq()===0&&Nh.set(0,0,Q.zoomMinDistance);let t=Nh.length(),n=jt.clamp(t,Q.zoomMinDistance,Q.zoomMaxDistance);if(Math.abs(n-t)<2**-52){Ih();return}Nh.setLength(n),Ch.position.copy(wh.target).add(Nh),wh.update()},Rh=()=>{!_h||!vh||!yh||!bh||(_h.classList.toggle(`is-collapsed`,Ah),vh.hidden=Ah,bh.hidden=Ah,yh.classList.toggle(`is-collapsed`,Ah),yh.textContent=Ah?`設定を展開`:`設定を折りたたむ`,yh.setAttribute(`aria-expanded`,String(!Ah)))},zh=()=>{xh&&(xh.textContent=Q.isAnimating?`アニメーション停止`:`アニメーション再生`,xh.classList.toggle(`is-active`,Q.isAnimating),xh.setAttribute(`aria-pressed`,String(Q.isAnimating)),xh.title=Mh?`惑星ズーム中は操作できません`:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,Sh?.classList.toggle(`is-animating`,Q.isAnimating&&!Q.isOrbitPausedByZoom))},Bh=e=>{jh=e,Sh&&fh(Sh,e)},Vh=e=>{Mh=e,xh&&(xh.disabled=e,xh.classList.toggle(`is-disabled`,e),xh.setAttribute(`aria-disabled`,String(e)),zh())},Hh=()=>{gh&&(gh.accelerationOrbit.value=String(Q.accelerationOrbit),gh.accelerationOrbitValue.value=String(Q.accelerationOrbit),gh.accelerationOrbitValue.textContent=String(Q.accelerationOrbit),gh.accelerationRotation.value=String(Q.accelerationRotation),gh.accelerationRotationValue.value=String(Q.accelerationRotation),gh.accelerationRotationValue.textContent=String(Q.accelerationRotation),gh.sunIntensity.value=String(Q.sunIntensity),gh.sunIntensityValue.value=String(Q.sunIntensity),gh.sunIntensityValue.textContent=String(Q.sunIntensity),Lh({clampCamera:!0}),Ih(),zh(),gh.showOrbits.checked=Q.showOrbits,gh.showLabels.checked=Q.showLabels,gh.showCurrentPosition.checked=Q.showCurrentPosition,Bh(jh),Rh())},Uh=e=>{let{label:t,min:n,max:r,step:i,value:a,onChange:o}=e,s=document.createElement(`label`);s.className=`settings-menu__row settings-menu__row--range`;let c=document.createElement(`span`);c.className=`settings-menu__label`,c.textContent=t;let l=document.createElement(`input`);l.type=`range`,l.min=String(n),l.max=String(r),l.step=String(i),l.value=String(a),l.className=`settings-menu__range`;let u=document.createElement(`output`);return u.className=`settings-menu__value`,u.value=String(a),u.textContent=String(a),l.addEventListener(`input`,()=>{let e=Number(l.value);u.value=l.value,u.textContent=l.value,o(e)}),s.append(c,l,u),{row:s,input:l,output:u}},Wh=e=>{let{label:t,checked:n,onChange:r}=e,i=document.createElement(`label`);i.className=`settings-menu__row settings-menu__row--toggle`;let a=document.createElement(`input`);a.type=`checkbox`,a.checked=n,a.className=`settings-menu__checkbox`,a.addEventListener(`change`,()=>r(a.checked));let o=document.createElement(`span`);return o.className=`settings-menu__label`,o.textContent=t,i.append(a,o),{row:i,input:a}},Gh=e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`settings-menu__button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick),t},Kh=e=>{let t=document.createElement(`p`);return t.className=`settings-menu__subtitle`,t.textContent=e,t},qh=()=>{if(kh)return kh;let e=document.createElement(`section`);e.className=`operation-guide`,e.setAttribute(`aria-label`,`操作方法`);let t=document.createElement(`p`);return t.className=`operation-guide__text`,t.textContent=`ドラッグで回転 / ホイールでズーム / 右ドラッグで移動 / 惑星をクリックでズーム`,e.append(t),document.body.appendChild(e),kh=e,e},Jh=()=>{if(Th&&Eh&&Dh&&Oh)return{panel:Th,name:Eh,items:Dh,actions:Oh};let e=document.createElement(`section`);e.className=`planet-info-panel`,e.hidden=!0,e.setAttribute(`aria-label`,`惑星情報`);let t=document.createElement(`header`);t.className=`planet-info-panel__header`;let n=document.createElement(`p`);n.className=`planet-info-panel__title`,n.textContent=`惑星情報`;let r=document.createElement(`p`);r.className=`planet-info-panel__name`,t.append(n,r);let i=document.createElement(`div`);i.className=`planet-info-panel__items`;let a=document.createElement(`div`);return a.className=`planet-info-panel__actions`,e.append(t,i,a),document.body.appendChild(e),Th=e,Eh=r,Dh=i,Oh=a,{panel:e,name:r,items:i,actions:a}},Yh=e=>{let{panel:t,name:n,items:r}=Jh();n.textContent=e.name;let i=e.items.map(e=>{let t=document.createElement(`div`);t.className=`planet-info-panel__row`;let n=document.createElement(`span`);n.className=`planet-info-panel__label`,n.textContent=e.label;let r=document.createElement(`span`);return r.className=`planet-info-panel__value`,r.textContent=e.value,t.append(n,r),t});r.replaceChildren(...i),t.hidden=!1},Xh=()=>{!Th||!Dh||(Th.hidden=!0,Dh.replaceChildren())},Zh=e=>{let{actions:t}=Jh();t.replaceChildren(e)},Qh=(e,t,n,r)=>{e.setSize(n,r),e.setClearColor(0,1),document.body.appendChild(e.domElement),t.background=new ao().load([jm(`/images/3.jpg`),jm(`/images/1.jpg`),jm(`/images/2.jpg`),jm(`/images/2.jpg`),jm(`/images/4.jpg`),jm(`/images/2.jpg`)]);let i=new df;i.setSize(n,r),i.domElement.style.position=`absolute`,i.domElement.style.top=`0`,i.domElement.style.left=`0`,i.domElement.style.pointerEvents=`none`,i.domElement.style.zIndex=`10`,document.body.appendChild(i.domElement),qh(),Jh();let a=new bo(50,n/r,1,5e3);a.position.set(...nh(n)),mh(a,e,i),window.addEventListener(`resize`,()=>mh(a,e,i));let o=new Au(a,e.domElement);o.minDistance=Q.zoomMinDistance,o.maxDistance=Q.zoomMaxDistance;let s=eg(e,t,a,n,r);return $h(t),{camera:a,controls:o,composer:s,labelRenderer:i}},$h=e=>{let t=new Oo(2236962,10);e.add(t)},eg=(e,t,n,r,i)=>{let a=new $d(e);a.addPass(new tf(t,n));let o=new ef(new U(r,i),t,n);o.edgeStrength=3,o.edgeGlow=1,o.visibleEdgeColor.set(16777215),o.hiddenEdgeColor.set(1640965),a.addPass(o);let s=new rf(new U(r,i),1,.4,.85);return s.threshold=1,s.radius=.9,a.addPass(s),a},tg=e=>{let{sunMesh:t,camera:n,controls:r,onExitPlanetZoom:i,setDayIndex:a,setDayFraction:o,setFrameCount:s,userDataEarthPositionRes:c,currentIndex:l}=e,u=document.createElement(`section`);u.className=`settings-menu`,u.setAttribute(`aria-label`,`表示設定メニュー`);let d=document.createElement(`header`);d.className=`settings-menu__header`;let f=document.createElement(`div`);f.className=`settings-menu__heading`;let p=document.createElement(`p`);p.className=`settings-menu__title`,p.textContent=`表示設定`,f.append(p);let m=dh(l,Ph(n.position.distanceTo(r.target))),h=document.createElement(`button`);h.type=`button`,h.className=`settings-menu__collapse-button`,h.addEventListener(`click`,()=>{Ah=!Ah,Rh()}),d.append(f,m);let g=document.createElement(`div`);g.className=`settings-menu__sections`;let _=document.createElement(`section`);_.className=`settings-menu__section`;let v=Kh(`アニメーション`),y=Uh({label:`公転スピード`,min:0,max:10,step:.1,value:Q.accelerationOrbit,onChange:e=>{Q.accelerationOrbit=e}}),b=Uh({label:`自転スピード`,min:0,max:10,step:.1,value:Q.accelerationRotation,onChange:e=>{Q.accelerationRotation=e}}),x=Uh({label:`太陽光強度`,min:0,max:10,step:.1,value:Q.sunIntensity,onChange:e=>{Q.sunIntensity=e,t.material.emissiveIntensity=e}}),S=Gh({label:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,onClick:()=>{Q.isAnimating=!Q.isAnimating,zh()}});S.classList.add(`settings-menu__button--primary`),S.setAttribute(`aria-pressed`,String(Q.isAnimating)),_.append(v,y.row,b.row,x.row,S);let C=document.createElement(`section`);C.className=`settings-menu__section`;let w=Kh(`表示`),T=document.createElement(`div`);T.className=`settings-menu__toggle-group`;let E=Wh({label:`公転軌道`,checked:Q.showOrbits,onChange:e=>{Q.showOrbits=e}}),D=Wh({label:`惑星名`,checked:Q.showLabels,onChange:e=>{Q.showLabels=e}}),O=Wh({label:`現在位置`,checked:Q.showCurrentPosition,onChange:e=>{Q.showCurrentPosition=e}});T.append(E.row,D.row,O.row),C.append(w,T);let k=document.createElement(`section`);k.className=`settings-menu__section settings-menu__section--actions`;let A=Kh(`視点`);k.append(A,Gh({label:`トップ`,onClick:()=>{i(),sh(n,r)}}),Gh({label:`サイド`,onClick:()=>{i(),ch(n,r)}}),Gh({label:`リセット`,onClick:()=>{i(),lh(n,r)}}));let j=Gh({label:`設定を初期化`,onClick:()=>{Q.lerpFrame=hh.lerpFrame,Q.accelerationOrbit=hh.accelerationOrbit,Q.accelerationRotation=hh.accelerationRotation,Q.sunIntensity=hh.sunIntensity,Q.zoomMinDistance=hh.zoomMinDistance,Q.zoomMaxDistance=hh.zoomMaxDistance,Q.isAnimating=hh.isAnimating,Q.isOrbitPausedByZoom=hh.isOrbitPausedByZoom,Q.showOrbits=hh.showOrbits,Q.showLabels=hh.showLabels,Q.showCurrentPosition=hh.showCurrentPosition,Q.showPlanets=hh.showPlanets,t.material.emissiveIntensity=Q.sunIntensity,i(),lh(n,r);let e=c.todayRow-1;a(e),o(0),s(0),Bh(e),Hh()}});j.classList.add(`settings-menu__button--fullwidth`),u.append(d,k,g,j,h),g.append(_,C),document.body.appendChild(u),_h=u,vh=g,yh=h,bh=j,xh=S,Sh=m,Ch=n,wh=r,Bh(l),Vh(!1),gh={accelerationOrbit:y.input,accelerationOrbitValue:y.output,accelerationRotation:b.input,accelerationRotationValue:b.output,sunIntensity:x.input,sunIntensityValue:x.output,isAnimating:S,showOrbits:E.input,showLabels:D.input,showCurrentPosition:O.input},r.addEventListener(`change`,Ih),Hh()},ng={IO:`${$.PLANET_MOONS_NAME}_Io`,EUROPA:`${$.PLANET_MOONS_NAME}_Europa`,GANYMEDE:`${$.PLANET_MOONS_NAME}_Ganymede`,CALLISTO:`${$.PLANET_MOONS_NAME}_Callisto`},rg=[{size:jp*.29,texture:`/images/jupiterIo.jpg`,orbitRadius:20,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.8,xPosition:80},{size:jp*.24,texture:`/images/jupiterEuropa.jpg`,orbitRadius:24,orbitSpeed:25e-5*Q.accelerationOrbit,orbitalPeriodDays:3.5,xPosition:90},{size:jp*.41,texture:`/images/jupiterGanymede.jpg`,orbitRadius:28,orbitSpeed:125e-6*Q.accelerationOrbit,orbitalPeriodDays:7.1,xPosition:110},{size:jp*.34,texture:`/images/jupiterCallisto.jpg`,orbitRadius:32,orbitSpeed:6e-5*Q.accelerationOrbit,orbitalPeriodDays:16.7,xPosition:140}],ig=async e=>{let t=await Um(`JUPITER`),n=Jm(`JUPITER`,om,im,am,Om(`JUPITER`),`/images/jupiter.jpg`,null,null,null,rg,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=ng.IO),e===1&&(t.name=ng.EUROPA),e===2&&(t.name=ng.GANYMEDE),e===3&&(t.name=ng.CALLISTO),t.position.set(rg[e].xPosition??0,0,0);return n},ag={PHOBOS:`${$.PLANET_MOONS_NAME}_Phobos`,DEIMOS:`${$.PLANET_MOONS_NAME}_Deimos`},og=[{size:.1,orbitRadius:5,orbitSpeed:.002*Q.accelerationOrbit,orbitalPeriodDays:.319,modelPath:`/images/mars/phobos.glb`,xPosition:6},{size:.1,orbitRadius:12.5,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.263,modelPath:`/images/mars/deimos.glb`,xPosition:14}],sg=async e=>{let t=await Um(`MARS`),n=Jm(`MARS`,nm,em,tm,Om(`MARS`),`/images/marsmap.jpg`,`/images/marsbump.jpg`,null,null,[],t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME);for(let[e,t]of og.entries())t.modelPath!==void 0&&(t.mesh=(await Mm(t.modelPath)).children[0],e===0&&(t.mesh.name=ag.PHOBOS),e===1&&(t.mesh.name=ag.DEIMOS),t.mesh.scale.set(t.size,t.size,t.size),t.mesh.position.set(t.xPosition??0,0,0),t.mesh.castShadow=!0,t.mesh.receiveShadow=!0,r.add(t.mesh));return n},cg=async e=>{let t=await Um(`MERCURY`);return Jm(`MERCURY`,Jp,Kp,qp,Om(`MERCURY`),`/images/mercurymap.jpg`,`/images/mercurybump.jpg`,null,null,[],t,e)},lg={TRITON:`${$.PLANET_MOONS_NAME}_Triton`,PROTEUS:`${$.PLANET_MOONS_NAME}_Proteus`,NEREID:`${$.PLANET_MOONS_NAME}_Nereid`},ug=[{size:jp*.21,texture:`/images/Triton-tok.webp`,orbitRadius:14,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:5.88,xPosition:120,retrograde:!0},{size:jp*.033,texture:`/images/Proteus.webp`,orbitRadius:10,orbitSpeed:35e-5*Q.accelerationOrbit,orbitalPeriodDays:1.12,xPosition:150},{size:jp*.053,texture:`/images/Nereidimproved.webp`,orbitRadius:18,orbitSpeed:8e-5*Q.accelerationOrbit,orbitalPeriodDays:360.14,xPosition:210}],dg=async e=>{let t=await Um(`NEPTUNE`),n=Jm(`NEPTUNE`,vm,gm,_m,Om(`NEPTUNE`),`/images/neptune.jpg`,null,null,null,ug,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=lg.TRITON),e===1&&(t.name=lg.PROTEUS),e===2&&(t.name=lg.NEREID),t.position.set(ug[e].xPosition??0,0,0);return n},fg=12742,pg={MERCURY:`Mercury（水星）`,VENUS:`Venus（金星）`,EARTH:`Earth（地球）`,MARS:`Mars（火星）`,JUPITER:`Jupiter（木星）`,SATURN:`Saturn（土星）`,URANUS:`Uranus（天王星）`,NEPTUNE:`Neptune（海王星）`,PLUTO:`Pluto（冥王星）`},mg={MERCURY:4879,VENUS:12104,EARTH:fg,MARS:6779,JUPITER:139820,SATURN:116460,URANUS:50724,NEPTUNE:49244,PLUTO:2377},hg=(e,t=2)=>e.toLocaleString(`ja-JP`,{maximumFractionDigits:t,minimumFractionDigits:0}),gg=e=>`${hg(e,e>=10?2:3)} AU`,_g=e=>`${hg(e,2)}日`,vg=e=>{let t=_g(e);return e<365?t:`${t}（${hg(e/365,2)}年）`},yg=e=>{let t=mg[e];return e===`EARTH`?`約${hg(t,0)} km`:`地球の${hg(t/fg,2)}倍（約${hg(t,0)} km）`},bg=(e,t)=>({name:pg[e],items:[{label:`太陽からの距離`,value:gg(t)},{label:`公転周期`,value:vg(kp(e))},{label:`自転周期`,value:_g(Ap(e))},{label:`サイズ`,value:yg(e)}]}),xg=1.65,Sg=2.85,Cg=()=>typeof window>`u`?768:window.innerWidth,wg=(e=Cg())=>e<=767?Sg:xg,Tg=e=>{let t=e;for(;t;){let e=t.userData.commandKey;if(typeof e==`string`)return e;t=t.parent}return null},Eg=e=>{let{renderer:t,camera:n,controls:r,planets:i,onResetView:a}=e,o=new Zo,s=new U,c=new U,l=new W,u=new W,d=new W,f=new W,p=new W,m=new W,h=new W,g=null,_=!1,v=null,y=null,b=document.createElement(`button`),x=`PlanetHoverRimLight`,S=new Ca({uniforms:{rimColor:{value:new J(10080767)},rimPower:{value:2.6}},vertexShader:`
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1}),C=e=>{let n=t.domElement.getBoundingClientRect();s.x=(e.clientX-n.left)/n.width*2-1,s.y=-((e.clientY-n.top)/n.height)*2+1};b.type=`button`,b.className=`planet-zoom-close-button`,b.textContent=`視点をリセット`,b.title=`視点をリセット`,b.setAttribute(`aria-label`,`視点をリセット`),b.addEventListener(`click`,()=>{a()}),Zh(b);let w=(e,t)=>{let n=e.getObjectByName(x);if(t){if(n)return;let t=new ni(e.geometry,S);t.name=x,t.scale.setScalar(1.04),e.add(t);return}n&&e.remove(n)},T=()=>{g&&=(w(g,!1),null)},E=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2,D=()=>{y!==null&&(cancelAnimationFrame(y),y=null),r.enabled=!0},O=(e,t)=>{D(),r.enabled=!1,f.copy(n.position),p.copy(e),m.copy(r.target),h.copy(t);let i=performance.now(),a=e=>{let t=Math.min((e-i)/650,1),o=E(t);if(n.position.lerpVectors(f,p,o),r.target.lerpVectors(m,h,o),r.update(),t<1){y=requestAnimationFrame(a);return}y=null,r.enabled=!0};y=requestAnimationFrame(a)},k=()=>_?(D(),T(),_=!1,Q.isOrbitPausedByZoom=!1,Hh(),Vh(!1),Xh(),!0):!1,A=e=>{e.getWorldPosition(l);let t=Tg(e),i=e.geometry;i.computeBoundingSphere();let a=i.boundingSphere?.radius??1;e.getWorldScale(u);let o=a*Math.max(u.x,u.y,u.z)/Math.tan(km(n.fov)/2)*wg();d.subVectors(n.position,r.target),d.lengthSq()===0&&d.set(0,0,1),d.normalize(),p.copy(l).add(d.multiplyScalar(o)),O(p,l),t&&Yh(bg(t,l.length()/90))},j=e=>{e.isPrimary&&(v=e.pointerId,c.set(e.clientX,e.clientY))},M=()=>{v=null};return{handlePlanetPointerDown:j,handlePlanetPointerUp:e=>{if(!e.isPrimary||v!==e.pointerId)return;let t=c.distanceTo(new U(e.clientX,e.clientY));if(M(),t>10)return;C(e),o.setFromCamera(s,n);let r=o.intersectObjects(i,!1);if(r.length===0)return;let a=r[0].object;_||(Q.isOrbitPausedByZoom=!0,Hh(),_=!0,Vh(!0)),A(a)},clearPlanetTapState:M,handlePlanetHover:e=>{C(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1)[0]?.object;if(!(t instanceof ni)){T();return}g!==t&&(T(),g=t,w(t,!0))},clearPlanetHover:T,exitPlanetZoom:k}},Dg={TITAN:`${$.PLANET_MOONS_NAME}_Titan`,RHEA:`${$.PLANET_MOONS_NAME}_Rhea`,IAPETUS:`${$.PLANET_MOONS_NAME}_Iapetus`,MIMAS:`${$.PLANET_MOONS_NAME}_Mimas`,ENCELADUS:`${$.PLANET_MOONS_NAME}_Enceladus`},Og=[{size:jp*.4,texture:`/images/RS3_Titan.webp`,orbitRadius:16,orbitSpeed:9e-5*Q.accelerationOrbit,orbitalPeriodDays:15.95,xPosition:137},{size:jp*.12,texture:`/images/RS3_Rhea.webp`,orbitRadius:12,orbitSpeed:18e-5*Q.accelerationOrbit,orbitalPeriodDays:4.52,xPosition:116},{size:jp*.115,texture:`/images/LapetusNew.webp`,orbitRadius:22,orbitSpeed:1e-5*Q.accelerationOrbit,orbitalPeriodDays:79.3,xPosition:180},{size:jp*.031,texture:`/images/RS3_Mimas.webp`,orbitRadius:8,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:.942,xPosition:102},{size:jp*.04,texture:`/images/Enceladus.webp`,orbitRadius:10,orbitSpeed:45e-5*Q.accelerationOrbit,orbitalPeriodDays:1.37,xPosition:110}],kg=async e=>{let t=await Um(`SATURN`),n=Jm(`SATURN`,um,cm,lm,Om(`SATURN`),`/images/saturnmap.jpg`,null,{innerRadius:18,outerRadius:29,texture:`/images/saturn_ring.png`},null,Og,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Dg.TITAN),e===1&&(t.name=Dg.RHEA),e===2&&(t.name=Dg.IAPETUS),e===3&&(t.name=Dg.MIMAS),e===4&&(t.name=Dg.ENCELADUS),t.position.set(Og[e].xPosition??0,0,0);return n},Ag=`Sun`,jg=new Ta({emissive:Bp,emissiveMap:new oo().load(jm(`/images/sun.jpg`)),emissiveIntensity:Q.sunIntensity}),Mg=()=>{let e=new ni(new ma(Rp,32,20),jg);e.name=Ag;let t=new wo(Vp,100,0,Hp),n=new wo(Up,20,Wp,Gp);return e.add(t),e.add(n),e},Ng={MIRANDA:`${$.PLANET_MOONS_NAME}_Miranda`,ARIEL:`${$.PLANET_MOONS_NAME}_Ariel`,UMBRIEL:`${$.PLANET_MOONS_NAME}_Umbriel`,TITANIA:`${$.PLANET_MOONS_NAME}_Titania`,OBERON:`${$.PLANET_MOONS_NAME}_Oberon`},Pg=[{size:jp*.037,texture:`/images/Miranda-0.webp`,orbitRadius:10,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:1.41,xPosition:58},{size:jp*.084,texture:`/images/Ariel-0.webp`,orbitRadius:10,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:2.52,xPosition:90},{size:jp*.07,texture:`/images/Uranus-0.webp`,orbitRadius:10,orbitSpeed:4e-4*Q.accelerationOrbit,orbitalPeriodDays:4.14,xPosition:120},{size:jp*.11,texture:`/images/Titaniamap.webp`,orbitRadius:10,orbitSpeed:3e-4*Q.accelerationOrbit,orbitalPeriodDays:8.71,xPosition:150},{size:jp*.105,texture:`/images/Oberonmap1.webp`,orbitRadius:10,orbitSpeed:2e-4*Q.accelerationOrbit,orbitalPeriodDays:13.46,xPosition:180}],Fg=async e=>{let t=await Um(`URANUS`),n=Jm(`URANUS`,mm,fm,pm,Om(`URANUS`),`/images/uranus.jpg`,null,{innerRadius:8,outerRadius:10,texture:`/images/uranus_ring.png`},null,Pg,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Ng.MIRANDA),e===1&&(t.name=Ng.ARIEL),e===2&&(t.name=Ng.UMBRIEL),e===3&&(t.name=Ng.TITANIA),e===4&&(t.name=Ng.OBERON),t.position.set(Pg[e].xPosition??0,0,0);return n},Ig=async e=>{let t=await Um(`VENUS`);return Jm(`VENUS`,Qp,Xp,Zp,Om(`VENUS`),`/images/venusmap.jpg`,`/images/venusbump.jpg`,null,`/images/venus_atmosphere.jpg`,[],t,e)};function Lg(e,t,n){let{earthPlanetSystem:r,earthPlanet:i,earthAtmosphere:a,moon:o}=t;{let t=n.pathPoints.length-1,o=e.dayIndex%t,s=n.pathPoints[o],c=(o+1)%t,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=km(360/Q.lerpFrame*Q.accelerationRotation);i.rotateY(u),a.rotateY(u+Lp)}{let t=km(5),n=km(360/(Ip*Q.lerpFrame)*Q.accelerationOrbit),r=e.frameCount*n,{orbitRadius:i}=Xm[0],a=i*Math.cos(r),s=i*Math.sin(r)*Math.sin(t),c=i*Math.sin(r)*Math.cos(t);o.position.set(-a,s,c);let l=n;o.rotateY(l)}}function Rg(e,t,n){let{mercuryPlanetSystem:r,mercuryPlanet:i}=t,a=n.pathPoints.length-1,o=e.dayIndex%a,s=n.pathPoints[o],c=(o+1)%a,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=km(360/(Q.lerpFrame*Ap(`MERCURY`))*Q.accelerationRotation);i.rotateY(u)}function zg(e,t,n){let{venusPlanetSystem:r,venusPlanet:i,venusAtmosphere:a}=t,o=n.pathPoints.length-1,s=e.dayIndex%o,c=n.pathPoints[s],l=(s+1)%o,u=n.pathPoints[l];e.buf.copy(c).lerp(u,e.dayFraction),r.position.copy(e.buf);let d=km(360/(Q.lerpFrame*Ap(`VENUS`))*Q.accelerationRotation);i.rotateY(d),a.rotateY(d*60)}function Bg(e,t,n){let{marsPlanetSystem:r,marsPlanet:i,phobos:a,deimos:o}=t,s=Em(`MARS`),c=n.pathPoints.length-1,l=e.dayIndex+e.dayFraction,u=Math.floor(l/s)%c,d=n.pathPoints[u],f=(u+1)%c,p=n.pathPoints[f],m=l%s/s;e.buf.copy(d).lerp(p,m),r.position.copy(e.buf);let h=km(360/(Q.lerpFrame*Ap(`MARS`))*Q.accelerationRotation);i.rotateY(h);let g=og[0].orbitRadius,_=og[1].orbitRadius,v=e.frameCount*Q.accelerationOrbit*4,y=e.frameCount*Q.accelerationOrbit*1,b=g*Math.cos(v),x=g*Math.sin(v);a.position.set(-b,0,x);let S=_*Math.cos(y),C=_*Math.sin(y);o.position.set(-S,0,C)}function Vg(e,t,n){let{jupiterPlanetSystem:r,jupiterPlanet:i,io:a,europa:o,ganymede:s,callisto:c}=t,l=Em(`JUPITER`),u=n.pathPoints.length-1,d=e.dayIndex+e.dayFraction,f=Math.floor(d/l)%u,p=n.pathPoints[f],m=(f+1)%u,h=n.pathPoints[m],g=d%l/l;e.buf.copy(p).lerp(h,g),r.position.copy(e.buf);let _=km(360/(Q.lerpFrame*Ap(`JUPITER`))*Q.accelerationRotation);i.rotateY(_);{let t=rg[0].orbitRadius+(rg[0].xPosition??0),n=rg[1].orbitRadius+(rg[1].xPosition??0),r=rg[2].orbitRadius+(rg[2].xPosition??0),i=rg[3].orbitRadius+(rg[3].xPosition??0),l=e.frameCount*Q.accelerationOrbit*(1/rg[0].orbitalPeriodDays),u=e.frameCount*Q.accelerationOrbit*(1/rg[1].orbitalPeriodDays),d=e.frameCount*Q.accelerationOrbit*(1/rg[2].orbitalPeriodDays),f=e.frameCount*Q.accelerationOrbit*(1/rg[3].orbitalPeriodDays),p=t*Math.cos(l),m=t*Math.sin(l);a.position.set(-p,0,m);let h=n*Math.cos(u),g=n*Math.sin(u);o.position.set(-h,0,g);let _=r*Math.cos(d),v=r*Math.sin(d);s.position.set(-_,0,v);let y=i*Math.cos(f),b=i*Math.sin(f);c.position.set(-y,0,b)}}function Hg(e,t,n){let{saturnPlanetSystem:r,saturnPlanet:i,titan:a,rhea:o,iapetus:s,mimas:c,enceladus:l}=t,u=Em(`SATURN`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=km(360/(Q.lerpFrame*Ap(`SATURN`))*Q.accelerationRotation);i.rotateY(v);{let t=km(lm),n=Og[0].orbitRadius+(Og[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Og[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Og[1].orbitRadius+(Og[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Og[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Og[2].orbitRadius+(Og[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Og[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Og[3].orbitRadius+(Og[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Og[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=Og[4].orbitRadius+(Og[4].xPosition??0),M=e.frameCount*Q.accelerationOrbit*(1/Og[4].orbitalPeriodDays),N=-j*Math.cos(M),ee=j*Math.sin(M),te=N*Math.cos(t),P=N*Math.sin(t);l.position.set(te,P,ee)}}function Ug(e,t,n){let{uranusPlanetSystem:r,uranusPlanet:i,miranda:a,ariel:o,umbriel:s,titania:c,oberon:l}=t,u=Em(`URANUS`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=km(360/(Q.lerpFrame*Ap(`URANUS`))*Q.accelerationRotation);i.rotateY(v);{let t=km(pm),n=Pg[0].orbitRadius+(Pg[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Pg[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Pg[1].orbitRadius+(Pg[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Pg[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Pg[2].orbitRadius+(Pg[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Pg[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Pg[3].orbitRadius+(Pg[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Pg[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=Pg[4].orbitRadius+(Pg[4].xPosition??0),M=e.frameCount*Q.accelerationOrbit*(1/Pg[4].orbitalPeriodDays),N=-j*Math.cos(M),ee=j*Math.sin(M),te=N*Math.cos(t),P=N*Math.sin(t);l.position.set(te,P,ee)}}function Wg(e,t,n){let{neptunePlanetSystem:r,neptunePlanet:i,triton:a,proteus:o,nereid:s}=t,c=Em(`NEPTUNE`),l=n.pathPoints.length-1,u=e.dayIndex+e.dayFraction,d=Math.floor(u/c)%l,f=n.pathPoints[d],p=(d+1)%l,m=n.pathPoints[p],h=u%c/c;e.buf.copy(f).lerp(m,h),r.position.copy(e.buf);let g=km(360/(Q.lerpFrame*Ap(`NEPTUNE`))*Q.accelerationRotation);i.rotateY(g);{let t=km(_m),n=ug[0].orbitRadius+(ug[0].xPosition??0),r=(ug[0].retrograde?-1:1)*e.frameCount*Q.accelerationOrbit*(1/ug[0].orbitalPeriodDays),i=-n*Math.cos(r),c=n*Math.sin(r),l=i*Math.cos(t),u=i*Math.sin(t);a.position.set(l,u,c);let d=ug[1].orbitRadius+(ug[1].xPosition??0),f=e.frameCount*Q.accelerationOrbit*(1/ug[1].orbitalPeriodDays),p=-d*Math.cos(f),m=d*Math.sin(f),h=p*Math.cos(t),g=p*Math.sin(t);o.position.set(h,g,m);let _=ug[2].orbitRadius+(ug[2].xPosition??0),v=e.frameCount*Q.accelerationOrbit*(1/ug[2].orbitalPeriodDays),y=-_*Math.cos(v),b=_*Math.sin(v),x=y*Math.cos(t),S=y*Math.sin(t);s.position.set(x,S,b)}}var Gg=5e3,Kg=5,qg=185,Jg=275,Yg=30,Xg=class{permutation;constructor(e){this.permutation=this.generatePermutation(e)}generatePermutation(e){let t=Array.from({length:256},(e,t)=>t);for(let n=255;n>0;n--){let r=this.seededRandom(e+n),i=Math.floor(r*(n+1));[t[n],t[i]]=[t[i],t[n]]}return[...t,...t]}seededRandom(e){let t=Math.sin(e)*1e4;return t-Math.floor(t)}fade(e){return e*e*e*(e*(e*6-15)+10)}lerp(e,t,n){return t+e*(n-t)}grad(e,t,n,r){let i=e&15,a=i<8?t:n,o=i<8?n:r;return(i&1?-a:a)+(i&2?-o:o)}noise(e,t,n){let r=Math.floor(e)&255,i=Math.floor(t)&255,a=Math.floor(n)&255,o=e-Math.floor(e),s=t-Math.floor(t),c=n-Math.floor(n),l=this.fade(o),u=this.fade(s),d=this.fade(c),f=this.permutation,p=f[f[f[r]+i]+a],m=f[f[f[r]+i+1]+a],h=f[f[f[r]+i]+a+1],g=f[f[f[r]+i+1]+a+1],_=f[f[f[r+1]+i]+a],v=f[f[f[r+1]+i+1]+a],y=f[f[f[r+1]+i]+a+1],b=f[f[f[r+1]+i+1]+a+1],x=this.grad(p,o,s,c),S=this.grad(_,o-1,s,c),C=this.grad(m,o,s-1,c),w=this.grad(v,o-1,s-1,c),T=this.grad(h,o,s,c-1),E=this.grad(y,o-1,s,c-1),D=this.grad(g,o,s-1,c-1),O=this.grad(b,o-1,s-1,c-1),k=this.lerp(l,x,S),A=this.lerp(l,C,w),j=this.lerp(u,k,A),M=this.lerp(l,T,E),N=this.lerp(l,D,O),ee=this.lerp(u,M,N);return this.lerp(d,j,ee)}fbm(e,t,n,r=4){let i=0,a=1,o=1,s=0;for(let c=0;c<r;c++)i+=a*this.noise(e*o,t*o,n*o),s+=a,a*=.5,o*=2;return i/s}};function Zg(e){let t=new da(1,4),n=t.getAttribute(`position`),r=n.array,i=new Xg(e);for(let e=0;e<r.length;e+=3){let t=r[e],n=r[e+1],a=r[e+2],o=Math.sqrt(t*t+n*n+a*a),s=t/o,c=n/o,l=a/o,u=i.fbm(t*2,n*2,a*2,3)*.3;r[e]=t+s*u,r[e+1]=n+c*u,r[e+2]=a+l*u}return n.needsUpdate=!0,t.computeVertexNormals(),t}var Qg=class{group;instancedMeshes=[];constructor(){this.group=new On,this.group.name=`AsteroidBelt`,this.initAsteroidBelt()}initAsteroidBelt(){let e=[];for(let t=0;t<Kg;t++)e.push(Zg(t*12345));let t=Math.floor(Gg/Kg);e.forEach((e,n)=>{let r=new Oi(e,this.createRockMaterial(n),t);r.castShadow=!0,r.receiveShadow=!0;let i=new q;for(let e=0;e<t;e++){let t=Math.random()*Math.PI*2,n=qg+Math.random()*(Jg-qg),a=(Math.random()-.5)*Yg,o=Math.cos(t)*n,s=Math.sin(t)*n,c=a,l=new Mt;l.setFromEuler(new un(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2));let u=.3+Math.random()*.7,d=u*(.8+Math.random()*.4),f=u*(.8+Math.random()*.4),p=u*(.8+Math.random()*.4);i.compose(new W(o,c,s),l,new W(d,f,p)),r.setMatrixAt(e,i)}r.instanceMatrix.needsUpdate=!0,this.instancedMeshes.push(r),this.group.add(r)})}createRockMaterial(e){let t=[9139029,6908265,8421504,7036244,4868682];return new Ta({color:t[e%t.length],metalness:.3+Math.random()*.2,roughness:.7+Math.random()*.2})}animate(e=.016){this.instancedMeshes.forEach(t=>{t.rotation.y+=e*.015})}getGroup(){return this.group}},$g=class{loadingScreen=document.getElementById(`loading-screen`);loadingStatus=document.getElementById(`loading-status`);renderer=new yu;scene=new In;camera;controls;composer;labelRenderer;zoomablePlanets=[];planetInteractionController;sunMesh;earthGroup;mercuryGroup;venusGroup;marsGroup;jupiterGroup;saturnGroup;uranusGroup;neptuneGroup;asteroidBelt;dayFraction=0;dayIndex=0;timer=new Io;frameCount=0;_cachedMeshes;_interpolatedPos=new W;_prevShowOrbits=Q.showOrbits;_prevShowLabels=Q.showLabels;_prevShowCurrentPosition=Q.showCurrentPosition;_prevShowPlanets=Q.showPlanets;resetPlanetZoomView=()=>{this.planetInteractionController.exitPlanetZoom()&&lh(this.camera,this.controls)};constructor(){let{camera:e,controls:t,composer:n,labelRenderer:r}=Qh(this.renderer,this.scene,this.width,this.height);this.camera=e,this.controls=t,this.composer=n,this.labelRenderer=r,this.updateLoadingState(`太陽系データを読み込み中...`),this.initPlanets().catch(e=>{this.showLoadingError(`読み込みに失敗しました。ページを再読み込みしてください。`)})}get userDataEarthPositionRes(){return this.earthGroup.userData.planetPositionsRes}get width(){return window.innerWidth}get height(){return window.innerHeight}async initPlanets(){this.updateLoadingState(`太陽と地球を読み込み中...`),this.sunMesh=Mg(),this.scene.add(this.sunMesh),this.earthGroup=await Zm(this.sunMesh.position,Q.showCurrentPosition),this.dayIndex=this.userDataEarthPositionRes.todayRow-1,this.scene.add(this.earthGroup),this.updateLoadingState(`水星を読み込み中...`);let e=await cg(Q.showCurrentPosition);this.updateLoadingState(`金星を読み込み中...`);let t=await Ig(Q.showCurrentPosition);this.updateLoadingState(`火星を読み込み中...`);let n=await sg(Q.showCurrentPosition);this.updateLoadingState(`木星を読み込み中...`);let r=await ig(Q.showCurrentPosition);this.updateLoadingState(`土星を読み込み中...`);let i=await kg(Q.showCurrentPosition);this.updateLoadingState(`天王星を読み込み中...`);let a=await Fg(Q.showCurrentPosition);this.updateLoadingState(`海王星を読み込み中...`);let o=await dg(Q.showCurrentPosition);this.mercuryGroup=e,this.scene.add(e),this.venusGroup=t,this.scene.add(t),this.marsGroup=n,this.scene.add(n),this.jupiterGroup=r,this.scene.add(r),this.saturnGroup=i,this.scene.add(i),this.uranusGroup=a,this.scene.add(a),this.neptuneGroup=o,this.scene.add(o),this.updateLoadingState(`小惑星帯を生成中...`),this.asteroidBelt=new Qg,this.scene.add(this.asteroidBelt.getGroup()),this.initPlanetTapZoom(),tg({sunMesh:this.sunMesh,camera:this.camera,controls:this.controls,onExitPlanetZoom:()=>{this.planetInteractionController.exitPlanetZoom()},setDayIndex:e=>{this.dayIndex=e},setDayFraction:e=>{this.dayFraction=e},setFrameCount:e=>{this.frameCount=e},userDataEarthPositionRes:this.userDataEarthPositionRes,currentIndex:this.dayIndex}),this._initMeshCache(),this.updateLoadingState(`描画を開始中...`),this.renderer.setAnimationLoop(()=>this.render()),this.render(),window.requestAnimationFrame(()=>this.hideLoadingScreen())}updateLoadingState(e){this.loadingStatus&&(this.loadingStatus.textContent=e)}hideLoadingScreen(){this.loadingScreen&&(this.loadingScreen.classList.add(`is-hidden`),window.setTimeout(()=>this.loadingScreen?.remove(),400))}showLoadingError(e){this.loadingScreen&&(this.loadingScreen.classList.add(`is-error`),this.updateLoadingState(e))}_initMeshCache(){this._cachedMeshes={earthPlanetSystem:this.earthGroup.getObjectByName($.PLANET_SYSTEM_NAME),earthPlanet:this.earthGroup.getObjectByName($.PLANET_NAME),earthAtmosphere:this.earthGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),moon:this.earthGroup.getObjectByName(Ym.MOON),mercuryPlanetSystem:this.mercuryGroup.getObjectByName($.PLANET_SYSTEM_NAME),mercuryPlanet:this.mercuryGroup.getObjectByName($.PLANET_NAME),venusPlanetSystem:this.venusGroup.getObjectByName($.PLANET_SYSTEM_NAME),venusPlanet:this.venusGroup.getObjectByName($.PLANET_NAME),venusAtmosphere:this.venusGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),marsPlanetSystem:this.marsGroup.getObjectByName($.PLANET_SYSTEM_NAME),marsPlanet:this.marsGroup.getObjectByName($.PLANET_NAME),phobos:this.marsGroup.getObjectByName(ag.PHOBOS),deimos:this.marsGroup.getObjectByName(ag.DEIMOS),jupiterPlanetSystem:this.jupiterGroup.getObjectByName($.PLANET_SYSTEM_NAME),jupiterPlanet:this.jupiterGroup.getObjectByName($.PLANET_NAME),io:this.jupiterGroup.getObjectByName(ng.IO),europa:this.jupiterGroup.getObjectByName(ng.EUROPA),ganymede:this.jupiterGroup.getObjectByName(ng.GANYMEDE),callisto:this.jupiterGroup.getObjectByName(ng.CALLISTO),saturnPlanetSystem:this.saturnGroup.getObjectByName($.PLANET_SYSTEM_NAME),saturnPlanet:this.saturnGroup.getObjectByName($.PLANET_NAME),titan:this.saturnGroup.getObjectByName(Dg.TITAN),rhea:this.saturnGroup.getObjectByName(Dg.RHEA),iapetus:this.saturnGroup.getObjectByName(Dg.IAPETUS),mimas:this.saturnGroup.getObjectByName(Dg.MIMAS),enceladus:this.saturnGroup.getObjectByName(Dg.ENCELADUS),uranusPlanetSystem:this.uranusGroup.getObjectByName($.PLANET_SYSTEM_NAME),uranusPlanet:this.uranusGroup.getObjectByName($.PLANET_NAME),miranda:this.uranusGroup.getObjectByName(Ng.MIRANDA),ariel:this.uranusGroup.getObjectByName(Ng.ARIEL),umbriel:this.uranusGroup.getObjectByName(Ng.UMBRIEL),titania:this.uranusGroup.getObjectByName(Ng.TITANIA),oberon:this.uranusGroup.getObjectByName(Ng.OBERON),neptunePlanetSystem:this.neptuneGroup.getObjectByName($.PLANET_SYSTEM_NAME),neptunePlanet:this.neptuneGroup.getObjectByName($.PLANET_NAME),triton:this.neptuneGroup.getObjectByName(lg.TRITON),proteus:this.neptuneGroup.getObjectByName(lg.PROTEUS),nereid:this.neptuneGroup.getObjectByName(lg.NEREID)}}initPlanetTapZoom(){let e=this.earthGroup.getObjectByName($.PLANET_NAME),t=this.mercuryGroup.getObjectByName($.PLANET_NAME),n=this.venusGroup.getObjectByName($.PLANET_NAME),r=this.marsGroup.getObjectByName($.PLANET_NAME),i=this.jupiterGroup.getObjectByName($.PLANET_NAME),a=this.saturnGroup.getObjectByName($.PLANET_NAME),o=this.uranusGroup.getObjectByName($.PLANET_NAME),s=this.neptuneGroup.getObjectByName($.PLANET_NAME);this.zoomablePlanets=[e,t,n,r,i,a,o,s].filter(e=>e instanceof ni),this.planetInteractionController=Eg({renderer:this.renderer,camera:this.camera,controls:this.controls,planets:this.zoomablePlanets,onResetView:this.resetPlanetZoomView}),this.renderer.domElement.addEventListener(`pointerdown`,this.planetInteractionController.handlePlanetPointerDown),this.renderer.domElement.addEventListener(`pointerup`,this.planetInteractionController.handlePlanetPointerUp),this.renderer.domElement.addEventListener(`pointercancel`,this.planetInteractionController.clearPlanetTapState),this.renderer.domElement.addEventListener(`pointermove`,this.planetInteractionController.handlePlanetHover),this.renderer.domElement.addEventListener(`pointerleave`,this.planetInteractionController.clearPlanetHover)}render(){this.controls.update(),this.composer.render(),this.labelRenderer.render(this.scene,this.camera),Q.isAnimating&&this.animate(),this.#e()}#e(){(Q.showOrbits!==this._prevShowOrbits||Q.showLabels!==this._prevShowLabels||Q.showCurrentPosition!==this._prevShowCurrentPosition||Q.showPlanets!==this._prevShowPlanets)&&(this._prevShowOrbits=Q.showOrbits,this._prevShowLabels=Q.showLabels,this._prevShowCurrentPosition=Q.showCurrentPosition,this._prevShowPlanets=Q.showPlanets,[this.earthGroup,this.mercuryGroup,this.venusGroup,this.marsGroup,this.jupiterGroup,this.saturnGroup,this.uranusGroup,this.neptuneGroup].forEach(e=>{this.#t(e);let t=e.getObjectByName($.PLANET_ORBIT_NAME);t&&(t.visible=Q.showOrbits),e.traverse(e=>{(e.name===$.PLANET_NAME||e.name===$.PLANET_RING_NAME||e.name===$.PLANET_AXIS_NAME||e.name===$.PLANET_ATMO_SPHERE_NAME||e.name.startsWith($.PLANET_MOONS_NAME))&&(e.visible=Q.showPlanets),e.name===$.PLANET_LABEL_NAME&&(e.visible=Q.showLabels)})}))}#t(e){let t=e.userData.commandKey,n=e.userData.planetPositionsRes;if(!t||!n)return;let r=e.getObjectByName(Wm(t));if(Q.showCurrentPosition){r||Gm({parent:e,commandKey:t,planetPositionsRes:n});return}r&&Km(e,t)}animate(){let e=!Q.isOrbitPausedByZoom;this.frameCount++,Bh(this.dayIndex),this.sunMesh.rotateY(zp*Q.accelerationRotation),e&&(this.dayFraction=Number(((this.dayFraction+1/Q.lerpFrame)*Q.accelerationOrbit).toFixed(3)),this.dayFraction>=1&&(this.dayIndex+=1,this.dayFraction=0));let t={dayIndex:this.dayIndex,dayFraction:this.dayFraction,frameCount:this.frameCount,buf:this._interpolatedPos};Lg(t,this._cachedMeshes,this.userDataEarthPositionRes),Rg(t,this._cachedMeshes,this.mercuryGroup.userData.planetPositionsRes),zg(t,this._cachedMeshes,this.venusGroup.userData.planetPositionsRes),Bg(t,this._cachedMeshes,this.marsGroup.userData.planetPositionsRes),Vg(t,this._cachedMeshes,this.jupiterGroup.userData.planetPositionsRes),Hg(t,this._cachedMeshes,this.saturnGroup.userData.planetPositionsRes),Ug(t,this._cachedMeshes,this.uranusGroup.userData.planetPositionsRes),Wg(t,this._cachedMeshes,this.neptuneGroup.userData.planetPositionsRes),e&&this.asteroidBelt.animate(.016)}};window.addEventListener(`DOMContentLoaded`,()=>{new $g});