...
`).filter(e=>e.includes(`X =`)),n=[];t.forEach((e,t)=>{let r=e.split(/[X,Y,Z, =]/).filter(e=>e.trim()),i=parseFloat(r[0]),a=parseFloat(r[1]),o=parseFloat(r[2]);n.push({x:i,y:a,z:o,day:t+1})}),l.pathPoints=Fm(n.map(e=>new W(e.x*90,e.z*90,e.y*90)).reverse()),l.todayRow=Lm(),await Bm(o,l)}else console.error(`データの取得に失敗しました:`,e)}catch(e){console.error(`API呼び出し中にエラーが発生しました:`,e)}finally{return l}},Wm=e=>`${e}-current-position`,Gm=({parent:e,commandKey:t,planetPositionsRes:n,radius:r=1,color:i})=>{let a=new ni(new ma(r,32,32),new Wr({color:i??Em(t),depthTest:!1,depthWrite:!1}));a.name=Wm(t),a.renderOrder=999;let{pathPoints:o,todayRow:s}=n,c=o.length-1,l=s-1,u=wm(t),d=Math.floor(l/u)%c,f=(d+1)%c,p=l%u/u,m=o[d],h=o[f],g=new W().fromArray(m.toArray()).lerp(new W().fromArray(h.toArray()),p);return a.position.copy(g),e.add(a),a},Km=(e,t)=>{let n=e.getObjectByName(Wm(t));n&&(e.remove(n),n instanceof ni&&(n.geometry.dispose(),Array.isArray(n.material)?n.material.forEach(e=>e.dispose()):n.material.dispose()))},$={PLANET_NAME:`Planet`,PLANET_ORBIT_NAME:`PlanetOrbit`,PLANET_RING_NAME:`PlanetRing`,PLANET_AXIS_NAME:`PlanetAxis`,PLANET_SYSTEM_NAME:`PlanetSystem`,PLANET_ATMO_SPHERE_NAME:`PlanetAtmosphere`,PLANET_MOONS_NAME:`PlanetMoons`,PLANET_LABEL_NAME:`PlanetLabel`},qm={MERCURY:`Mercury（水星）`,VENUS:`Venus（金星）`,EARTH:`Earth（地球）`,MARS:`Mars（火星）`,JUPITER:`Jupiter（木星）`,SATURN:`Saturn（土星）`,URANUS:`Uranus（天王星）`,NEPTUNE:`Neptune（海王星）`,PLUTO:`Pluto（冥王星）`},Jm=(e,t,n,r,i,a,o,s,c,l,u,d=!1)=>{let f=new oo,p;p=a instanceof Fr?a:o?new Da({map:f.load(km(a)),bumpMap:f.load(km(o)),bumpScale:.7}):new Da({map:f.load(km(a))});let m=new ni(new ma(n,32,20),p);m.rotation.z=Dm(r),m.castShadow=!0,m.receiveShadow=!0,m.name=$.PLANET_NAME;let h=new On;h.name=$.PLANET_SYSTEM_NAME;let g=u.pathPoints.length-1,_=u.todayRow-1,v=wm(e),y=Math.floor(_/v)%g,b=(y+1)%g,x=_%v/v,S=u.pathPoints[y],C=u.pathPoints[b],w=new W().fromArray(S.toArray()).lerp(new W().fromArray(C.toArray()),x);h.position.copy(w),h.add(m);let T=document.createElement(`div`);T.className=`planet-name-label`,T.textContent=qm[e]??t;let E=new af(T);E.name=$.PLANET_LABEL_NAME,E.position.set(0,n+3,0),h.add(E);let D=document.createElement(`div`);D.className=`planet-tilt-label`,D.textContent=`傾き: ${r}°`;let O=new af(D);O.name=$.PLANET_LABEL_NAME,O.position.set(0,-(n+3),0),h.add(O);{let e=.1,t=new ni(new la(e,e,2.8*n,32),new Wr({color:65280}));t.name=$.PLANET_AXIS_NAME,t.rotation.z=Dm(r),h.add(t)}if(s){let e=new ni(new pa(s.innerRadius,s.outerRadius,30),new Ta({map:f.load(km(s.texture)),side:2}));e.name=$.PLANET_RING_NAME,e.rotation.x=Dm(90),e.rotation.y=Dm(r),h.add(e);let t=3.6;e.scale.set(t,t,t)}if(c){let e=new ni(new ma(n+.1,32,20),new Da({map:f.load(km(c)),transparent:!0,opacity:.4,depthTest:!0,depthWrite:!1}));e.name=$.PLANET_ATMO_SPHERE_NAME,e.rotation.z=.41,m.add(e)}let k=0;for(let e of l){let t;if(e.texture===void 0)continue;t=e.bump?new Ta({map:f.load(km(e.texture)),bumpMap:f.load(km(e.bump)),bumpScale:.5}):new Ta({map:f.load(km(e.texture))});let r=new ni(new ma(e.size,32,20),t);r.name=`${$.PLANET_MOONS_NAME}_${k}`,r.castShadow=!0,r.receiveShadow=!0,k++;let i=n*1.5;r.position.set(i,0,0),h.add(r),e.mesh=r}let A=new On;A.add(h),A.name=t,A.userData={planetPositionsRes:u,commandKey:e};let j=new Gi(new Ar().setFromPoints(u.pathPoints),new Li({color:i,transparent:!0,opacity:.2}));return j.name=$.PLANET_ORBIT_NAME,A.add(j),d&&Gm({parent:A,commandKey:e,planetPositionsRes:u}),A},Ym={MOON:`${$.PLANET_MOONS_NAME}_Moon`},Xm=[{size:Np,texture:`/images/moonmap.jpg`,bump:`/images/moonbump.jpg`,orbitSpeed:.001*Q.accelerationOrbit,orbitRadius:10,orbitalPeriodDays:27.322}],Zm=async(e,t)=>{let n=new oo,r=new Ca({uniforms:{dayTexture:{value:n.load(km(`/images/earth_daymap.jpg`))},nightTexture:{value:n.load(km(`/images/earth_nightmap.jpg`))},sunPosition:{value:e}},vertexShader:`
      ...
      `}),i=await Um(`EARTH`),a=Jm(`EARTH`,jp,kp,Ap,Em(`EARTH`),r,null,null,`/images/earth_atmosphere.jpg`,Xm,i,t),o=a.getObjectByName($.PLANET_SYSTEM_NAME).children.find(e=>e.name.startsWith($.PLANET_MOONS_NAME));return o&&(o.name=Ym.MOON),a},Qm=[0,24,150],$m=(e,t,n)=>{e.position.set(...n),e.up.set(0,1,0),t.target.set(0,0,0),t.update()},eh=(e,t)=>{$m(e,t,[190,0,.01])},th=(e,t)=>{$m(e,t,Qm)},nh=(e,t,n)=>{let r=window.innerWidth,i=window.innerHeight;t.setSize(r,i),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),n?.setSize(r,i),e.aspect=r/i,e.updateProjectionMatrix()},rh=e=>{let t=new Date().getFullYear();return yp(yf(new Date(t,0,1),e),`yyyy年MM月dd日`)},ih=(e,t)=>{let n=document.createElement(`div`);n.className=`current-index-label`,n.setAttribute(`aria-live`,`polite`);let r=document.createElement(`div`);r.className=`current-index-label__chip current-index-label__chip--date`;let i=document.createElement(`span`);i.className=`current-index-label__caption`,i.textContent=`現在日付`;let a=document.createElement(`span`);a.className=`current-index-label__value`,a.textContent=rh(e),r.append(i,a);let o=document.createElement(`div`);o.className=`current-index-label__chip current-index-label__chip--zoom`;let s=document.createElement(`span`);s.className=`current-index-label__caption`,s.textContent=`ズーム距離`;let c=document.createElement(`span`);return c.className=`current-index-label__zoom`,c.textContent=`Zoom ${t}`,o.append(s,c),n.append(r,o),n},ah=(e,t)=>{let n=e.querySelector(`.current-index-label__value`);n&&(n.textContent=rh(t))},oh=(e,t)=>{let n=e.querySelector(`.current-index-label__zoom`);n&&(n.textContent=`Zoom ${t}`)},sh={...Q},ch=null,lh=null,uh=null,dh=null,fh=null,ph=null,mh=null,hh=null,gh=!0,_h=0,vh=!1,yh=new W,bh=e=>e.toFixed(1),xh=()=>!mh||!hh?0:mh.position.distanceTo(hh.target),Sh=()=>{let e=bh(xh());ph&&oh(ph,e)},Ch=e=>{if(!hh||(hh.minDistance=Q.zoomMinDistance,hh.maxDistance=Q.zoomMaxDistance,!e?.clampCamera||!mh))return;yh.subVectors(mh.position,hh.target),yh.lengthSq()===0&&yh.set(0,0,Q.zoomMinDistance);let t=yh.length(),n=jt.clamp(t,Q.zoomMinDistance,Q.zoomMaxDistance);if(Math.abs(n-t)<2**-52){Sh();return}yh.setLength(n),mh.position.copy(hh.target).add(yh),hh.update()},wh=()=>{!lh||!uh||!dh||(lh.classList.toggle(`is-collapsed`,gh),uh.hidden=gh,dh.classList.toggle(`is-collapsed`,gh),dh.textContent=gh?`設定を展開`:`設定を折りたたむ`,dh.setAttribute(`aria-expanded`,String(!gh)))},Th=()=>{fh&&(fh.textContent=Q.isAnimating?`アニメーション停止`:`アニメーション再生`,fh.classList.toggle(`is-active`,Q.isAnimating),fh.setAttribute(`aria-pressed`,String(Q.isAnimating)),fh.title=vh?`惑星ズーム中は操作できません`:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,ph?.classList.toggle(`is-animating`,Q.isAnimating&&!Q.isOrbitPausedByZoom))},Eh=e=>{_h=e,ph&&ah(ph,e)},Dh=e=>{vh=e,fh&&(fh.disabled=e,fh.classList.toggle(`is-disabled`,e),fh.setAttribute(`aria-disabled`,String(e)),Th())},Oh=()=>{ch&&(ch.accelerationOrbit.value=String(Q.accelerationOrbit),ch.accelerationOrbitValue.value=String(Q.accelerationOrbit),ch.accelerationOrbitValue.textContent=String(Q.accelerationOrbit),ch.accelerationRotation.value=String(Q.accelerationRotation),ch.accelerationRotationValue.value=String(Q.accelerationRotation),ch.accelerationRotationValue.textContent=String(Q.accelerationRotation),ch.sunIntensity.value=String(Q.sunIntensity),ch.sunIntensityValue.value=String(Q.sunIntensity),ch.sunIntensityValue.textContent=String(Q.sunIntensity),Ch({clampCamera:!0}),Sh(),Th(),ch.showOrbits.checked=Q.showOrbits,ch.showLabels.checked=Q.showLabels,ch.showCurrentPosition.checked=Q.showCurrentPosition,Eh(_h),wh())},kh=e=>{let{label:t,min:n,max:r,step:i,value:a,onChange:o}=e,s=document.createElement(`label`);s.className=`settings-menu__row settings-menu__row--range`;let c=document.createElement(`span`);c.className=`settings-menu__label`,c.textContent=t;let l=document.createElement(`input`);l.type=`range`,l.min=String(n),l.max=String(r),l.step=String(i),l.value=String(a),l.className=`settings-menu__range`;let u=document.createElement(`output`);return u.className=`settings-menu__value`,u.value=String(a),u.textContent=String(a),l.addEventListener(`input`,()=>{let e=Number(l.value);u.value=l.value,u.textContent=l.value,o(e)}),s.append(c,l,u),{row:s,input:l,output:u}},Ah=e=>{let{label:t,checked:n,onChange:r}=e,i=document.createElement(`label`);i.className=`settings-menu__row settings-menu__row--toggle`;let a=document.createElement(`input`);a.type=`checkbox`,a.checked=n,a.className=`settings-menu__checkbox`,a.addEventListener(`change`,()=>r(a.checked));let o=document.createElement(`span`);return o.className=`settings-menu__label`,o.textContent=t,i.append(a,o),{row:i,input:a}},jh=e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`settings-menu__button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick),t},Mh=e=>{let t=document.createElement(`p`);return t.className=`settings-menu__subtitle`,t.textContent=e,t},Nh=(e,t,n,r)=>{e.setSize(n,r),e.setClearColor(0,1),document.body.appendChild(e.domElement),t.background=new ao().load([km(`/images/3.jpg`),km(`/images/1.jpg`),km(`/images/2.jpg`),km(`/images/2.jpg`),km(`/images/4.jpg`),km(`/images/2.jpg`)]);let i=new df;i.setSize(n,r),i.domElement.style.position=`absolute`,i.domElement.style.top=`0`,i.domElement.style.left=`0`,i.domElement.style.pointerEvents=`none`,i.domElement.style.zIndex=`10`,document.body.appendChild(i.domElement);let a=new bo(50,n/r,1,5e3);a.position.set(...Qm),nh(a,e,i),window.addEventListener(`resize`,()=>nh(a,e,i));let o=new Au(a,e.domElement);o.minDistance=Q.zoomMinDistance,o.maxDistance=Q.zoomMaxDistance;let s=Fh(e,t,a,n,r);return Ph(t),{camera:a,controls:o,composer:s,labelRenderer:i}},Ph=e=>{let t=new Oo(2236962,10);e.add(t)},Fh=(e,t,n,r,i)=>{let a=new $d(e);a.addPass(new tf(t,n));let o=new ef(new U(r,i),t,n);o.edgeStrength=3,o.edgeGlow=1,o.visibleEdgeColor.set(16777215),o.hiddenEdgeColor.set(1640965),a.addPass(o);let s=new rf(new U(r,i),1,.4,.85);return s.threshold=1,s.radius=.9,a.addPass(s),a},Ih=e=>{let{sunMesh:t,camera:n,controls:r,onExitPlanetZoom:i,setDayIndex:a,setDayFraction:o,setFrameCount:s,userDataEarthPositionRes:c,currentIndex:l}=e,u=document.createElement(`section`);u.className=`settings-menu`,u.setAttribute(`aria-label`,`表示設定メニュー`);let d=document.createElement(`header`);d.className=`settings-menu__header`;let f=document.createElement(`div`);f.className=`settings-menu__heading`;let p=document.createElement(`p`);p.className=`settings-menu__title`,p.textContent=`表示設定`,f.append(p);let m=ih(l,bh(n.position.distanceTo(r.target))),h=document.createElement(`button`);h.type=`button`,h.className=`settings-menu__collapse-button`,h.addEventListener(`click`,()=>{gh=!gh,wh()}),d.append(f,m);let g=document.createElement(`div`);g.className=`settings-menu__sections`;let _=document.createElement(`section`);_.className=`settings-menu__section`;let v=Mh(`アニメーション`),y=kh({label:`公転スピード`,min:0,max:10,step:.1,value:Q.accelerationOrbit,onChange:e=>{Q.accelerationOrbit=e}}),b=kh({label:`自転スピード`,min:0,max:10,step:.1,value:Q.accelerationRotation,onChange:e=>{Q.accelerationRotation=e}}),x=kh({label:`太陽光強度`,min:0,max:10,step:.1,value:Q.sunIntensity,onChange:e=>{Q.sunIntensity=e,t.material.emissiveIntensity=e}}),S=jh({label:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,onClick:()=>{Q.isAnimating=!Q.isAnimating,Th()}});S.classList.add(`settings-menu__button--primary`),S.setAttribute(`aria-pressed`,String(Q.isAnimating)),_.append(v,y.row,b.row,x.row,S);let C=document.createElement(`section`);C.className=`settings-menu__section`;let w=Mh(`表示`),T=document.createElement(`div`);T.className=`settings-menu__toggle-group`;let E=Ah({label:`公転軌道`,checked:Q.showOrbits,onChange:e=>{Q.showOrbits=e}}),D=Ah({label:`惑星名`,checked:Q.showLabels,onChange:e=>{Q.showLabels=e}}),O=Ah({label:`現在位置`,checked:Q.showCurrentPosition,onChange:e=>{Q.showCurrentPosition=e}});T.append(E.row,D.row,O.row),C.append(w,T);let k=document.createElement(`section`);k.className=`settings-menu__section settings-menu__section--actions`;let A=Mh(`視点`);k.append(A,jh({label:`トップ`,onClick:()=>{i(),n.position.set(0,190,.01),r.target.set(0,0,0),r.update()}}),jh({label:`サイド`,onClick:()=>{i(),eh(n,r)}}),jh({label:`リセット`,onClick:()=>{i(),th(n,r)}}),jh({label:`設定を初期化`,onClick:()=>{Q.lerpFrame=sh.lerpFrame,Q.accelerationOrbit=sh.accelerationOrbit,Q.accelerationRotation=sh.accelerationRotation,Q.sunIntensity=sh.sunIntensity,Q.zoomMinDistance=sh.zoomMinDistance,Q.zoomMaxDistance=sh.zoomMaxDistance,Q.isAnimating=sh.isAnimating,Q.isOrbitPausedByZoom=sh.isOrbitPausedByZoom,Q.showOrbits=sh.showOrbits,Q.showLabels=sh.showLabels,Q.showCurrentPosition=sh.showCurrentPosition,Q.showPlanets=sh.showPlanets,t.material.emissiveIntensity=Q.sunIntensity,i(),th(n,r);let e=c.todayRow-1;a(e),o(0),s(0),Eh(e),Oh()}})),u.append(d,g,h),g.append(_,k,C),document.body.appendChild(u),lh=u,uh=g,dh=h,fh=S,ph=m,mh=n,hh=r,Eh(l),Dh(!1),ch={accelerationOrbit:y.input,accelerationOrbitValue:y.output,accelerationRotation:b.input,accelerationRotationValue:b.output,sunIntensity:x.input,sunIntensityValue:x.output,isAnimating:S,showOrbits:E.input,showLabels:D.input,showCurrentPosition:O.input},r.addEventListener(`change`,Sh),Oh()},Lh={IO:`${$.PLANET_MOONS_NAME}_Io`,EUROPA:`${$.PLANET_MOONS_NAME}_Europa`,GANYMEDE:`${$.PLANET_MOONS_NAME}_Ganymede`,CALLISTO:`${$.PLANET_MOONS_NAME}_Callisto`},Rh=[{size:kp*.29,texture:`/images/jupiterIo.jpg`,orbitRadius:20,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.8,xPosition:80},{size:kp*.24,texture:`/images/jupiterEuropa.jpg`,orbitRadius:24,orbitSpeed:25e-5*Q.accelerationOrbit,orbitalPeriodDays:3.5,xPosition:90},{size:kp*.41,texture:`/images/jupiterGanymede.jpg`,orbitRadius:28,orbitSpeed:125e-6*Q.accelerationOrbit,orbitalPeriodDays:7.1,xPosition:110},{size:kp*.34,texture:`/images/jupiterCallisto.jpg`,orbitRadius:32,orbitSpeed:6e-5*Q.accelerationOrbit,orbitalPeriodDays:16.7,xPosition:140}],zh=async e=>{let t=await Um(`JUPITER`),n=Jm(`JUPITER`,im,nm,rm,Em(`JUPITER`),`/images/jupiter.jpg`,null,null,null,Rh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Lh.IO),e===1&&(t.name=Lh.EUROPA),e===2&&(t.name=Lh.GANYMEDE),e===3&&(t.name=Lh.CALLISTO),t.position.set(Rh[e].xPosition??0,0,0);return n},Bh={PHOBOS:`${$.PLANET_MOONS_NAME}_Phobos`,DEIMOS:`${$.PLANET_MOONS_NAME}_Deimos`},Vh=[{size:.1,orbitRadius:5,orbitSpeed:.002*Q.accelerationOrbit,orbitalPeriodDays:.319,modelPath:`/images/mars/phobos.glb`,xPosition:6},{size:.1,orbitRadius:12.5,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.263,modelPath:`/images/mars/deimos.glb`,xPosition:14}],Hh=async e=>{let t=await Um(`MARS`),n=Jm(`MARS`,em,Qp,$p,Em(`MARS`),`/images/marsmap.jpg`,`/images/marsbump.jpg`,null,null,[],t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME);for(let[e,t]of Vh.entries())t.modelPath!==void 0&&(t.mesh=(await Am(t.modelPath)).children[0],e===0&&(t.mesh.name=Bh.PHOBOS),e===1&&(t.mesh.name=Bh.DEIMOS),t.mesh.scale.set(t.size,t.size,t.size),t.mesh.position.set(t.xPosition??0,0,0),t.mesh.castShadow=!0,t.mesh.receiveShadow=!0,r.add(t.mesh));return n},Uh=async e=>{let t=await Um(`MERCURY`);return Jm(`MERCURY`,Kp,Wp,Gp,Em(`MERCURY`),`/images/mercurymap.jpg`,`/images/mercurybump.jpg`,null,null,[],t,e)},Wh={TRITON:`${$.PLANET_MOONS_NAME}_Triton`,PROTEUS:`${$.PLANET_MOONS_NAME}_Proteus`,NEREID:`${$.PLANET_MOONS_NAME}_Nereid`},Gh=[{size:kp*.21,texture:`/images/Triton-tok.webp`,orbitRadius:14,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:5.88,xPosition:120,retrograde:!0},{size:kp*.033,texture:`/images/Proteus.webp`,orbitRadius:10,orbitSpeed:35e-5*Q.accelerationOrbit,orbitalPeriodDays:1.12,xPosition:150},{size:kp*.053,texture:`/images/Nereidimproved.webp`,orbitRadius:18,orbitSpeed:8e-5*Q.accelerationOrbit,orbitalPeriodDays:360.14,xPosition:210}],Kh=async e=>{let t=await Um(`NEPTUNE`),n=Jm(`NEPTUNE`,gm,mm,hm,Em(`NEPTUNE`),`/images/neptune.jpg`,null,null,null,Gh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Wh.TRITON),e===1&&(t.name=Wh.PROTEUS),e===2&&(t.name=Wh.NEREID),t.position.set(Gh[e].xPosition??0,0,0);return n},qh=e=>{let{renderer:t,camera:n,controls:r,planets:i,onResetView:a}=e,o=new Zo,s=new U,c=new U,l=new W,u=new W,d=new W,f=new W,p=new W,m=new W,h=new W,g=null,_=!1,v=null,y=null,b=document.createElement(`button`),x=`PlanetHoverRimLight`,S=new Ca({uniforms:{rimColor:{value:new J(10080767)},rimPower:{value:2.6}},vertexShader:`
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1}),C=e=>{let n=t.domElement.getBoundingClientRect();s.x=(e.clientX-n.left)/n.width*2-1,s.y=-((e.clientY-n.top)/n.height)*2+1};b.type=`button`,b.className=`planet-zoom-close-button`,b.textContent=`視点をリセット`,b.title=`視点をリセット`,b.setAttribute(`aria-label`,`視点をリセット`),b.hidden=!0,b.addEventListener(`click`,()=>{a()}),document.body.appendChild(b);let w=(e,t)=>{let n=e.getObjectByName(x);if(t){if(n)return;let t=new ni(e.geometry,S);t.name=x,t.scale.setScalar(1.04),e.add(t);return}n&&e.remove(n)},T=()=>{g&&=(w(g,!1),null)},E=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2,D=()=>{y!==null&&(cancelAnimationFrame(y),y=null),r.enabled=!0},O=(e,t)=>{D(),r.enabled=!1,f.copy(n.position),p.copy(e),m.copy(r.target),h.copy(t);let i=performance.now(),a=e=>{let t=Math.min((e-i)/650,1),o=E(t);if(n.position.lerpVectors(f,p,o),r.target.lerpVectors(m,h,o),r.update(),t<1){y=requestAnimationFrame(a);return}y=null,r.enabled=!0};y=requestAnimationFrame(a)},k=()=>_?(D(),T(),_=!1,Q.isOrbitPausedByZoom=!1,Oh(),Dh(!1),b.hidden=!0,!0):!1,A=()=>{b.hidden=!1},j=e=>{e.getWorldPosition(l);let t=e.geometry;t.computeBoundingSphere();let i=t.boundingSphere?.radius??1;e.getWorldScale(u);let a=i*Math.max(u.x,u.y,u.z)/Math.tan(Dm(n.fov)/2)*1.35;d.subVectors(n.position,r.target),d.lengthSq()===0&&d.set(0,0,1),d.normalize(),p.copy(l).add(d.multiplyScalar(a)),O(p,l)},ee=e=>{e.isPrimary&&(v=e.pointerId,c.set(e.clientX,e.clientY))},M=()=>{v=null};return{handlePlanetPointerDown:ee,handlePlanetPointerUp:e=>{if(!e.isPrimary||v!==e.pointerId)return;let t=c.distanceTo(new U(e.clientX,e.clientY));if(M(),t>10)return;C(e),o.setFromCamera(s,n);let r=o.intersectObjects(i,!1);if(r.length===0)return;let a=r[0].object;_||(Q.isOrbitPausedByZoom=!0,Oh(),_=!0,Dh(!0)),A(),j(a)},clearPlanetTapState:M,handlePlanetHover:e=>{C(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1)[0]?.object;if(!(t instanceof ni)){T();return}g!==t&&(T(),g=t,w(t,!0))},clearPlanetHover:T,exitPlanetZoom:k}},Jh={TITAN:`${$.PLANET_MOONS_NAME}_Titan`,RHEA:`${$.PLANET_MOONS_NAME}_Rhea`,IAPETUS:`${$.PLANET_MOONS_NAME}_Iapetus`,MIMAS:`${$.PLANET_MOONS_NAME}_Mimas`,ENCELADUS:`${$.PLANET_MOONS_NAME}_Enceladus`},Yh=[{size:kp*.4,texture:`/images/RS3_Titan.webp`,orbitRadius:16,orbitSpeed:9e-5*Q.accelerationOrbit,orbitalPeriodDays:15.95,xPosition:137},{size:kp*.12,texture:`/images/RS3_Rhea.webp`,orbitRadius:12,orbitSpeed:18e-5*Q.accelerationOrbit,orbitalPeriodDays:4.52,xPosition:116},{size:kp*.115,texture:`/images/LapetusNew.webp`,orbitRadius:22,orbitSpeed:1e-5*Q.accelerationOrbit,orbitalPeriodDays:79.3,xPosition:180},{size:kp*.031,texture:`/images/RS3_Mimas.webp`,orbitRadius:8,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:.942,xPosition:102},{size:kp*.04,texture:`/images/Enceladus.webp`,orbitRadius:10,orbitSpeed:45e-5*Q.accelerationOrbit,orbitalPeriodDays:1.37,xPosition:110}],Xh=async e=>{let t=await Um(`SATURN`),n=Jm(`SATURN`,cm,om,sm,Em(`SATURN`),`/images/saturnmap.jpg`,null,{innerRadius:18,outerRadius:29,texture:`/images/saturn_ring.png`},null,Yh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Jh.TITAN),e===1&&(t.name=Jh.RHEA),e===2&&(t.name=Jh.IAPETUS),e===3&&(t.name=Jh.MIMAS),e===4&&(t.name=Jh.ENCELADUS),t.position.set(Yh[e].xPosition??0,0,0);return n},Zh=`Sun`,Qh=new Ta({emissive:Rp,emissiveMap:new oo().load(km(`/images/sun.jpg`)),emissiveIntensity:Q.sunIntensity}),$h=()=>{let e=new ni(new ma(Ip,32,20),Qh);e.name=Zh;let t=new wo(zp,100,0,Bp),n=new wo(Vp,20,Hp,Up);return e.add(t),e.add(n),e},eg={MIRANDA:`${$.PLANET_MOONS_NAME}_Miranda`,ARIEL:`${$.PLANET_MOONS_NAME}_Ariel`,UMBRIEL:`${$.PLANET_MOONS_NAME}_Umbriel`,TITANIA:`${$.PLANET_MOONS_NAME}_Titania`,OBERON:`${$.PLANET_MOONS_NAME}_Oberon`},tg=[{size:kp*.037,texture:`/images/Miranda-0.webp`,orbitRadius:10,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:1.41,xPosition:58},{size:kp*.084,texture:`/images/Ariel-0.webp`,orbitRadius:10,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:2.52,xPosition:90},{size:kp*.07,texture:`/images/Uranus-0.webp`,orbitRadius:10,orbitSpeed:4e-4*Q.accelerationOrbit,orbitalPeriodDays:4.14,xPosition:120},{size:kp*.11,texture:`/images/Titaniamap.webp`,orbitRadius:10,orbitSpeed:3e-4*Q.accelerationOrbit,orbitalPeriodDays:8.71,xPosition:150},{size:kp*.105,texture:`/images/Oberonmap1.webp`,orbitRadius:10,orbitSpeed:2e-4*Q.accelerationOrbit,orbitalPeriodDays:13.46,xPosition:180}],ng=async e=>{let t=await Um(`URANUS`),n=Jm(`URANUS`,fm,um,dm,Em(`URANUS`),`/images/uranus.jpg`,null,{innerRadius:8,outerRadius:10,texture:`/images/uranus_ring.png`},null,tg,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=eg.MIRANDA),e===1&&(t.name=eg.ARIEL),e===2&&(t.name=eg.UMBRIEL),e===3&&(t.name=eg.TITANIA),e===4&&(t.name=eg.OBERON),t.position.set(tg[e].xPosition??0,0,0);return n},rg=async e=>{let t=await Um(`VENUS`);return Jm(`VENUS`,Xp,Jp,Yp,Em(`VENUS`),`/images/venusmap.jpg`,`/images/venusbump.jpg`,null,`/images/venus_atmosphere.jpg`,[],t,e)};function ig(e,t,n){let{earthPlanetSystem:r,earthPlanet:i,earthAtmosphere:a,moon:o}=t;{let t=n.pathPoints.length-1,o=e.dayIndex%t,s=n.pathPoints[o],c=(o+1)%t,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Dm(360/Q.lerpFrame*Q.accelerationRotation);i.rotateY(u),a.rotateY(u+Fp)}{let t=Dm(5),n=Dm(360/(Pp*Q.lerpFrame)*Q.accelerationOrbit),r=e.frameCount*n,{orbitRadius:i}=Xm[0],a=i*Math.cos(r),s=i*Math.sin(r)*Math.sin(t),c=i*Math.sin(r)*Math.cos(t);o.position.set(-a,s,c);let l=n;o.rotateY(l)}}function ag(e,t,n){let{mercuryPlanetSystem:r,mercuryPlanet:i}=t,a=n.pathPoints.length-1,o=e.dayIndex%a,s=n.pathPoints[o],c=(o+1)%a,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Dm(360/(Q.lerpFrame*Hm(`MERCURY`))*Q.accelerationRotation);i.rotateY(u)}function og(e,t,n){let{venusPlanetSystem:r,venusPlanet:i,venusAtmosphere:a}=t,o=n.pathPoints.length-1,s=e.dayIndex%o,c=n.pathPoints[s],l=(s+1)%o,u=n.pathPoints[l];e.buf.copy(c).lerp(u,e.dayFraction),r.position.copy(e.buf);let d=Dm(360/(Q.lerpFrame*Hm(`VENUS`))*Q.accelerationRotation);i.rotateY(d),a.rotateY(d*60)}function sg(e,t,n){let{marsPlanetSystem:r,marsPlanet:i,phobos:a,deimos:o}=t,s=wm(`MARS`),c=n.pathPoints.length-1,l=e.dayIndex+e.dayFraction,u=Math.floor(l/s)%c,d=n.pathPoints[u],f=(u+1)%c,p=n.pathPoints[f],m=l%s/s;e.buf.copy(d).lerp(p,m),r.position.copy(e.buf);let h=Dm(360/(Q.lerpFrame*Hm(`MARS`))*Q.accelerationRotation);i.rotateY(h);let g=Vh[0].orbitRadius,_=Vh[1].orbitRadius,v=e.frameCount*Q.accelerationOrbit*4,y=e.frameCount*Q.accelerationOrbit*1,b=g*Math.cos(v),x=g*Math.sin(v);a.position.set(-b,0,x);let S=_*Math.cos(y),C=_*Math.sin(y);o.position.set(-S,0,C)}function cg(e,t,n){let{jupiterPlanetSystem:r,jupiterPlanet:i,io:a,europa:o,ganymede:s,callisto:c}=t,l=wm(`JUPITER`),u=n.pathPoints.length-1,d=e.dayIndex+e.dayFraction,f=Math.floor(d/l)%u,p=n.pathPoints[f],m=(f+1)%u,h=n.pathPoints[m],g=d%l/l;e.buf.copy(p).lerp(h,g),r.position.copy(e.buf);let _=Dm(360/(Q.lerpFrame*Hm(`JUPITER`))*Q.accelerationRotation);i.rotateY(_);{let t=Rh[0].orbitRadius+(Rh[0].xPosition??0),n=Rh[1].orbitRadius+(Rh[1].xPosition??0),r=Rh[2].orbitRadius+(Rh[2].xPosition??0),i=Rh[3].orbitRadius+(Rh[3].xPosition??0),l=e.frameCount*Q.accelerationOrbit*(1/Rh[0].orbitalPeriodDays),u=e.frameCount*Q.accelerationOrbit*(1/Rh[1].orbitalPeriodDays),d=e.frameCount*Q.accelerationOrbit*(1/Rh[2].orbitalPeriodDays),f=e.frameCount*Q.accelerationOrbit*(1/Rh[3].orbitalPeriodDays),p=t*Math.cos(l),m=t*Math.sin(l);a.position.set(-p,0,m);let h=n*Math.cos(u),g=n*Math.sin(u);o.position.set(-h,0,g);let _=r*Math.cos(d),v=r*Math.sin(d);s.position.set(-_,0,v);let y=i*Math.cos(f),b=i*Math.sin(f);c.position.set(-y,0,b)}}function lg(e,t,n){let{saturnPlanetSystem:r,saturnPlanet:i,titan:a,rhea:o,iapetus:s,mimas:c,enceladus:l}=t,u=wm(`SATURN`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Dm(360/(Q.lerpFrame*Hm(`SATURN`))*Q.accelerationRotation);i.rotateY(v);{let t=Dm(sm),n=Yh[0].orbitRadius+(Yh[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Yh[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Yh[1].orbitRadius+(Yh[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Yh[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Yh[2].orbitRadius+(Yh[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Yh[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Yh[3].orbitRadius+(Yh[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Yh[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=Yh[4].orbitRadius+(Yh[4].xPosition??0),ee=e.frameCount*Q.accelerationOrbit*(1/Yh[4].orbitalPeriodDays),M=-j*Math.cos(ee),te=j*Math.sin(ee),ne=M*Math.cos(t),N=M*Math.sin(t);l.position.set(ne,N,te)}}function ug(e,t,n){let{uranusPlanetSystem:r,uranusPlanet:i,miranda:a,ariel:o,umbriel:s,titania:c,oberon:l}=t,u=wm(`URANUS`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Dm(360/(Q.lerpFrame*Hm(`URANUS`))*Q.accelerationRotation);i.rotateY(v);{let t=Dm(dm),n=tg[0].orbitRadius+(tg[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/tg[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=tg[1].orbitRadius+(tg[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/tg[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=tg[2].orbitRadius+(tg[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/tg[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=tg[3].orbitRadius+(tg[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/tg[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=tg[4].orbitRadius+(tg[4].xPosition??0),ee=e.frameCount*Q.accelerationOrbit*(1/tg[4].orbitalPeriodDays),M=-j*Math.cos(ee),te=j*Math.sin(ee),ne=M*Math.cos(t),N=M*Math.sin(t);l.position.set(ne,N,te)}}function dg(e,t,n){let{neptunePlanetSystem:r,neptunePlanet:i,triton:a,proteus:o,nereid:s}=t,c=wm(`NEPTUNE`),l=n.pathPoints.length-1,u=e.dayIndex+e.dayFraction,d=Math.floor(u/c)%l,f=n.pathPoints[d],p=(d+1)%l,m=n.pathPoints[p],h=u%c/c;e.buf.copy(f).lerp(m,h),r.position.copy(e.buf);let g=Dm(360/(Q.lerpFrame*Hm(`NEPTUNE`))*Q.accelerationRotation);i.rotateY(g);{let t=Dm(hm),n=Gh[0].orbitRadius+(Gh[0].xPosition??0),r=(Gh[0].retrograde?-1:1)*e.frameCount*Q.accelerationOrbit*(1/Gh[0].orbitalPeriodDays),i=-n*Math.cos(r),c=n*Math.sin(r),l=i*Math.cos(t),u=i*Math.sin(t);a.position.set(l,u,c);let d=Gh[1].orbitRadius+(Gh[1].xPosition??0),f=e.frameCount*Q.accelerationOrbit*(1/Gh[1].orbitalPeriodDays),p=-d*Math.cos(f),m=d*Math.sin(f),h=p*Math.cos(t),g=p*Math.sin(t);o.position.set(h,g,m);let _=Gh[2].orbitRadius+(Gh[2].xPosition??0),v=e.frameCount*Q.accelerationOrbit*(1/Gh[2].orbitalPeriodDays),y=-_*Math.cos(v),b=_*Math.sin(v),x=y*Math.cos(t),S=y*Math.sin(t);s.position.set(x,S,b)}}var fg=5e3,pg=5,mg=185,hg=275,gg=30,_g=class{permutation;constructor(e){this.permutation=this.generatePermutation(e)}generatePermutation(e){let t=Array.from({length:256},(e,t)=>t);for(let n=255;n>0;n--){let r=this.seededRandom(e+n),i=Math.floor(r*(n+1));[t[n],t[i]]=[t[i],t[n]]}return[...t,...t]}seededRandom(e){let t=Math.sin(e)*1e4;return t-Math.floor(t)}fade(e){return e*e*e*(e*(e*6-15)+10)}lerp(e,t,n){return t+e*(n-t)}grad(e,t,n,r){let i=e&15,a=i<8?t:n,o=i<8?n:r;return(i&1?-a:a)+(i&2?-o:o)}noise(e,t,n){let r=Math.floor(e)&255,i=Math.floor(t)&255,a=Math.floor(n)&255,o=e-Math.floor(e),s=t-Math.floor(t),c=n-Math.floor(n),l=this.fade(o),u=this.fade(s),d=this.fade(c),f=this.permutation,p=f[f[f[r]+i]+a],m=f[f[f[r]+i+1]+a],h=f[f[f[r]+i]+a+1],g=f[f[f[r]+i+1]+a+1],_=f[f[f[r+1]+i]+a],v=f[f[f[r+1]+i+1]+a],y=f[f[f[r+1]+i]+a+1],b=f[f[f[r+1]+i+1]+a+1],x=this.grad(p,o,s,c),S=this.grad(_,o-1,s,c),C=this.grad(m,o,s-1,c),w=this.grad(v,o-1,s-1,c),T=this.grad(h,o,s,c-1),E=this.grad(y,o-1,s,c-1),D=this.grad(g,o,s-1,c-1),O=this.grad(b,o-1,s-1,c-1),k=this.lerp(l,x,S),A=this.lerp(l,C,w),j=this.lerp(u,k,A),ee=this.lerp(l,T,E),M=this.lerp(l,D,O),te=this.lerp(u,ee,M);return this.lerp(d,j,te)}fbm(e,t,n,r=4){let i=0,a=1,o=1,s=0;for(let c=0;c<r;c++)i+=a*this.noise(e*o,t*o,n*o),s+=a,a*=.5,o*=2;return i/s}};function vg(e){let t=new da(1,4),n=t.getAttribute(`position`),r=n.array,i=new _g(e);for(let e=0;e<r.length;e+=3){let t=r[e],n=r[e+1],a=r[e+2],o=Math.sqrt(t*t+n*n+a*a),s=t/o,c=n/o,l=a/o,u=i.fbm(t*2,n*2,a*2,3)*.3;r[e]=t+s*u,r[e+1]=n+c*u,r[e+2]=a+l*u}return n.needsUpdate=!0,t.computeVertexNormals(),t}var yg=class{group;instancedMeshes=[];constructor(){this.group=new On,this.group.name=`AsteroidBelt`,this.initAsteroidBelt()}initAsteroidBelt(){let e=[];for(let t=0;t<pg;t++)e.push(vg(t*12345));let t=Math.floor(fg/pg);e.forEach((e,n)=>{let r=new Oi(e,this.createRockMaterial(n),t);r.castShadow=!0,r.receiveShadow=!0;let i=new q;for(let e=0;e<t;e++){let t=Math.random()*Math.PI*2,n=mg+Math.random()*(hg-mg),a=(Math.random()-.5)*gg,o=Math.cos(t)*n,s=Math.sin(t)*n,c=a,l=new Mt;l.setFromEuler(new un(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2));let u=.3+Math.random()*.7,d=u*(.8+Math.random()*.4),f=u*(.8+Math.random()*.4),p=u*(.8+Math.random()*.4);i.compose(new W(o,c,s),l,new W(d,f,p)),r.setMatrixAt(e,i)}r.instanceMatrix.needsUpdate=!0,this.instancedMeshes.push(r),this.group.add(r)})}createRockMaterial(e){let t=[9139029,6908265,8421504,7036244,4868682];return new Ta({color:t[e%t.length],metalness:.3+Math.random()*.2,roughness:.7+Math.random()*.2})}animate(e=.016){this.instancedMeshes.forEach(t=>{t.rotation.y+=e*.015})}getGroup(){return this.group}},bg=class{loadingScreen=document.getElementById(`loading-screen`);loadingStatus=document.getElementById(`loading-status`);renderer=new yu;scene=new In;camera;controls;composer;labelRenderer;zoomablePlanets=[];planetInteractionController;sunMesh;earthGroup;mercuryGroup;venusGroup;marsGroup;jupiterGroup;saturnGroup;uranusGroup;neptuneGroup;asteroidBelt;dayFraction=0;dayIndex=0;timer=new Io;frameCount=0;_cachedMeshes;_interpolatedPos=new W;_prevShowOrbits=Q.showOrbits;_prevShowLabels=Q.showLabels;_prevShowCurrentPosition=Q.showCurrentPosition;_prevShowPlanets=Q.showPlanets;resetPlanetZoomView=()=>{this.planetInteractionController.exitPlanetZoom()&&th(this.camera,this.controls)};constructor(){let{camera:e,controls:t,composer:n,labelRenderer:r}=Nh(this.renderer,this.scene,this.width,this.height);this.camera=e,this.controls=t,this.composer=n,this.labelRenderer=r,this.updateLoadingState(`太陽系データを読み込み中...`),this.initPlanets().catch(e=>{this.showLoadingError(`読み込みに失敗しました。ページを再読み込みしてください。`)})}get userDataEarthPositionRes(){return this.earthGroup.userData.planetPositionsRes}get width(){return window.innerWidth}get height(){return window.innerHeight}async initPlanets(){this.updateLoadingState(`太陽と地球を読み込み中...`),this.sunMesh=$h(),this.scene.add(this.sunMesh),this.earthGroup=await Zm(this.sunMesh.position,Q.showCurrentPosition),this.dayIndex=this.userDataEarthPositionRes.todayRow-1,this.scene.add(this.earthGroup),this.updateLoadingState(`水星を読み込み中...`);let e=await Uh(Q.showCurrentPosition);this.updateLoadingState(`金星を読み込み中...`);let t=await rg(Q.showCurrentPosition);this.updateLoadingState(`火星を読み込み中...`);let n=await Hh(Q.showCurrentPosition);this.updateLoadingState(`木星を読み込み中...`);let r=await zh(Q.showCurrentPosition);this.updateLoadingState(`土星を読み込み中...`);let i=await Xh(Q.showCurrentPosition);this.updateLoadingState(`天王星を読み込み中...`);let a=await ng(Q.showCurrentPosition);this.updateLoadingState(`海王星を読み込み中...`);let o=await Kh(Q.showCurrentPosition);this.mercuryGroup=e,this.scene.add(e),this.venusGroup=t,this.scene.add(t),this.marsGroup=n,this.scene.add(n),this.jupiterGroup=r,this.scene.add(r),this.saturnGroup=i,this.scene.add(i),this.uranusGroup=a,this.scene.add(a),this.neptuneGroup=o,this.scene.add(o),this.updateLoadingState(`小惑星帯を生成中...`),this.asteroidBelt=new yg,this.scene.add(this.asteroidBelt.getGroup()),this.initPlanetTapZoom(),Ih({sunMesh:this.sunMesh,camera:this.camera,controls:this.controls,onExitPlanetZoom:()=>{this.planetInteractionController.exitPlanetZoom()},setDayIndex:e=>{this.dayIndex=e},setDayFraction:e=>{this.dayFraction=e},setFrameCount:e=>{this.frameCount=e},userDataEarthPositionRes:this.userDataEarthPositionRes,currentIndex:this.dayIndex}),this._initMeshCache(),this.updateLoadingState(`描画を開始中...`),this.renderer.setAnimationLoop(()=>this.render()),this.render(),window.requestAnimationFrame(()=>this.hideLoadingScreen())}updateLoadingState(e){this.loadingStatus&&(this.loadingStatus.textContent=e)}hideLoadingScreen(){this.loadingScreen&&(this.loadingScreen.classList.add(`is-hidden`),window.setTimeout(()=>this.loadingScreen?.remove(),400))}showLoadingError(e){this.loadingScreen&&(this.loadingScreen.classList.add(`is-error`),this.updateLoadingState(e))}_initMeshCache(){this._cachedMeshes={earthPlanetSystem:this.earthGroup.getObjectByName($.PLANET_SYSTEM_NAME),earthPlanet:this.earthGroup.getObjectByName($.PLANET_NAME),earthAtmosphere:this.earthGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),moon:this.earthGroup.getObjectByName(Ym.MOON),mercuryPlanetSystem:this.mercuryGroup.getObjectByName($.PLANET_SYSTEM_NAME),mercuryPlanet:this.mercuryGroup.getObjectByName($.PLANET_NAME),venusPlanetSystem:this.venusGroup.getObjectByName($.PLANET_SYSTEM_NAME),venusPlanet:this.venusGroup.getObjectByName($.PLANET_NAME),venusAtmosphere:this.venusGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),marsPlanetSystem:this.marsGroup.getObjectByName($.PLANET_SYSTEM_NAME),marsPlanet:this.marsGroup.getObjectByName($.PLANET_NAME),phobos:this.marsGroup.getObjectByName(Bh.PHOBOS),deimos:this.marsGroup.getObjectByName(Bh.DEIMOS),jupiterPlanetSystem:this.jupiterGroup.getObjectByName($.PLANET_SYSTEM_NAME),jupiterPlanet:this.jupiterGroup.getObjectByName($.PLANET_NAME),io:this.jupiterGroup.getObjectByName(Lh.IO),europa:this.jupiterGroup.getObjectByName(Lh.EUROPA),ganymede:this.jupiterGroup.getObjectByName(Lh.GANYMEDE),callisto:this.jupiterGroup.getObjectByName(Lh.CALLISTO),saturnPlanetSystem:this.saturnGroup.getObjectByName($.PLANET_SYSTEM_NAME),saturnPlanet:this.saturnGroup.getObjectByName($.PLANET_NAME),titan:this.saturnGroup.getObjectByName(Jh.TITAN),rhea:this.saturnGroup.getObjectByName(Jh.RHEA),iapetus:this.saturnGroup.getObjectByName(Jh.IAPETUS),mimas:this.saturnGroup.getObjectByName(Jh.MIMAS),enceladus:this.saturnGroup.getObjectByName(Jh.ENCELADUS),uranusPlanetSystem:this.uranusGroup.getObjectByName($.PLANET_SYSTEM_NAME),uranusPlanet:this.uranusGroup.getObjectByName($.PLANET_NAME),miranda:this.uranusGroup.getObjectByName(eg.MIRANDA),ariel:this.uranusGroup.getObjectByName(eg.ARIEL),umbriel:this.uranusGroup.getObjectByName(eg.UMBRIEL),titania:this.uranusGroup.getObjectByName(eg.TITANIA),oberon:this.uranusGroup.getObjectByName(eg.OBERON),neptunePlanetSystem:this.neptuneGroup.getObjectByName($.PLANET_SYSTEM_NAME),neptunePlanet:this.neptuneGroup.getObjectByName($.PLANET_NAME),triton:this.neptuneGroup.getObjectByName(Wh.TRITON),proteus:this.neptuneGroup.getObjectByName(Wh.PROTEUS),nereid:this.neptuneGroup.getObjectByName(Wh.NEREID)}}initPlanetTapZoom(){let e=this.earthGroup.getObjectByName($.PLANET_NAME),t=this.mercuryGroup.getObjectByName($.PLANET_NAME),n=this.venusGroup.getObjectByName($.PLANET_NAME),r=this.marsGroup.getObjectByName($.PLANET_NAME),i=this.jupiterGroup.getObjectByName($.PLANET_NAME),a=this.saturnGroup.getObjectByName($.PLANET_NAME),o=this.uranusGroup.getObjectByName($.PLANET_NAME),s=this.neptuneGroup.getObjectByName($.PLANET_NAME);this.zoomablePlanets=[e,t,n,r,i,a,o,s].filter(e=>e instanceof ni),this.planetInteractionController=qh({renderer:this.renderer,camera:this.camera,controls:this.controls,planets:this.zoomablePlanets,onResetView:this.resetPlanetZoomView}),this.renderer.domElement.addEventListener(`pointerdown`,this.planetInteractionController.handlePlanetPointerDown),this.renderer.domElement.addEventListener(`pointerup`,this.planetInteractionController.handlePlanetPointerUp),this.renderer.domElement.addEventListener(`pointercancel`,this.planetInteractionController.clearPlanetTapState),this.renderer.domElement.addEventListener(`pointermove`,this.planetInteractionController.handlePlanetHover),this.renderer.domElement.addEventListener(`pointerleave`,this.planetInteractionController.clearPlanetHover)}render(){this.controls.update(),this.composer.render(),this.labelRenderer.render(this.scene,this.camera),Q.isAnimating&&this.animate(),this.#e()}#e(){(Q.showOrbits!==this._prevShowOrbits||Q.showLabels!==this._prevShowLabels||Q.showCurrentPosition!==this._prevShowCurrentPosition||Q.showPlanets!==this._prevShowPlanets)&&(this._prevShowOrbits=Q.showOrbits,this._prevShowLabels=Q.showLabels,this._prevShowCurrentPosition=Q.showCurrentPosition,this._prevShowPlanets=Q.showPlanets,[this.earthGroup,this.mercuryGroup,this.venusGroup,this.marsGroup,this.jupiterGroup,this.saturnGroup,this.uranusGroup,this.neptuneGroup].forEach(e=>{this.#t(e);let t=e.getObjectByName($.PLANET_ORBIT_NAME);t&&(t.visible=Q.showOrbits),e.traverse(e=>{(e.name===$.PLANET_NAME||e.name===$.PLANET_RING_NAME||e.name===$.PLANET_AXIS_NAME||e.name===$.PLANET_ATMO_SPHERE_NAME||e.name.startsWith($.PLANET_MOONS_NAME))&&(e.visible=Q.showPlanets),e.name===$.PLANET_LABEL_NAME&&(e.visible=Q.showLabels)})}))}#t(e){let t=e.userData.commandKey,n=e.userData.planetPositionsRes;if(!t||!n)return;let r=e.getObjectByName(Wm(t));if(Q.showCurrentPosition){r||Gm({parent:e,commandKey:t,planetPositionsRes:n});return}r&&Km(e,t)}animate(){let e=!Q.isOrbitPausedByZoom;this.frameCount++,Eh(this.dayIndex),this.sunMesh.rotateY(Lp*Q.accelerationRotation),e&&(this.dayFraction=Number(((this.dayFraction+1/Q.lerpFrame)*Q.accelerationOrbit).toFixed(3)),this.dayFraction>=1&&(this.dayIndex+=1,this.dayFraction=0));let t={dayIndex:this.dayIndex,dayFraction:this.dayFraction,frameCount:this.frameCount,buf:this._interpolatedPos};ig(t,this._cachedMeshes,this.userDataEarthPositionRes),ag(t,this._cachedMeshes,this.mercuryGroup.userData.planetPositionsRes),og(t,this._cachedMeshes,this.venusGroup.userData.planetPositionsRes),sg(t,this._cachedMeshes,this.marsGroup.userData.planetPositionsRes),cg(t,this._cachedMeshes,this.jupiterGroup.userData.planetPositionsRes),lg(t,this._cachedMeshes,this.saturnGroup.userData.planetPositionsRes),ug(t,this._cachedMeshes,this.uranusGroup.userData.planetPositionsRes),dg(t,this._cachedMeshes,this.neptuneGroup.userData.planetPositionsRes),e&&this.asteroidBelt.animate(.016)}};window.addEventListener(`DOMContentLoaded`,()=>{new bg});