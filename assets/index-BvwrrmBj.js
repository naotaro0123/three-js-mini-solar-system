...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ms(e,t,n){let r=new Float32Array(vs),i=new U(0,1,0);return new wa({name:`SphericalGaussianBlur`,defines:{n:vs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ns(){return new wa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ps(){return new wa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fs(),fragmentShader:`
	...
	`}var Is=class extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`})}_getEdgeDetectionMaterial(){return new wa({uniforms:{maskTexture:{value:null},texSize:{value:new H(.5,.5)},visibleEdgeColor:{value:new U(1,1,1)},hiddenEdgeColor:{value:new U(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getSeparableBlurMaterial(e){return new wa({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new H(.5,.5)},direction:{value:new H(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getOverlayMaterial(){return new wa({uniforms:{maskTexture:{value:null},edgeTexture1:{value:null},edgeTexture2:{value:null},patternTexture:{value:null},edgeStrength:{value:1},edgeGlow:{value:1},usePatternTexture:{value:0}},vertexShader:`varying vec2 vUv;
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};af.BlurDirectionX=new H(1,0),af.BlurDirectionY=new H(0,1);var of=class extends On{constructor(e=document.createElement(`div`)){super(),this.isCSS2DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.center=new H(.5,.5),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element&&e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this.center=e.center,this}},sf=new U,cf=new K,lf=new K,uf=new U,df=new U,ff=class{constructor(e={}){let t=this,n,r,i,a,o={objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s,this.sortObjects=!0,this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),cf.copy(t.matrixWorldInverse),lf.multiplyMatrices(t.projectionMatrix,cf),l(e,e,t),this.sortObjects&&f(e)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`};function c(e){e.isCSS2DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)c(e.children[t])}function l(e,n,r){if(e.visible===!1){c(e);return}if(e.isCSS2DObject){sf.setFromMatrixPosition(e.matrixWorld),sf.applyMatrix4(lf);let c=sf.z>=-1&&sf.z<=1&&e.layers.test(r.layers)===!0,l=e.element;l.style.display=c===!0?``:`none`,c===!0&&(e.onBeforeRender(t,n,r),l.style.transform=`translate(`+-100*e.center.x+`%,`+-100*e.center.y+`%)translate(`+(sf.x*i+i)+`px,`+(-sf.y*a+a)+`px)`,l.parentNode!==s&&s.appendChild(l),e.onAfterRender(t,n,r));let d={distanceToCameraSquared:u(r,e)};o.objects.set(e,d)}for(let t=0,i=e.children.length;t<i;t++)l(e.children[t],n,r)}function u(e,t){return uf.setFromMatrixPosition(e.matrixWorld),df.setFromMatrixPosition(t.matrixWorld),uf.distanceToSquared(df)}function d(e){let t=[];return e.traverseVisible(function(e){e.isCSS2DObject&&t.push(e)}),t}function f(e){let t=d(e).sort(function(e,t){return e.renderOrder===t.renderOrder?o.objects.get(e).distanceToCameraSquared-o.objects.get(t).distanceToCameraSquared:t.renderOrder-e.renderOrder}),n=t.length;for(let e=0,r=t.length;e<r;e++)t[e].element.style.zIndex=n-e}}},pf=365.2425,mf=6048e5,hf=864e5,gf=3600*24;gf*7,gf*pf/12*3;var _f=Symbol.for(`constructDateFrom`);function vf(e,t){return typeof e==`function`?e(t):e&&typeof e==`object`&&_f in e?e[_f](t):e instanceof Date?new e.constructor(t):new Date(t)}function yf(e,t){return vf(t||e,e)}function bf(e,t,n){let r=yf(e,n?.in);return isNaN(t)?vf(n?.in||e,NaN):(t&&r.setDate(r.getDate()+t),r)}var xf={};function Sf(){return xf}function Cf(e,t){let n=Sf(),r=t?.weekStartsOn??t?.locale?.options?.weekStartsOn??n.weekStartsOn??n.locale?.options?.weekStartsOn??0,i=yf(e,t?.in),a=i.getDay(),o=(a<r?7:0)+a-r;return i.setDate(i.getDate()-o),i.setHours(0,0,0,0),i}function wf(e,t){return Cf(e,{...t,weekStartsOn:1})}function Tf(e,t){let n=yf(e,t?.in),r=n.getFullYear(),i=vf(n,0);i.setFullYear(r+1,0,4),i.setHours(0,0,0,0);let a=wf(i),o=vf(n,0);o.setFullYear(r,0,4),o.setHours(0,0,0,0);let s=wf(o);return n.getTime()>=a.getTime()?r+1:n.getTime()>=s.getTime()?r:r-1}function Ef(e){let t=yf(e),n=new Date(Date.UTC(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds(),t.getMilliseconds()));return n.setUTCFullYear(t.getFullYear()),e-+n}function Df(e,...t){let n=vf.bind(null,e||t.find(e=>typeof e==`object`));return t.map(n)}function Of(e,t){let n=yf(e,t?.in);return n.setHours(0,0,0,0),n}function kf(e,t,n){let[r,i]=Df(n?.in,e,t),a=Of(r),o=Of(i),s=+a-Ef(a),c=+o-Ef(o);return Math.round((s-c)/hf)}function Af(e,t){let n=Tf(e,t),r=vf(t?.in||e,0);return r.setFullYear(n,0,4),r.setHours(0,0,0,0),wf(r)}function jf(e){return e instanceof Date||typeof e==`object`&&Object.prototype.toString.call(e)===`[object Date]`}function Mf(e){return!(!jf(e)&&typeof e!=`number`||isNaN(+yf(e)))}function Nf(e,t){let n=yf(e,t?.in);return n.setFullYear(n.getFullYear(),0,1),n.setHours(0,0,0,0),n}var Pf={lessThanXSeconds:{one:`less than a second`,other:`less than {{count}} seconds`},xSeconds:{one:`1 second`,other:`{{count}} seconds`},halfAMinute:`half a minute`,lessThanXMinutes:{one:`less than a minute`,other:`less than {{count}} minutes`},xMinutes:{one:`1 minute`,other:`{{count}} minutes`},aboutXHours:{one:`about 1 hour`,other:`about {{count}} hours`},xHours:{one:`1 hour`,other:`{{count}} hours`},xDays:{one:`1 day`,other:`{{count}} days`},aboutXWeeks:{one:`about 1 week`,other:`about {{count}} weeks`},xWeeks:{one:`1 week`,other:`{{count}} weeks`},aboutXMonths:{one:`about 1 month`,other:`about {{count}} months`},xMonths:{one:`1 month`,other:`{{count}} months`},aboutXYears:{one:`about 1 year`,other:`about {{count}} years`},xYears:{one:`1 year`,other:`{{count}} years`},overXYears:{one:`over 1 year`,other:`over {{count}} years`},almostXYears:{one:`almost 1 year`,other:`almost {{count}} years`}},Ff=(e,t,n)=>{let r,i=Pf[e];return r=typeof i==`string`?i:t===1?i.one:i.other.replace(`{{count}}`,t.toString()),n?.addSuffix?n.comparison&&n.comparison>0?`in `+r:r+` ago`:r};function If(e){return(t={})=>{let n=t.width?String(t.width):e.defaultWidth;return e.formats[n]||e.formats[e.defaultWidth]}}var Lf={date:If({formats:{full:`EEEE, MMMM do, y`,long:`MMMM do, y`,medium:`MMM d, y`,short:`MM/dd/yyyy`},defaultWidth:`full`}),time:If({formats:{full:`h:mm:ss a zzzz`,long:`h:mm:ss a z`,medium:`h:mm:ss a`,short:`h:mm a`},defaultWidth:`full`}),dateTime:If({formats:{full:`{{date}} 'at' {{time}}`,long:`{{date}} 'at' {{time}}`,medium:`{{date}}, {{time}}`,short:`{{date}}, {{time}}`},defaultWidth:`full`})},Rf={lastWeek:`'last' eeee 'at' p`,yesterday:`'yesterday at' p`,today:`'today at' p`,tomorrow:`'tomorrow at' p`,nextWeek:`eeee 'at' p`,other:`P`},zf=(e,t,n,r)=>Rf[e];function Bf(e){return(t,n)=>{let r=n?.context?String(n.context):`standalone`,i;if(r===`formatting`&&e.formattingValues){let t=e.defaultFormattingWidth||e.defaultWidth,r=n?.width?String(n.width):t;i=e.formattingValues[r]||e.formattingValues[t]}else{let t=e.defaultWidth,r=n?.width?String(n.width):e.defaultWidth;i=e.values[r]||e.values[t]}let a=e.argumentCallback?e.argumentCallback(t):t;return i[a]}}var Vf={ordinalNumber:(e,t)=>{let n=Number(e),r=n%100;if(r>20||r<10)switch(r%10){case 1:return n+`st`;case 2:return n+`nd`;case 3:return n+`rd`}return n+`th`},era:Bf({values:{narrow:[`B`,`A`],abbreviated:[`BC`,`AD`],wide:[`Before Christ`,`Anno Domini`]},defaultWidth:`wide`}),quarter:Bf({values:{narrow:[`1`,`2`,`3`,`4`],abbreviated:[`Q1`,`Q2`,`Q3`,`Q4`],wide:[`1st quarter`,`2nd quarter`,`3rd quarter`,`4th quarter`]},defaultWidth:`wide`,argumentCallback:e=>e-1}),month:Bf({values:{narrow:[`J`,`F`,`M`,`A`,`M`,`J`,`J`,`A`,`S`,`O`,`N`,`D`],abbreviated:[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`],wide:[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`]},defaultWidth:`wide`}),day:Bf({values:{narrow:[`S`,`M`,`T`,`W`,`T`,`F`,`S`],short:[`Su`,`Mo`,`Tu`,`We`,`Th`,`Fr`,`Sa`],abbreviated:[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`],wide:[`Sunday`,`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`]},defaultWidth:`wide`}),dayPeriod:Bf({values:{narrow:{am:`a`,pm:`p`,midnight:`mi`,noon:`n`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},abbreviated:{am:`AM`,pm:`PM`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},wide:{am:`a.m.`,pm:`p.m.`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`}},defaultWidth:`wide`,formattingValues:{narrow:{am:`a`,pm:`p`,midnight:`mi`,noon:`n`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`},abbreviated:{am:`AM`,pm:`PM`,midnight:`midnight`,noon:`noon`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`},wide:{am:`a.m.`,pm:`p.m.`,midnight:`midnight`,noon:`noon`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`}},defaultFormattingWidth:`wide`})};function Hf(e){return(t,n={})=>{let r=n.width,i=r&&e.matchPatterns[r]||e.matchPatterns[e.defaultMatchWidth],a=t.match(i);if(!a)return null;let o=a[0],s=r&&e.parsePatterns[r]||e.parsePatterns[e.defaultParseWidth],c=Array.isArray(s)?Wf(s,e=>e.test(o)):Uf(s,e=>e.test(o)),l;l=e.valueCallback?e.valueCallback(c):c,l=n.valueCallback?n.valueCallback(l):l;let u=t.slice(o.length);return{value:l,rest:u}}}function Uf(e,t){for(let n in e)if(Object.prototype.hasOwnProperty.call(e,n)&&t(e[n]))return n}function Wf(e,t){for(let n=0;n<e.length;n++)if(t(e[n]))return n}function Gf(e){return(t,n={})=>{let r=t.match(e.matchPattern);if(!r)return null;let i=r[0],a=t.match(e.parsePattern);if(!a)return null;let o=e.valueCallback?e.valueCallback(a[0]):a[0];o=n.valueCallback?n.valueCallback(o):o;let s=t.slice(i.length);return{value:o,rest:s}}}var Kf={code:`en-US`,formatDistance:Ff,formatLong:Lf,formatRelative:zf,localize:Vf,match:{ordinalNumber:Gf({matchPattern:/^(\d+)(th|st|nd|rd)?/i,parsePattern:/\d+/i,valueCallback:e=>parseInt(e,10)}),era:Hf({matchPatterns:{narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},defaultMatchWidth:`wide`,parsePatterns:{any:[/^b/i,/^(a|c)/i]},defaultParseWidth:`any`}),quarter:Hf({matchPatterns:{narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},defaultMatchWidth:`wide`,parsePatterns:{any:[/1/i,/2/i,/3/i,/4/i]},defaultParseWidth:`any`,valueCallback:e=>e+1}),month:Hf({matchPatterns:{narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},defaultMatchWidth:`wide`,parsePatterns:{narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},defaultParseWidth:`any`}),day:Hf({matchPatterns:{narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},defaultMatchWidth:`wide`,parsePatterns:{narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},defaultParseWidth:`any`}),dayPeriod:Hf({matchPatterns:{narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},defaultMatchWidth:`any`,parsePatterns:{any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},defaultParseWidth:`any`})},options:{weekStartsOn:0,firstWeekContainsDate:1}};function qf(e,t){let n=yf(e,t?.in);return kf(n,Nf(n))+1}function Jf(e,t){let n=yf(e,t?.in),r=wf(n)-+Af(n);return Math.round(r/mf)+1}function Yf(e,t){let n=yf(e,t?.in),r=n.getFullYear(),i=Sf(),a=t?.firstWeekContainsDate??t?.locale?.options?.firstWeekContainsDate??i.firstWeekContainsDate??i.locale?.options?.firstWeekContainsDate??1,o=vf(t?.in||e,0);o.setFullYear(r+1,0,a),o.setHours(0,0,0,0);let s=Cf(o,t),c=vf(t?.in||e,0);c.setFullYear(r,0,a),c.setHours(0,0,0,0);let l=Cf(c,t);return+n>=+s?r+1:+n>=+l?r:r-1}function Xf(e,t){let n=Sf(),r=t?.firstWeekContainsDate??t?.locale?.options?.firstWeekContainsDate??n.firstWeekContainsDate??n.locale?.options?.firstWeekContainsDate??1,i=Yf(e,t),a=vf(t?.in||e,0);return a.setFullYear(i,0,r),a.setHours(0,0,0,0),Cf(a,t)}function Zf(e,t){let n=yf(e,t?.in),r=Cf(n,t)-+Xf(n,t);return Math.round(r/mf)+1}function Z(e,t){return(e<0?`-`:``)+Math.abs(e).toString().padStart(t,`0`)}var Qf={y(e,t){let n=e.getFullYear(),r=n>0?n:1-n;return Z(t===`yy`?r%100:r,t.length)},M(e,t){let n=e.getMonth();return t===`M`?String(n+1):Z(n+1,2)},d(e,t){return Z(e.getDate(),t.length)},a(e,t){let n=e.getHours()/12>=1?`pm`:`am`;switch(t){case`a`:case`aa`:return n.toUpperCase();case`aaa`:return n;case`aaaaa`:return n[0];default:return n===`am`?`a.m.`:`p.m.`}},h(e,t){return Z(e.getHours()%12||12,t.length)},H(e,t){return Z(e.getHours(),t.length)},m(e,t){return Z(e.getMinutes(),t.length)},s(e,t){return Z(e.getSeconds(),t.length)},S(e,t){let n=t.length,r=e.getMilliseconds();return Z(Math.trunc(r*10**(n-3)),t.length)}},$f={am:`am`,pm:`pm`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},ep={G:function(e,t,n){let r=+(e.getFullYear()>0);switch(t){case`G`:case`GG`:case`GGG`:return n.era(r,{width:`abbreviated`});case`GGGGG`:return n.era(r,{width:`narrow`});default:return n.era(r,{width:`wide`})}},y:function(e,t,n){if(t===`yo`){let t=e.getFullYear(),r=t>0?t:1-t;return n.ordinalNumber(r,{unit:`year`})}return Qf.y(e,t)},Y:function(e,t,n,r){let i=Yf(e,r),a=i>0?i:1-i;return t===`YY`?Z(a%100,2):t===`Yo`?n.ordinalNumber(a,{unit:`year`}):Z(a,t.length)},R:function(e,t){return Z(Tf(e),t.length)},u:function(e,t){return Z(e.getFullYear(),t.length)},Q:function(e,t,n){let r=Math.ceil((e.getMonth()+1)/3);switch(t){case`Q`:return String(r);case`QQ`:return Z(r,2);case`Qo`:return n.ordinalNumber(r,{unit:`quarter`});case`QQQ`:return n.quarter(r,{width:`abbreviated`,context:`formatting`});case`QQQQQ`:return n.quarter(r,{width:`narrow`,context:`formatting`});default:return n.quarter(r,{width:`wide`,context:`formatting`})}},q:function(e,t,n){let r=Math.ceil((e.getMonth()+1)/3);switch(t){case`q`:return String(r);case`qq`:return Z(r,2);case`qo`:return n.ordinalNumber(r,{unit:`quarter`});case`qqq`:return n.quarter(r,{width:`abbreviated`,context:`standalone`});case`qqqqq`:return n.quarter(r,{width:`narrow`,context:`standalone`});default:return n.quarter(r,{width:`wide`,context:`standalone`})}},M:function(e,t,n){let r=e.getMonth();switch(t){case`M`:case`MM`:return Qf.M(e,t);case`Mo`:return n.ordinalNumber(r+1,{unit:`month`});case`MMM`:return n.month(r,{width:`abbreviated`,context:`formatting`});case`MMMMM`:return n.month(r,{width:`narrow`,context:`formatting`});default:return n.month(r,{width:`wide`,context:`formatting`})}},L:function(e,t,n){let r=e.getMonth();switch(t){case`L`:return String(r+1);case`LL`:return Z(r+1,2);case`Lo`:return n.ordinalNumber(r+1,{unit:`month`});case`LLL`:return n.month(r,{width:`abbreviated`,context:`standalone`});case`LLLLL`:return n.month(r,{width:`narrow`,context:`standalone`});default:return n.month(r,{width:`wide`,context:`standalone`})}},w:function(e,t,n,r){let i=Zf(e,r);return t===`wo`?n.ordinalNumber(i,{unit:`week`}):Z(i,t.length)},I:function(e,t,n){let r=Jf(e);return t===`Io`?n.ordinalNumber(r,{unit:`week`}):Z(r,t.length)},d:function(e,t,n){return t===`do`?n.ordinalNumber(e.getDate(),{unit:`date`}):Qf.d(e,t)},D:function(e,t,n){let r=qf(e);return t===`Do`?n.ordinalNumber(r,{unit:`dayOfYear`}):Z(r,t.length)},E:function(e,t,n){let r=e.getDay();switch(t){case`E`:case`EE`:case`EEE`:return n.day(r,{width:`abbreviated`,context:`formatting`});case`EEEEE`:return n.day(r,{width:`narrow`,context:`formatting`});case`EEEEEE`:return n.day(r,{width:`short`,context:`formatting`});default:return n.day(r,{width:`wide`,context:`formatting`})}},e:function(e,t,n,r){let i=e.getDay(),a=(i-r.weekStartsOn+8)%7||7;switch(t){case`e`:return String(a);case`ee`:return Z(a,2);case`eo`:return n.ordinalNumber(a,{unit:`day`});case`eee`:return n.day(i,{width:`abbreviated`,context:`formatting`});case`eeeee`:return n.day(i,{width:`narrow`,context:`formatting`});case`eeeeee`:return n.day(i,{width:`short`,context:`formatting`});default:return n.day(i,{width:`wide`,context:`formatting`})}},c:function(e,t,n,r){let i=e.getDay(),a=(i-r.weekStartsOn+8)%7||7;switch(t){case`c`:return String(a);case`cc`:return Z(a,t.length);case`co`:return n.ordinalNumber(a,{unit:`day`});case`ccc`:return n.day(i,{width:`abbreviated`,context:`standalone`});case`ccccc`:return n.day(i,{width:`narrow`,context:`standalone`});case`cccccc`:return n.day(i,{width:`short`,context:`standalone`});default:return n.day(i,{width:`wide`,context:`standalone`})}},i:function(e,t,n){let r=e.getDay(),i=r===0?7:r;switch(t){case`i`:return String(i);case`ii`:return Z(i,t.length);case`io`:return n.ordinalNumber(i,{unit:`day`});case`iii`:return n.day(r,{width:`abbreviated`,context:`formatting`});case`iiiii`:return n.day(r,{width:`narrow`,context:`formatting`});case`iiiiii`:return n.day(r,{width:`short`,context:`formatting`});default:return n.day(r,{width:`wide`,context:`formatting`})}},a:function(e,t,n){let r=e.getHours()/12>=1?`pm`:`am`;switch(t){case`a`:case`aa`:return n.dayPeriod(r,{width:`abbreviated`,context:`formatting`});case`aaa`:return n.dayPeriod(r,{width:`abbreviated`,context:`formatting`}).toLowerCase();case`aaaaa`:return n.dayPeriod(r,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(r,{width:`wide`,context:`formatting`})}},b:function(e,t,n){let r=e.getHours(),i;switch(i=r===12?$f.noon:r===0?$f.midnight:r/12>=1?`pm`:`am`,t){case`b`:case`bb`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`});case`bbb`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`}).toLowerCase();case`bbbbb`:return n.dayPeriod(i,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(i,{width:`wide`,context:`formatting`})}},B:function(e,t,n){let r=e.getHours(),i;switch(i=r>=17?$f.evening:r>=12?$f.afternoon:r>=4?$f.morning:$f.night,t){case`B`:case`BB`:case`BBB`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`});case`BBBBB`:return n.dayPeriod(i,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(i,{width:`wide`,context:`formatting`})}},h:function(e,t,n){if(t===`ho`){let t=e.getHours()%12;return t===0&&(t=12),n.ordinalNumber(t,{unit:`hour`})}return Qf.h(e,t)},H:function(e,t,n){return t===`Ho`?n.ordinalNumber(e.getHours(),{unit:`hour`}):Qf.H(e,t)},K:function(e,t,n){let r=e.getHours()%12;return t===`Ko`?n.ordinalNumber(r,{unit:`hour`}):Z(r,t.length)},k:function(e,t,n){let r=e.getHours();return r===0&&(r=24),t===`ko`?n.ordinalNumber(r,{unit:`hour`}):Z(r,t.length)},m:function(e,t,n){return t===`mo`?n.ordinalNumber(e.getMinutes(),{unit:`minute`}):Qf.m(e,t)},s:function(e,t,n){return t===`so`?n.ordinalNumber(e.getSeconds(),{unit:`second`}):Qf.s(e,t)},S:function(e,t){return Qf.S(e,t)},X:function(e,t,n){let r=e.getTimezoneOffset();if(r===0)return`Z`;switch(t){case`X`:return np(r);case`XXXX`:case`XX`:return rp(r);default:return rp(r,`:`)}},x:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`x`:return np(r);case`xxxx`:case`xx`:return rp(r);default:return rp(r,`:`)}},O:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`O`:case`OO`:case`OOO`:return`GMT`+tp(r,`:`);default:return`GMT`+rp(r,`:`)}},z:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`z`:case`zz`:case`zzz`:return`GMT`+tp(r,`:`);default:return`GMT`+rp(r,`:`)}},t:function(e,t,n){return Z(Math.trunc(e/1e3),t.length)},T:function(e,t,n){return Z(+e,t.length)}};function tp(e,t=``){let n=e>0?`-`:`+`,r=Math.abs(e),i=Math.trunc(r/60),a=r%60;return a===0?n+String(i):n+String(i)+t+Z(a,2)}function np(e,t){return e%60==0?(e>0?`-`:`+`)+Z(Math.abs(e)/60,2):rp(e,t)}function rp(e,t=``){let n=e>0?`-`:`+`,r=Math.abs(e),i=Z(Math.trunc(r/60),2),a=Z(r%60,2);return n+i+t+a}var ip=(e,t)=>{switch(e){case`P`:return t.date({width:`short`});case`PP`:return t.date({width:`medium`});case`PPP`:return t.date({width:`long`});default:return t.date({width:`full`})}},ap=(e,t)=>{switch(e){case`p`:return t.time({width:`short`});case`pp`:return t.time({width:`medium`});case`ppp`:return t.time({width:`long`});default:return t.time({width:`full`})}},op={p:ap,P:(e,t)=>{let n=e.match(/(P+)(p+)?/)||[],r=n[1],i=n[2];if(!i)return ip(e,t);let a;switch(r){case`P`:a=t.dateTime({width:`short`});break;case`PP`:a=t.dateTime({width:`medium`});break;case`PPP`:a=t.dateTime({width:`long`});break;default:a=t.dateTime({width:`full`});break}return a.replace(`{{date}}`,ip(r,t)).replace(`{{time}}`,ap(i,t))}},sp=/^D+$/,cp=/^Y+$/,lp=[`D`,`DD`,`YY`,`YYYY`];function up(e){return sp.test(e)}function dp(e){return cp.test(e)}function fp(e,t,n){let r=pp(e,t,n);if(console.warn(r),lp.includes(e))throw RangeError(r)}function pp(e,t,n){let r=e[0]===`Y`?`years`:`days of the month`;return`Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${r} to the input \`${n}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}var mp=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,hp=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,gp=/^'([^]*?)'?$/,_p=/''/g,vp=/[a-zA-Z]/;function yp(e,t,n){let r=Sf(),i=n?.locale??r.locale??Kf,a=n?.firstWeekContainsDate??n?.locale?.options?.firstWeekContainsDate??r.firstWeekContainsDate??r.locale?.options?.firstWeekContainsDate??1,o=n?.weekStartsOn??n?.locale?.options?.weekStartsOn??r.weekStartsOn??r.locale?.options?.weekStartsOn??0,s=yf(e,n?.in);if(!Mf(s))throw RangeError(`Invalid time value`);let c=t.match(hp).map(e=>{let t=e[0];if(t===`p`||t===`P`){let n=op[t];return n(e,i.formatLong)}return e}).join(``).match(mp).map(e=>{if(e===`''`)return{isToken:!1,value:`'`};let t=e[0];if(t===`'`)return{isToken:!1,value:bp(e)};if(ep[t])return{isToken:!0,value:e};if(t.match(vp))throw RangeError("Format string contains an unescaped latin alphabet character `"+t+"`");return{isToken:!1,value:e}});i.localize.preprocessor&&(c=i.localize.preprocessor(s,c));let l={firstWeekContainsDate:a,weekStartsOn:o,locale:i};return c.map(r=>{if(!r.isToken)return r.value;let a=r.value;(!n?.useAdditionalWeekYearTokens&&dp(a)||!n?.useAdditionalDayOfYearTokens&&up(a))&&fp(a,t,String(e));let o=ep[a[0]];return o(s,a,i.localize,l)}).join(``)}function bp(e){let t=e.match(gp);return t?t[1].replace(_p,`'`):e}var xp=`/api/v1/planet-position`,Sp=`planet-position-cache-db`,Cp=`planet_positions`,wp=1,Tp=()=>new Promise((e,t)=>{let n=indexedDB.open(Sp,wp);n.onupgradeneeded=()=>{let e=n.result;e.objectStoreNames.contains(Cp)||e.createObjectStore(Cp,{keyPath:`key`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error)}),Ep=async e=>{try{let t=await Tp(),n=await new Promise((n,r)=>{let i=t.transaction(Cp,`readonly`).objectStore(Cp).get(e);i.onsuccess=()=>n(i.result??null),i.onerror=()=>r(i.error)});return t.close(),n}catch{return null}},Dp=async(e,t)=>{let n={key:e,...t};try{let e=await Tp();await new Promise((t,r)=>{let i=e.transaction(Cp,`readwrite`).objectStore(Cp).put(n);i.onsuccess=()=>t(),i.onerror=()=>r(i.error)}),e.close()}catch{}},Op=async e=>{try{let t=await Tp();await new Promise((n,r)=>{let i=t.transaction(Cp,`readwrite`).objectStore(Cp).delete(e);i.onsuccess=()=>n(),i.onerror=()=>r(i.error)}),t.close()}catch{}},Q={lerpFrame:60,accelerationOrbit:1,accelerationRotation:1,sunIntensity:2.1,isAnimating:!1,showOrbits:!0,showLabels:!0,showPlanets:!0},kp=6.4,Ap=23.4,jp=`Earth`,Mp=16777215,Np=kp/3.7,Pp=27.322,Fp=2e-5,Ip=kp*109/40,Lp=.001,Rp=16775311,zp=16646099,Bp=1.4,Vp=15265791,Hp=8e4,Up=.5,Wp=2.4,Gp=`Mercury`,Kp=39423,qp=6.1,Jp=177.4,Yp=`Venus`,Xp=16766720,Zp=kp*.53,Qp=25.2,$p=`Mars`,em=16729344,tm=kp*11,nm=3.13,rm=`Jupiter`,im=39168,am=kp*9.4,om=26.7,sm=`Saturn`,cm=10053120,lm=kp*4,um=97.8,dm=`Uranus`,fm=6684825,pm=kp*3.9,mm=28.3,hm=`Neptune`,gm=3368703,_m=1,vm=5,ym=30,bm=90,xm=120,Sm=180,Cm=e=>{switch(e){case`JUPITER`:return ym;case`MARS`:return vm;case`SATURN`:return bm;case`URANUS`:return xm;case`NEPTUNE`:return Sm;default:return _m}},wm=e=>`${Cm(e)}days`,Tm=e=>{switch(e){case`EARTH`:return Mp;case`MERCURY`:return Kp;case`VENUS`:return Xp;case`MARS`:return em;case`JUPITER`:return im;case`SATURN`:return cm;case`URANUS`:return fm;case`NEPTUNE`:return gm;default:return Mp}},Em=e=>e*Math.PI/180,Dm=e=>new Promise(t=>setTimeout(t,e)),Om=e=>/^(?:https?:)?\/\//.test(e)||e.startsWith(`data:`)||e.startsWith(`blob:`)?e:`/three-js-mini-solar-system/${e.replace(/^\.?\//,``)}`,km=e=>new Promise((t,n)=>{new Zu().load(Om(e),e=>{t(e.scene)},void 0,e=>{n(e)})}),Am=`https://three-js-mini-solar-system.onrender.com`.replace(/\/+$/,``),jm=`planet-position-cache:v2`,Mm=e=>{if(e.length===0)return e;let t=e[0],n=e[e.length-1];return t.equals(n)?e:[...e,t.clone()]},Nm=(e,t,n,r)=>`${jm}:${e}:${t}:${n}:${r}`,Pm=async e=>{try{let t=await Ep(e);if(!t)return null;if(!Array.isArray(t.pathPoints)||typeof t.todayRow!=`number`)return await Op(e),null;let n=t.pathPoints.map(e=>new U(e.x,e.y,e.z));return{todayRow:t.todayRow,pathPoints:n}}catch{return null}},Fm=async(e,t)=>{await Dp(e,{todayRow:t.todayRow,pathPoints:t.pathPoints.map(e=>({x:e.x,y:e.y,z:e.z}))})},Im=e=>{switch(e){case`EARTH`:return 365;case`MERCURY`:return 88;case`VENUS`:return 225;case`MARS`:return 687;case`JUPITER`:return 4333;case`SATURN`:return 10759;case`URANUS`:return 30687;case`NEPTUNE`:return 60190;default:return 364}},Lm=e=>{switch(e){case`EARTH`:return 1;case`MERCURY`:return 58.6;case`VENUS`:return 243;case`MARS`:return 1.03;case`JUPITER`:return .41;case`SATURN`:return .45;case`URANUS`:return .72;case`NEPTUNE`:return .67;default:return 1}},Rm=async e=>{let t=new Date().getFullYear(),n=new Date(`${t}-01-01`),r=yp(n,`yyyy-MM-dd`),i=yp(bf(n,Im(e)),`yyyy-MM-dd`),a=wm(e),o=Nm(e,r,i,a),s=await Pm(o);if(s)return s;await Dm(50);let c=`${Am}${xp}?START_TIME=${r}&STOP_TIME=${i}&STEP_SIZE=${a}&COMMAND=${e}`,l={todayRow:0,pathPoints:[]};try{let e=await fetch(c);if(!e.ok)throw Error(`HTTP error! status: ${e.status}`);let t=await e.json();if(t.result){let e=t.result.split(`
`).filter(e=>e.includes(`X =`)),n=[];e.forEach((e,t)=>{let r=e.split(/[X,Y,Z, =]/).filter(e=>e.trim()),i=parseFloat(r[0]),a=parseFloat(r[1]),o=parseFloat(r[2]);n.push({x:i,y:a,z:o,day:t+1})}),l.pathPoints=Mm(n.map(e=>new U(e.x*90,e.z*90,e.y*90)).reverse()),l.todayRow=qf(new Date),await Fm(o,l)}else console.error(`データの取得に失敗しました:`,t)}catch(e){console.error(`API呼び出し中にエラーが発生しました:`,e)}finally{return l}},zm=({parent:e,commandKey:t,planetPositionsRes:n,radius:r=1,color:i})=>{let a=new ri(new ha(r,32,32),new Gr({color:i??Tm(t),depthTest:!1,depthWrite:!1}));a.name=`${t}-current-position`,a.renderOrder=999;let{pathPoints:o,todayRow:s}=n,c=o.length-1,l=s-1,u=Cm(t),d=Math.floor(l/u)%c,f=(d+1)%c,p=l%u/u,m=o[d],h=o[f],g=new U().fromArray(m.toArray()).lerp(new U().fromArray(h.toArray()),p);return a.position.copy(g),e.add(a),a},$={PLANET_NAME:`Planet`,PLANET_ORBIT_NAME:`PlanetOrbit`,PLANET_RING_NAME:`PlanetRing`,PLANET_AXIS_NAME:`PlanetAxis`,PLANET_SYSTEM_NAME:`PlanetSystem`,PLANET_ATMO_SPHERE_NAME:`PlanetAtmosphere`,PLANET_MOONS_NAME:`PlanetMoons`,PLANET_LABEL_NAME:`PlanetLabel`},Bm={MERCURY:`Mercury（水星）`,VENUS:`Venus（金星）`,EARTH:`Earth（地球）`,MARS:`Mars（火星）`,JUPITER:`Jupiter（木星）`,SATURN:`Saturn（土星）`,URANUS:`Uranus（天王星）`,NEPTUNE:`Neptune（海王星）`,PLUTO:`Pluto（冥王星）`},Vm=(e,t,n,r,i,a,o,s,c,l,u,d=!1)=>{let f=new so,p;p=a instanceof Ir?a:o?new Oa({map:f.load(Om(a)),bumpMap:f.load(Om(o)),bumpScale:.7}):new Oa({map:f.load(Om(a))});let m=new ri(new ha(n,32,20),p);m.rotation.z=Em(r),m.castShadow=!0,m.receiveShadow=!0,m.name=$.PLANET_NAME;let h=new kn;h.name=$.PLANET_SYSTEM_NAME;let g=u.pathPoints.length-1,_=u.todayRow-1,v=Cm(e),y=Math.floor(_/v)%g,b=(y+1)%g,x=_%v/v,S=u.pathPoints[y],C=u.pathPoints[b],w=new U().fromArray(S.toArray()).lerp(new U().fromArray(C.toArray()),x);h.position.copy(w),h.add(m);let T=document.createElement(`div`);T.className=`planet-name-label`,T.textContent=Bm[e]??t;let E=new of(T);E.name=$.PLANET_LABEL_NAME,E.position.set(0,n+3,0),h.add(E);let D=document.createElement(`div`);D.className=`planet-tilt-label`,D.textContent=`傾き: ${r}°`;let O=new of(D);O.name=$.PLANET_LABEL_NAME,O.position.set(0,-(n+3),0),h.add(O);{let e=.1,t=new ri(new ua(e,e,2.8*n,32),new Gr({color:65280}));t.name=$.PLANET_AXIS_NAME,t.rotation.z=Em(r),h.add(t)}if(s){let e=new ri(new ma(s.innerRadius,s.outerRadius,30),new Ea({map:f.load(Om(s.texture)),side:2}));e.name=$.PLANET_RING_NAME,e.rotation.x=Em(90),e.rotation.y=Em(r),h.add(e);let t=3.6;e.scale.set(t,t,t)}if(c){let e=new ri(new ha(n+.1,32,20),new Oa({map:f.load(Om(c)),transparent:!0,opacity:.4,depthTest:!0,depthWrite:!1}));e.name=$.PLANET_ATMO_SPHERE_NAME,e.rotation.z=.41,m.add(e)}let k=0;for(let e of l){let t;if(e.texture===void 0)continue;t=e.bump?new Ea({map:f.load(Om(e.texture)),bumpMap:f.load(Om(e.bump)),bumpScale:.5}):new Ea({map:f.load(Om(e.texture))});let r=new ri(new ha(e.size,32,20),t);r.name=`${$.PLANET_MOONS_NAME}_${k}`,r.castShadow=!0,r.receiveShadow=!0,k++;let i=n*1.5;r.position.set(i,0,0),h.add(r),e.mesh=r}let A=new kn;A.add(h),A.name=t,A.userData={planetPositionsRes:u};let ee=new Ki(new jr().setFromPoints(u.pathPoints),new Ri({color:i,transparent:!0,opacity:.2}));return ee.name=$.PLANET_ORBIT_NAME,A.add(ee),d&&zm({parent:A,commandKey:e,planetPositionsRes:u}),A},Hm={MOON:`${$.PLANET_MOONS_NAME}_Moon`},Um=[{size:Np,texture:`/images/moonmap.jpg`,bump:`/images/moonbump.jpg`,orbitSpeed:.001*Q.accelerationOrbit,orbitRadius:10,orbitalPeriodDays:27.322}],Wm=async(e,t)=>{let n=new so,r=new wa({uniforms:{dayTexture:{value:n.load(Om(`/images/earth_daymap.jpg`))},nightTexture:{value:n.load(Om(`/images/earth_nightmap.jpg`))},sunPosition:{value:e}},vertexShader:`
        varying vec3 vNormal;
        varying vec2 vUv;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1}),u=e=>{let n=t.domElement.getBoundingClientRect();o.x=(e.clientX-n.left)/n.width*2-1,o.y=-((e.clientY-n.top)/n.height)*2+1},d=(e,t)=>{let n=e.getObjectByName(c);if(t){if(n)return;let t=new ri(e.geometry,l);t.name=c,t.scale.setScalar(1.04),e.add(t);return}n&&e.remove(n)},f=()=>{s&&=(d(s,!1),null)},p=e=>{let t=new U;e.getWorldPosition(t);let i=e.geometry;i.computeBoundingSphere();let a=i.boundingSphere?.radius??1,o=new U;e.getWorldScale(o);let s=a*Math.max(o.x,o.y,o.z)/Math.tan(Em(n.fov)/2)*1.35,c=new U().subVectors(n.position,r.target);c.lengthSq()===0&&c.set(0,0,1),c.normalize(),n.position.copy(t).add(c.multiplyScalar(s)),r.target.copy(t),r.update()};return{handleDoubleClickPlanetZoom:e=>{u(e),a.setFromCamera(o,n);let t=a.intersectObjects(i,!1);if(t.length===0)return;let r=t[0].object;p(r)},handlePlanetHover:e=>{u(e),a.setFromCamera(o,n);let t=a.intersectObjects(i,!1)[0]?.object;if(!(t instanceof ri)){f();return}s!==t&&(f(),s=t,d(t,!0))},clearPlanetHover:f}},Sh={TITAN:`${$.PLANET_MOONS_NAME}_Titan`,RHEA:`${$.PLANET_MOONS_NAME}_Rhea`,IAPETUS:`${$.PLANET_MOONS_NAME}_Iapetus`,MIMAS:`${$.PLANET_MOONS_NAME}_Mimas`,ENCELADUS:`${$.PLANET_MOONS_NAME}_Enceladus`},Ch=[{size:kp*.4,texture:`/images/RS3_Titan.webp`,orbitRadius:16,orbitSpeed:9e-5*Q.accelerationOrbit,orbitalPeriodDays:15.95,xPosition:137},{size:kp*.12,texture:`/images/RS3_Rhea.webp`,orbitRadius:12,orbitSpeed:18e-5*Q.accelerationOrbit,orbitalPeriodDays:4.52,xPosition:116},{size:kp*.115,texture:`/images/LapetusNew.webp`,orbitRadius:22,orbitSpeed:1e-5*Q.accelerationOrbit,orbitalPeriodDays:79.3,xPosition:180},{size:kp*.031,texture:`/images/RS3_Mimas.webp`,orbitRadius:8,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:.942,xPosition:102},{size:kp*.04,texture:`/images/Enceladus.webp`,orbitRadius:10,orbitSpeed:45e-5*Q.accelerationOrbit,orbitalPeriodDays:1.37,xPosition:110}],wh=async e=>{let t=await Rm(`SATURN`),n=Vm(`SATURN`,sm,am,om,Tm(`SATURN`),`/images/saturnmap.jpg`,null,{innerRadius:18,outerRadius:29,texture:`/images/saturn_ring.png`},null,Ch,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Sh.TITAN),e===1&&(t.name=Sh.RHEA),e===2&&(t.name=Sh.IAPETUS),e===3&&(t.name=Sh.MIMAS),e===4&&(t.name=Sh.ENCELADUS),t.position.set(Ch[e].xPosition??0,0,0);return n},Th=`Sun`,Eh=new Ea({emissive:Rp,emissiveMap:new so().load(Om(`/images/sun.jpg`)),emissiveIntensity:Q.sunIntensity}),Dh=()=>{let e=new ri(new ha(Ip,32,20),Eh);e.name=Th;let t=new To(zp,100,0,Bp),n=new To(Vp,20,Hp,Up);return e.add(t),e.add(n),e},Oh={MIRANDA:`${$.PLANET_MOONS_NAME}_Miranda`,ARIEL:`${$.PLANET_MOONS_NAME}_Ariel`,UMBRIEL:`${$.PLANET_MOONS_NAME}_Umbriel`,TITANIA:`${$.PLANET_MOONS_NAME}_Titania`,OBERON:`${$.PLANET_MOONS_NAME}_Oberon`},kh=[{size:kp*.037,texture:`/images/Miranda-0.webp`,orbitRadius:10,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:1.41,xPosition:58},{size:kp*.084,texture:`/images/Ariel-0.webp`,orbitRadius:10,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:2.52,xPosition:90},{size:kp*.07,texture:`/images/Umbriel-0.webp`,orbitRadius:10,orbitSpeed:4e-4*Q.accelerationOrbit,orbitalPeriodDays:4.14,xPosition:120},{size:kp*.11,texture:`/images/Titania-0.webp`,orbitRadius:10,orbitSpeed:3e-4*Q.accelerationOrbit,orbitalPeriodDays:8.71,xPosition:150},{size:kp*.105,texture:`/images/Oberon-0.webp`,orbitRadius:10,orbitSpeed:2e-4*Q.accelerationOrbit,orbitalPeriodDays:13.46,xPosition:180}],Ah=async e=>{let t=await Rm(`URANUS`),n=Vm(`URANUS`,dm,lm,um,Tm(`URANUS`),`/images/uranus.jpg`,null,{innerRadius:8,outerRadius:10,texture:`/images/uranus_ring.png`},null,kh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Oh.MIRANDA),e===1&&(t.name=Oh.ARIEL),e===2&&(t.name=Oh.UMBRIEL),e===3&&(t.name=Oh.TITANIA),e===4&&(t.name=Oh.OBERON),t.position.set(kh[e].xPosition??0,0,0);return n},jh=async e=>{let t=await Rm(`VENUS`);return Vm(`VENUS`,Yp,qp,Jp,Tm(`VENUS`),`/images/venusmap.jpg`,`/images/venusbump.jpg`,null,`/images/venus_atmosphere.png`,[],t,e)};function Mh(e,t,n){let{earthPlanetSystem:r,earthPlanet:i,earthAtmosphere:a,moon:o}=t;{let t=n.pathPoints.length-1,o=e.dayIndex%t,s=n.pathPoints[o],c=(o+1)%t,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Em(360/Q.lerpFrame*Q.accelerationRotation);i.rotateY(u),a.rotateY(u+Fp)}{let t=Em(5),n=Em(360/(Pp*Q.lerpFrame)*Q.accelerationOrbit),r=e.frameCount*n,{orbitRadius:i}=Um[0],a=i*Math.cos(r),s=i*Math.sin(r)*Math.sin(t),c=i*Math.sin(r)*Math.cos(t);o.position.set(-a,s,c);let l=n;o.rotateY(l)}}function Nh(e,t,n){let{mercuryPlanetSystem:r,mercuryPlanet:i}=t,a=n.pathPoints.length-1,o=e.dayIndex%a,s=n.pathPoints[o],c=(o+1)%a,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Em(360/(Q.lerpFrame*Lm(`MERCURY`))*Q.accelerationRotation);i.rotateY(u)}function Ph(e,t,n){let{venusPlanetSystem:r,venusPlanet:i,venusAtmosphere:a}=t,o=n.pathPoints.length-1,s=e.dayIndex%o,c=n.pathPoints[s],l=(s+1)%o,u=n.pathPoints[l];e.buf.copy(c).lerp(u,e.dayFraction),r.position.copy(e.buf);let d=Em(360/(Q.lerpFrame*Lm(`VENUS`))*Q.accelerationRotation);i.rotateY(d),a.rotateY(d*60)}function Fh(e,t,n){let{marsPlanetSystem:r,marsPlanet:i,phobos:a,deimos:o}=t,s=Cm(`MARS`),c=n.pathPoints.length-1,l=e.dayIndex+e.dayFraction,u=Math.floor(l/s)%c,d=n.pathPoints[u],f=(u+1)%c,p=n.pathPoints[f],m=l%s/s;e.buf.copy(d).lerp(p,m),r.position.copy(e.buf);let h=Em(360/(Q.lerpFrame*Lm(`MARS`))*Q.accelerationRotation);i.rotateY(h);let g=hh[0].orbitRadius,_=hh[1].orbitRadius,v=e.frameCount*Q.accelerationOrbit*4,y=e.frameCount*Q.accelerationOrbit*1,b=g*Math.cos(v),x=g*Math.sin(v);a.position.set(-b,0,x);let S=_*Math.cos(y),C=_*Math.sin(y);o.position.set(-S,0,C)}function Ih(e,t,n){let{jupiterPlanetSystem:r,jupiterPlanet:i,io:a,europa:o,ganymede:s,callisto:c}=t,l=Cm(`JUPITER`),u=n.pathPoints.length-1,d=e.dayIndex+e.dayFraction,f=Math.floor(d/l)%u,p=n.pathPoints[f],m=(f+1)%u,h=n.pathPoints[m],g=d%l/l;e.buf.copy(p).lerp(h,g),r.position.copy(e.buf);let _=Em(360/(Q.lerpFrame*Lm(`JUPITER`))*Q.accelerationRotation);i.rotateY(_);{let t=uh[0].orbitRadius+(uh[0].xPosition??0),n=uh[1].orbitRadius+(uh[1].xPosition??0),r=uh[2].orbitRadius+(uh[2].xPosition??0),i=uh[3].orbitRadius+(uh[3].xPosition??0),l=e.frameCount*Q.accelerationOrbit*(1/uh[0].orbitalPeriodDays),u=e.frameCount*Q.accelerationOrbit*(1/uh[1].orbitalPeriodDays),d=e.frameCount*Q.accelerationOrbit*(1/uh[2].orbitalPeriodDays),f=e.frameCount*Q.accelerationOrbit*(1/uh[3].orbitalPeriodDays),p=t*Math.cos(l),m=t*Math.sin(l);a.position.set(-p,0,m);let h=n*Math.cos(u),g=n*Math.sin(u);o.position.set(-h,0,g);let _=r*Math.cos(d),v=r*Math.sin(d);s.position.set(-_,0,v);let y=i*Math.cos(f),b=i*Math.sin(f);c.position.set(-y,0,b)}}function Lh(e,t,n){let{saturnPlanetSystem:r,saturnPlanet:i,titan:a,rhea:o,iapetus:s,mimas:c,enceladus:l}=t,u=Cm(`SATURN`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Em(360/(Q.lerpFrame*Lm(`SATURN`))*Q.accelerationRotation);i.rotateY(v);{let t=Em(om),n=Ch[0].orbitRadius+(Ch[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Ch[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Ch[1].orbitRadius+(Ch[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Ch[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Ch[2].orbitRadius+(Ch[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Ch[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Ch[3].orbitRadius+(Ch[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Ch[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let ee=Ch[4].orbitRadius+(Ch[4].xPosition??0),te=e.frameCount*Q.accelerationOrbit*(1/Ch[4].orbitalPeriodDays),j=-ee*Math.cos(te),ne=ee*Math.sin(te),re=j*Math.cos(t),M=j*Math.sin(t);l.position.set(re,M,ne)}}function Rh(e,t,n){let{uranusPlanetSystem:r,uranusPlanet:i,miranda:a,ariel:o,umbriel:s,titania:c,oberon:l}=t,u=Cm(`URANUS`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Em(360/(Q.lerpFrame*Lm(`URANUS`))*Q.accelerationRotation);i.rotateY(v);{let t=Em(um),n=kh[0].orbitRadius+(kh[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/kh[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=kh[1].orbitRadius+(kh[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/kh[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=kh[2].orbitRadius+(kh[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/kh[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=kh[3].orbitRadius+(kh[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/kh[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let ee=kh[4].orbitRadius+(kh[4].xPosition??0),te=e.frameCount*Q.accelerationOrbit*(1/kh[4].orbitalPeriodDays),j=-ee*Math.cos(te),ne=ee*Math.sin(te),re=j*Math.cos(t),M=j*Math.sin(t);l.position.set(re,M,ne)}}function zh(e,t,n){let{neptunePlanetSystem:r,neptunePlanet:i,triton:a,proteus:o,nereid:s}=t,c=Cm(`NEPTUNE`),l=n.pathPoints.length-1,u=e.dayIndex+e.dayFraction,d=Math.floor(u/c)%l,f=n.pathPoints[d],p=(d+1)%l,m=n.pathPoints[p],h=u%c/c;e.buf.copy(f).lerp(m,h),r.position.copy(e.buf);let g=Em(360/(Q.lerpFrame*Lm(`NEPTUNE`))*Q.accelerationRotation);i.rotateY(g);{let t=Em(mm),n=yh[0].orbitRadius+(yh[0].xPosition??0),r=(yh[0].retrograde?-1:1)*e.frameCount*Q.accelerationOrbit*(1/yh[0].orbitalPeriodDays),i=-n*Math.cos(r),c=n*Math.sin(r),l=i*Math.cos(t),u=i*Math.sin(t);a.position.set(l,u,c);let d=yh[1].orbitRadius+(yh[1].xPosition??0),f=e.frameCount*Q.accelerationOrbit*(1/yh[1].orbitalPeriodDays),p=-d*Math.cos(f),m=d*Math.sin(f),h=p*Math.cos(t),g=p*Math.sin(t);o.position.set(h,g,m);let _=yh[2].orbitRadius+(yh[2].xPosition??0),v=e.frameCount*Q.accelerationOrbit*(1/yh[2].orbitalPeriodDays),y=-_*Math.cos(v),b=_*Math.sin(v),x=y*Math.cos(t),S=y*Math.sin(t);s.position.set(x,S,b)}}var Bh=5e3,Vh=5,Hh=185,Uh=275,Wh=30,Gh=class{permutation;constructor(e){this.permutation=this.generatePermutation(e)}generatePermutation(e){let t=Array.from({length:256},(e,t)=>t);for(let n=255;n>0;n--){let r=this.seededRandom(e+n),i=Math.floor(r*(n+1));[t[n],t[i]]=[t[i],t[n]]}return[...t,...t]}seededRandom(e){let t=Math.sin(e)*1e4;return t-Math.floor(t)}fade(e){return e*e*e*(e*(e*6-15)+10)}lerp(e,t,n){return t+e*(n-t)}grad(e,t,n,r){let i=e&15,a=i<8?t:n,o=i<8?n:r;return(i&1?-a:a)+(i&2?-o:o)}noise(e,t,n){let r=Math.floor(e)&255,i=Math.floor(t)&255,a=Math.floor(n)&255,o=e-Math.floor(e),s=t-Math.floor(t),c=n-Math.floor(n),l=this.fade(o),u=this.fade(s),d=this.fade(c),f=this.permutation,p=f[f[f[r]+i]+a],m=f[f[f[r]+i+1]+a],h=f[f[f[r]+i]+a+1],g=f[f[f[r]+i+1]+a+1],_=f[f[f[r+1]+i]+a],v=f[f[f[r+1]+i+1]+a],y=f[f[f[r+1]+i]+a+1],b=f[f[f[r+1]+i+1]+a+1],x=this.grad(p,o,s,c),S=this.grad(_,o-1,s,c),C=this.grad(m,o,s-1,c),w=this.grad(v,o-1,s-1,c),T=this.grad(h,o,s,c-1),E=this.grad(y,o-1,s,c-1),D=this.grad(g,o,s-1,c-1),O=this.grad(b,o-1,s-1,c-1),k=this.lerp(l,x,S),A=this.lerp(l,C,w),ee=this.lerp(u,k,A),te=this.lerp(l,T,E),j=this.lerp(l,D,O),ne=this.lerp(u,te,j);return this.lerp(d,ee,ne)}fbm(e,t,n,r=4){let i=0,a=1,o=1,s=0;for(let c=0;c<r;c++)i+=a*this.noise(e*o,t*o,n*o),s+=a,a*=.5,o*=2;return i/s}};function Kh(e){let t=new fa(1,4),n=t.getAttribute(`position`),r=n.array,i=new Gh(e);for(let e=0;e<r.length;e+=3){let t=r[e],n=r[e+1],a=r[e+2],o=Math.sqrt(t*t+n*n+a*a),s=t/o,c=n/o,l=a/o,u=i.fbm(t*2,n*2,a*2,3)*.3;r[e]=t+s*u,r[e+1]=n+c*u,r[e+2]=a+l*u}return n.needsUpdate=!0,t.computeVertexNormals(),t}var qh=class{group;instancedMeshes=[];constructor(){this.group=new kn,this.group.name=`AsteroidBelt`,this.initAsteroidBelt()}initAsteroidBelt(){let e=[];for(let t=0;t<Vh;t++)e.push(Kh(t*12345));let t=Math.floor(Bh/Vh);e.forEach((e,n)=>{let r=new ki(e,this.createRockMaterial(n),t);r.castShadow=!0,r.receiveShadow=!0;let i=new K;for(let e=0;e<t;e++){let t=Math.random()*Math.PI*2,n=Hh+Math.random()*(Uh-Hh),a=(Math.random()-.5)*Wh,o=Math.cos(t)*n,s=Math.sin(t)*n,c=a,l=new Nt;l.setFromEuler(new dn(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2));let u=.3+Math.random()*.7,d=u*(.8+Math.random()*.4),f=u*(.8+Math.random()*.4),p=u*(.8+Math.random()*.4);i.compose(new U(o,c,s),l,new U(d,f,p)),r.setMatrixAt(e,i)}r.instanceMatrix.needsUpdate=!0,this.instancedMeshes.push(r),this.group.add(r)})}createRockMaterial(e){let t=[9139029,6908265,8421504,7036244,4868682];return new Ea({color:t[e%t.length],metalness:.3+Math.random()*.2,roughness:.7+Math.random()*.2,emissive:0,emissiveIntensity:0,wireframe:!1})}animate(e=.016){this.instancedMeshes.forEach(t=>{t.rotation.x=0,t.rotation.z=0,t.rotation.y+=e*.015})}getGroup(){return this.group}},Jh=!0,Yh=class{renderer=new bu;scene=new Ln;camera;controls;composer;labelRenderer;zoomablePlanets=[];planetInteractionController;sunMesh;earthGroup;mercuryGroup;venusGroup;marsGroup;jupiterGroup;saturnGroup;uranusGroup;neptuneGroup;asteroidBelt;dayFraction=0;dayIndex=0;labelElement;timer=new Lo;frameCount=0;_cachedMeshes;_interpolatedPos=new U;_prevShowOrbits=Q.showOrbits;_prevShowLabels=Q.showLabels;_prevShowPlanets=Q.showPlanets;constructor(){let{camera:e,controls:t,composer:n,labelRenderer:r}=ah(this.renderer,this.scene,this.width,this.height);this.camera=e,this.controls=t,this.composer=n,this.labelRenderer=r,this.initPlanets()}get userDataEarthPositionRes(){return this.earthGroup.userData.planetPositionsRes}get width(){return window.innerWidth}get height(){return window.innerHeight}async initPlanets(){this.sunMesh=Dh(),this.scene.add(this.sunMesh),this.earthGroup=await Wm(this.sunMesh.position,Jh),this.dayIndex=this.userDataEarthPositionRes.todayRow-1,this.scene.add(this.earthGroup);let[e,t,n,r,i,a,o]=await Promise.all([_h(Jh),jh(Jh),gh(Jh),dh(Jh),wh(Jh),Ah(Jh),bh(Jh)]);this.mercuryGroup=e,this.scene.add(e),this.venusGroup=t,this.scene.add(t),this.marsGroup=n,this.scene.add(n),this.jupiterGroup=r,this.scene.add(r),this.saturnGroup=i,this.scene.add(i),this.uranusGroup=a,this.scene.add(a),this.neptuneGroup=o,this.scene.add(o),this.asteroidBelt=new qh,this.scene.add(this.asteroidBelt.getGroup()),this.initDoubleClickZoom(),this.labelElement=ph(this.dayIndex),document.body.appendChild(this.labelElement),ch({sunMesh:this.sunMesh,camera:this.camera,controls:this.controls,getCurrentIndex:()=>this.dayIndex,setDayIndex:e=>{this.dayIndex=e},setDayFraction:e=>{this.dayFraction=e},setFrameCount:e=>{this.frameCount=e},userDataEarthPositionRes:this.userDataEarthPositionRes}),this._initMeshCache(),this.render()}_initMeshCache(){this._cachedMeshes={earthPlanetSystem:this.earthGroup.getObjectByName($.PLANET_SYSTEM_NAME),earthPlanet:this.earthGroup.getObjectByName($.PLANET_NAME),earthAtmosphere:this.earthGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),moon:this.earthGroup.getObjectByName(Hm.MOON),mercuryPlanetSystem:this.mercuryGroup.getObjectByName($.PLANET_SYSTEM_NAME),mercuryPlanet:this.mercuryGroup.getObjectByName($.PLANET_NAME),venusPlanetSystem:this.venusGroup.getObjectByName($.PLANET_SYSTEM_NAME),venusPlanet:this.venusGroup.getObjectByName($.PLANET_NAME),venusAtmosphere:this.venusGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),marsPlanetSystem:this.marsGroup.getObjectByName($.PLANET_SYSTEM_NAME),marsPlanet:this.marsGroup.getObjectByName($.PLANET_NAME),phobos:this.marsGroup.getObjectByName(mh.PHOBOS),deimos:this.marsGroup.getObjectByName(mh.DEIMOS),jupiterPlanetSystem:this.jupiterGroup.getObjectByName($.PLANET_SYSTEM_NAME),jupiterPlanet:this.jupiterGroup.getObjectByName($.PLANET_NAME),io:this.jupiterGroup.getObjectByName(lh.IO),europa:this.jupiterGroup.getObjectByName(lh.EUROPA),ganymede:this.jupiterGroup.getObjectByName(lh.GANYMEDE),callisto:this.jupiterGroup.getObjectByName(lh.CALLISTO),saturnPlanetSystem:this.saturnGroup.getObjectByName($.PLANET_SYSTEM_NAME),saturnPlanet:this.saturnGroup.getObjectByName($.PLANET_NAME),titan:this.saturnGroup.getObjectByName(Sh.TITAN),rhea:this.saturnGroup.getObjectByName(Sh.RHEA),iapetus:this.saturnGroup.getObjectByName(Sh.IAPETUS),mimas:this.saturnGroup.getObjectByName(Sh.MIMAS),enceladus:this.saturnGroup.getObjectByName(Sh.ENCELADUS),uranusPlanetSystem:this.uranusGroup.getObjectByName($.PLANET_SYSTEM_NAME),uranusPlanet:this.uranusGroup.getObjectByName($.PLANET_NAME),miranda:this.uranusGroup.getObjectByName(Oh.MIRANDA),ariel:this.uranusGroup.getObjectByName(Oh.ARIEL),umbriel:this.uranusGroup.getObjectByName(Oh.UMBRIEL),titania:this.uranusGroup.getObjectByName(Oh.TITANIA),oberon:this.uranusGroup.getObjectByName(Oh.OBERON),neptunePlanetSystem:this.neptuneGroup.getObjectByName($.PLANET_SYSTEM_NAME),neptunePlanet:this.neptuneGroup.getObjectByName($.PLANET_NAME),triton:this.neptuneGroup.getObjectByName(vh.TRITON),proteus:this.neptuneGroup.getObjectByName(vh.PROTEUS),nereid:this.neptuneGroup.getObjectByName(vh.NEREID)}}initDoubleClickZoom(){let e=this.earthGroup.getObjectByName($.PLANET_NAME),t=this.mercuryGroup.getObjectByName($.PLANET_NAME),n=this.venusGroup.getObjectByName($.PLANET_NAME),r=this.marsGroup.getObjectByName($.PLANET_NAME),i=this.jupiterGroup.getObjectByName($.PLANET_NAME),a=this.saturnGroup.getObjectByName($.PLANET_NAME),o=this.uranusGroup.getObjectByName($.PLANET_NAME),s=this.neptuneGroup.getObjectByName($.PLANET_NAME);this.zoomablePlanets=[e,t,n,r,i,a,o,s].filter(e=>e instanceof ri),this.planetInteractionController=xh({renderer:this.renderer,camera:this.camera,controls:this.controls,planets:this.zoomablePlanets}),this.renderer.domElement.addEventListener(`dblclick`,this.planetInteractionController.handleDoubleClickPlanetZoom),this.renderer.domElement.addEventListener(`pointermove`,this.planetInteractionController.handlePlanetHover),this.renderer.domElement.addEventListener(`pointerleave`,this.planetInteractionController.clearPlanetHover)}render(){this.renderer.render(this.scene,this.camera),this.controls.update(),this.composer.render(),this.labelRenderer.render(this.scene,this.camera),this.renderer.setAnimationLoop(()=>this.render()),Q.isAnimating&&this.animate(),this.#e()}#e(){(Q.showOrbits!==this._prevShowOrbits||Q.showLabels!==this._prevShowLabels||Q.showPlanets!==this._prevShowPlanets)&&(this._prevShowOrbits=Q.showOrbits,this._prevShowLabels=Q.showLabels,this._prevShowPlanets=Q.showPlanets,[this.earthGroup,this.mercuryGroup,this.venusGroup,this.marsGroup,this.jupiterGroup,this.saturnGroup,this.uranusGroup,this.neptuneGroup].forEach(e=>{let t=e.getObjectByName($.PLANET_ORBIT_NAME);t&&(t.visible=Q.showOrbits),e.traverse(e=>{(e.name===$.PLANET_NAME||e.name===$.PLANET_RING_NAME||e.name===$.PLANET_AXIS_NAME||e.name===$.PLANET_ATMO_SPHERE_NAME||e.name.startsWith($.PLANET_MOONS_NAME)||e.name.endsWith(`-current-position`))&&(e.visible=Q.showPlanets),e.name===$.PLANET_LABEL_NAME&&(e.visible=Q.showLabels)})}))}animate(){this.frameCount++,this.sunMesh.rotateY(Lp*Q.accelerationRotation),this.labelElement.innerText=fh(this.dayIndex),this.dayFraction=Number(((this.dayFraction+1/Q.lerpFrame)*Q.accelerationOrbit).toFixed(3)),this.dayFraction>=1&&(this.dayIndex+=1,this.dayFraction=0);let e={dayIndex:this.dayIndex,dayFraction:this.dayFraction,frameCount:this.frameCount,buf:this._interpolatedPos};Mh(e,this._cachedMeshes,this.userDataEarthPositionRes),Nh(e,this._cachedMeshes,this.mercuryGroup.userData.planetPositionsRes),Ph(e,this._cachedMeshes,this.venusGroup.userData.planetPositionsRes),Fh(e,this._cachedMeshes,this.marsGroup.userData.planetPositionsRes),Ih(e,this._cachedMeshes,this.jupiterGroup.userData.planetPositionsRes),Lh(e,this._cachedMeshes,this.saturnGroup.userData.planetPositionsRes),Rh(e,this._cachedMeshes,this.uranusGroup.userData.planetPositionsRes),zh(e,this._cachedMeshes,this.neptuneGroup.userData.planetPositionsRes),this.asteroidBelt.animate(.016)}};window.addEventListener(`DOMContentLoaded`,()=>{new Yh});