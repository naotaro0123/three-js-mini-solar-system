...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function As(e,t,n){let r=new Float32Array(gs),i=new U(0,1,0);return new Ca({name:`SphericalGaussianBlur`,defines:{n:gs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function js(){return new Ca({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ms(){return new Ca({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ns(),fragmentShader:`
	...
	`}var Ps=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`})}_getEdgeDetectionMaterial(){return new Ca({uniforms:{maskTexture:{value:null},texSize:{value:new H(.5,.5)},visibleEdgeColor:{value:new U(1,1,1)},hiddenEdgeColor:{value:new U(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getSeparableBlurMaterial(e){return new Ca({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new H(.5,.5)},direction:{value:new H(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
				...
				}`,blending:2,depthTest:!1,depthWrite:!1,transparent:!0})}};of.BlurDirectionX=new H(1,0),of.BlurDirectionY=new H(0,1);var sf=class extends Ju{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new q}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},cf={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new q(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};lf.BlurDirectionX=new H(1,0),lf.BlurDirectionY=new H(0,1);var uf=class extends Dn{constructor(e=document.createElement(`div`)){super(),this.isCSS2DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.center=new H(.5,.5),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element&&e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this.center=e.center,this}},df=new U,ff=new K,pf=new K,mf=new U,hf=new U,gf=class{constructor(e={}){let t=this,n,r,i,a,o={objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s,this.sortObjects=!0,this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ff.copy(t.matrixWorldInverse),pf.multiplyMatrices(t.projectionMatrix,ff),l(e,e,t),this.sortObjects&&f(e)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`};function c(e){e.isCSS2DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)c(e.children[t])}function l(e,n,r){if(e.visible===!1){c(e);return}if(e.isCSS2DObject){df.setFromMatrixPosition(e.matrixWorld),df.applyMatrix4(pf);let c=df.z>=-1&&df.z<=1&&e.layers.test(r.layers)===!0,l=e.element;l.style.display=c===!0?``:`none`,c===!0&&(e.onBeforeRender(t,n,r),l.style.transform=`translate(`+-100*e.center.x+`%,`+-100*e.center.y+`%)translate(`+(df.x*i+i)+`px,`+(-df.y*a+a)+`px)`,l.parentNode!==s&&s.appendChild(l),e.onAfterRender(t,n,r));let d={distanceToCameraSquared:u(r,e)};o.objects.set(e,d)}for(let t=0,i=e.children.length;t<i;t++)l(e.children[t],n,r)}function u(e,t){return mf.setFromMatrixPosition(e.matrixWorld),hf.setFromMatrixPosition(t.matrixWorld),mf.distanceToSquared(hf)}function d(e){let t=[];return e.traverseVisible(function(e){e.isCSS2DObject&&t.push(e)}),t}function f(e){let t=d(e).sort(function(e,t){return e.renderOrder===t.renderOrder?o.objects.get(e).distanceToCameraSquared-o.objects.get(t).distanceToCameraSquared:t.renderOrder-e.renderOrder}),n=t.length;for(let e=0,r=t.length;e<r;e++)t[e].element.style.zIndex=n-e}}},_f=365.2425,vf=6048e5,yf=864e5,bf=3600*24;bf*7,bf*_f/12*3;var xf=Symbol.for(`constructDateFrom`);function Sf(e,t){return typeof e==`function`?e(t):e&&typeof e==`object`&&xf in e?e[xf](t):e instanceof Date?new e.constructor(t):new Date(t)}function Cf(e,t){return Sf(t||e,e)}function wf(e,t,n){let r=Cf(e,n?.in);return isNaN(t)?Sf(n?.in||e,NaN):(t&&r.setDate(r.getDate()+t),r)}var Tf={};function Ef(){return Tf}function Df(e,t){let n=Ef(),r=t?.weekStartsOn??t?.locale?.options?.weekStartsOn??n.weekStartsOn??n.locale?.options?.weekStartsOn??0,i=Cf(e,t?.in),a=i.getDay(),o=(a<r?7:0)+a-r;return i.setDate(i.getDate()-o),i.setHours(0,0,0,0),i}function Of(e,t){return Df(e,{...t,weekStartsOn:1})}function kf(e,t){let n=Cf(e,t?.in),r=n.getFullYear(),i=Sf(n,0);i.setFullYear(r+1,0,4),i.setHours(0,0,0,0);let a=Of(i),o=Sf(n,0);o.setFullYear(r,0,4),o.setHours(0,0,0,0);let s=Of(o);return n.getTime()>=a.getTime()?r+1:n.getTime()>=s.getTime()?r:r-1}function Af(e){let t=Cf(e),n=new Date(Date.UTC(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds(),t.getMilliseconds()));return n.setUTCFullYear(t.getFullYear()),e-+n}function jf(e,...t){let n=Sf.bind(null,e||t.find(e=>typeof e==`object`));return t.map(n)}function Mf(e,t){let n=Cf(e,t?.in);return n.setHours(0,0,0,0),n}function Nf(e,t,n){let[r,i]=jf(n?.in,e,t),a=Mf(r),o=Mf(i),s=+a-Af(a),c=+o-Af(o);return Math.round((s-c)/yf)}function Pf(e,t){let n=kf(e,t),r=Sf(t?.in||e,0);return r.setFullYear(n,0,4),r.setHours(0,0,0,0),Of(r)}function Ff(e){return e instanceof Date||typeof e==`object`&&Object.prototype.toString.call(e)===`[object Date]`}function If(e){return!(!Ff(e)&&typeof e!=`number`||isNaN(+Cf(e)))}function Lf(e,t){let n=Cf(e,t?.in);return n.setFullYear(n.getFullYear(),0,1),n.setHours(0,0,0,0),n}var Rf={lessThanXSeconds:{one:`less than a second`,other:`less than {{count}} seconds`},xSeconds:{one:`1 second`,other:`{{count}} seconds`},halfAMinute:`half a minute`,lessThanXMinutes:{one:`less than a minute`,other:`less than {{count}} minutes`},xMinutes:{one:`1 minute`,other:`{{count}} minutes`},aboutXHours:{one:`about 1 hour`,other:`about {{count}} hours`},xHours:{one:`1 hour`,other:`{{count}} hours`},xDays:{one:`1 day`,other:`{{count}} days`},aboutXWeeks:{one:`about 1 week`,other:`about {{count}} weeks`},xWeeks:{one:`1 week`,other:`{{count}} weeks`},aboutXMonths:{one:`about 1 month`,other:`about {{count}} months`},xMonths:{one:`1 month`,other:`{{count}} months`},aboutXYears:{one:`about 1 year`,other:`about {{count}} years`},xYears:{one:`1 year`,other:`{{count}} years`},overXYears:{one:`over 1 year`,other:`over {{count}} years`},almostXYears:{one:`almost 1 year`,other:`almost {{count}} years`}},zf=(e,t,n)=>{let r,i=Rf[e];return r=typeof i==`string`?i:t===1?i.one:i.other.replace(`{{count}}`,t.toString()),n?.addSuffix?n.comparison&&n.comparison>0?`in `+r:r+` ago`:r};function Bf(e){return(t={})=>{let n=t.width?String(t.width):e.defaultWidth;return e.formats[n]||e.formats[e.defaultWidth]}}var Vf={date:Bf({formats:{full:`EEEE, MMMM do, y`,long:`MMMM do, y`,medium:`MMM d, y`,short:`MM/dd/yyyy`},defaultWidth:`full`}),time:Bf({formats:{full:`h:mm:ss a zzzz`,long:`h:mm:ss a z`,medium:`h:mm:ss a`,short:`h:mm a`},defaultWidth:`full`}),dateTime:Bf({formats:{full:`{{date}} 'at' {{time}}`,long:`{{date}} 'at' {{time}}`,medium:`{{date}}, {{time}}`,short:`{{date}}, {{time}}`},defaultWidth:`full`})},Hf={lastWeek:`'last' eeee 'at' p`,yesterday:`'yesterday at' p`,today:`'today at' p`,tomorrow:`'tomorrow at' p`,nextWeek:`eeee 'at' p`,other:`P`},Uf=(e,t,n,r)=>Hf[e];function Wf(e){return(t,n)=>{let r=n?.context?String(n.context):`standalone`,i;if(r===`formatting`&&e.formattingValues){let t=e.defaultFormattingWidth||e.defaultWidth,r=n?.width?String(n.width):t;i=e.formattingValues[r]||e.formattingValues[t]}else{let t=e.defaultWidth,r=n?.width?String(n.width):e.defaultWidth;i=e.values[r]||e.values[t]}let a=e.argumentCallback?e.argumentCallback(t):t;return i[a]}}var Gf={ordinalNumber:(e,t)=>{let n=Number(e),r=n%100;if(r>20||r<10)switch(r%10){case 1:return n+`st`;case 2:return n+`nd`;case 3:return n+`rd`}return n+`th`},era:Wf({values:{narrow:[`B`,`A`],abbreviated:[`BC`,`AD`],wide:[`Before Christ`,`Anno Domini`]},defaultWidth:`wide`}),quarter:Wf({values:{narrow:[`1`,`2`,`3`,`4`],abbreviated:[`Q1`,`Q2`,`Q3`,`Q4`],wide:[`1st quarter`,`2nd quarter`,`3rd quarter`,`4th quarter`]},defaultWidth:`wide`,argumentCallback:e=>e-1}),month:Wf({values:{narrow:[`J`,`F`,`M`,`A`,`M`,`J`,`J`,`A`,`S`,`O`,`N`,`D`],abbreviated:[`Jan`,`Feb`,`Mar`,`Apr`,`May`,`Jun`,`Jul`,`Aug`,`Sep`,`Oct`,`Nov`,`Dec`],wide:[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`]},defaultWidth:`wide`}),day:Wf({values:{narrow:[`S`,`M`,`T`,`W`,`T`,`F`,`S`],short:[`Su`,`Mo`,`Tu`,`We`,`Th`,`Fr`,`Sa`],abbreviated:[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`],wide:[`Sunday`,`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`]},defaultWidth:`wide`}),dayPeriod:Wf({values:{narrow:{am:`a`,pm:`p`,midnight:`mi`,noon:`n`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},abbreviated:{am:`AM`,pm:`PM`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},wide:{am:`a.m.`,pm:`p.m.`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`}},defaultWidth:`wide`,formattingValues:{narrow:{am:`a`,pm:`p`,midnight:`mi`,noon:`n`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`},abbreviated:{am:`AM`,pm:`PM`,midnight:`midnight`,noon:`noon`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`},wide:{am:`a.m.`,pm:`p.m.`,midnight:`midnight`,noon:`noon`,morning:`in the morning`,afternoon:`in the afternoon`,evening:`in the evening`,night:`at night`}},defaultFormattingWidth:`wide`})};function Kf(e){return(t,n={})=>{let r=n.width,i=r&&e.matchPatterns[r]||e.matchPatterns[e.defaultMatchWidth],a=t.match(i);if(!a)return null;let o=a[0],s=r&&e.parsePatterns[r]||e.parsePatterns[e.defaultParseWidth],c=Array.isArray(s)?Jf(s,e=>e.test(o)):qf(s,e=>e.test(o)),l;l=e.valueCallback?e.valueCallback(c):c,l=n.valueCallback?n.valueCallback(l):l;let u=t.slice(o.length);return{value:l,rest:u}}}function qf(e,t){for(let n in e)if(Object.prototype.hasOwnProperty.call(e,n)&&t(e[n]))return n}function Jf(e,t){for(let n=0;n<e.length;n++)if(t(e[n]))return n}function Yf(e){return(t,n={})=>{let r=t.match(e.matchPattern);if(!r)return null;let i=r[0],a=t.match(e.parsePattern);if(!a)return null;let o=e.valueCallback?e.valueCallback(a[0]):a[0];o=n.valueCallback?n.valueCallback(o):o;let s=t.slice(i.length);return{value:o,rest:s}}}var Xf={code:`en-US`,formatDistance:zf,formatLong:Vf,formatRelative:Uf,localize:Gf,match:{ordinalNumber:Yf({matchPattern:/^(\d+)(th|st|nd|rd)?/i,parsePattern:/\d+/i,valueCallback:e=>parseInt(e,10)}),era:Kf({matchPatterns:{narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},defaultMatchWidth:`wide`,parsePatterns:{any:[/^b/i,/^(a|c)/i]},defaultParseWidth:`any`}),quarter:Kf({matchPatterns:{narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},defaultMatchWidth:`wide`,parsePatterns:{any:[/1/i,/2/i,/3/i,/4/i]},defaultParseWidth:`any`,valueCallback:e=>e+1}),month:Kf({matchPatterns:{narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},defaultMatchWidth:`wide`,parsePatterns:{narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},defaultParseWidth:`any`}),day:Kf({matchPatterns:{narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},defaultMatchWidth:`wide`,parsePatterns:{narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},defaultParseWidth:`any`}),dayPeriod:Kf({matchPatterns:{narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},defaultMatchWidth:`any`,parsePatterns:{any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},defaultParseWidth:`any`})},options:{weekStartsOn:0,firstWeekContainsDate:1}};function Zf(e,t){let n=Cf(e,t?.in);return Nf(n,Lf(n))+1}function Qf(e,t){let n=Cf(e,t?.in),r=Of(n)-+Pf(n);return Math.round(r/vf)+1}function $f(e,t){let n=Cf(e,t?.in),r=n.getFullYear(),i=Ef(),a=t?.firstWeekContainsDate??t?.locale?.options?.firstWeekContainsDate??i.firstWeekContainsDate??i.locale?.options?.firstWeekContainsDate??1,o=Sf(t?.in||e,0);o.setFullYear(r+1,0,a),o.setHours(0,0,0,0);let s=Df(o,t),c=Sf(t?.in||e,0);c.setFullYear(r,0,a),c.setHours(0,0,0,0);let l=Df(c,t);return+n>=+s?r+1:+n>=+l?r:r-1}function ep(e,t){let n=Ef(),r=t?.firstWeekContainsDate??t?.locale?.options?.firstWeekContainsDate??n.firstWeekContainsDate??n.locale?.options?.firstWeekContainsDate??1,i=$f(e,t),a=Sf(t?.in||e,0);return a.setFullYear(i,0,r),a.setHours(0,0,0,0),Df(a,t)}function tp(e,t){let n=Cf(e,t?.in),r=Df(n,t)-+ep(n,t);return Math.round(r/vf)+1}function np(e,t){return(e<0?`-`:``)+Math.abs(e).toString().padStart(t,`0`)}var rp={y(e,t){let n=e.getFullYear(),r=n>0?n:1-n;return np(t===`yy`?r%100:r,t.length)},M(e,t){let n=e.getMonth();return t===`M`?String(n+1):np(n+1,2)},d(e,t){return np(e.getDate(),t.length)},a(e,t){let n=e.getHours()/12>=1?`pm`:`am`;switch(t){case`a`:case`aa`:return n.toUpperCase();case`aaa`:return n;case`aaaaa`:return n[0];default:return n===`am`?`a.m.`:`p.m.`}},h(e,t){return np(e.getHours()%12||12,t.length)},H(e,t){return np(e.getHours(),t.length)},m(e,t){return np(e.getMinutes(),t.length)},s(e,t){return np(e.getSeconds(),t.length)},S(e,t){let n=t.length,r=e.getMilliseconds();return np(Math.trunc(r*10**(n-3)),t.length)}},ip={am:`am`,pm:`pm`,midnight:`midnight`,noon:`noon`,morning:`morning`,afternoon:`afternoon`,evening:`evening`,night:`night`},ap={G:function(e,t,n){let r=+(e.getFullYear()>0);switch(t){case`G`:case`GG`:case`GGG`:return n.era(r,{width:`abbreviated`});case`GGGGG`:return n.era(r,{width:`narrow`});default:return n.era(r,{width:`wide`})}},y:function(e,t,n){if(t===`yo`){let t=e.getFullYear(),r=t>0?t:1-t;return n.ordinalNumber(r,{unit:`year`})}return rp.y(e,t)},Y:function(e,t,n,r){let i=$f(e,r),a=i>0?i:1-i;return t===`YY`?np(a%100,2):t===`Yo`?n.ordinalNumber(a,{unit:`year`}):np(a,t.length)},R:function(e,t){return np(kf(e),t.length)},u:function(e,t){return np(e.getFullYear(),t.length)},Q:function(e,t,n){let r=Math.ceil((e.getMonth()+1)/3);switch(t){case`Q`:return String(r);case`QQ`:return np(r,2);case`Qo`:return n.ordinalNumber(r,{unit:`quarter`});case`QQQ`:return n.quarter(r,{width:`abbreviated`,context:`formatting`});case`QQQQQ`:return n.quarter(r,{width:`narrow`,context:`formatting`});default:return n.quarter(r,{width:`wide`,context:`formatting`})}},q:function(e,t,n){let r=Math.ceil((e.getMonth()+1)/3);switch(t){case`q`:return String(r);case`qq`:return np(r,2);case`qo`:return n.ordinalNumber(r,{unit:`quarter`});case`qqq`:return n.quarter(r,{width:`abbreviated`,context:`standalone`});case`qqqqq`:return n.quarter(r,{width:`narrow`,context:`standalone`});default:return n.quarter(r,{width:`wide`,context:`standalone`})}},M:function(e,t,n){let r=e.getMonth();switch(t){case`M`:case`MM`:return rp.M(e,t);case`Mo`:return n.ordinalNumber(r+1,{unit:`month`});case`MMM`:return n.month(r,{width:`abbreviated`,context:`formatting`});case`MMMMM`:return n.month(r,{width:`narrow`,context:`formatting`});default:return n.month(r,{width:`wide`,context:`formatting`})}},L:function(e,t,n){let r=e.getMonth();switch(t){case`L`:return String(r+1);case`LL`:return np(r+1,2);case`Lo`:return n.ordinalNumber(r+1,{unit:`month`});case`LLL`:return n.month(r,{width:`abbreviated`,context:`standalone`});case`LLLLL`:return n.month(r,{width:`narrow`,context:`standalone`});default:return n.month(r,{width:`wide`,context:`standalone`})}},w:function(e,t,n,r){let i=tp(e,r);return t===`wo`?n.ordinalNumber(i,{unit:`week`}):np(i,t.length)},I:function(e,t,n){let r=Qf(e);return t===`Io`?n.ordinalNumber(r,{unit:`week`}):np(r,t.length)},d:function(e,t,n){return t===`do`?n.ordinalNumber(e.getDate(),{unit:`date`}):rp.d(e,t)},D:function(e,t,n){let r=Zf(e);return t===`Do`?n.ordinalNumber(r,{unit:`dayOfYear`}):np(r,t.length)},E:function(e,t,n){let r=e.getDay();switch(t){case`E`:case`EE`:case`EEE`:return n.day(r,{width:`abbreviated`,context:`formatting`});case`EEEEE`:return n.day(r,{width:`narrow`,context:`formatting`});case`EEEEEE`:return n.day(r,{width:`short`,context:`formatting`});default:return n.day(r,{width:`wide`,context:`formatting`})}},e:function(e,t,n,r){let i=e.getDay(),a=(i-r.weekStartsOn+8)%7||7;switch(t){case`e`:return String(a);case`ee`:return np(a,2);case`eo`:return n.ordinalNumber(a,{unit:`day`});case`eee`:return n.day(i,{width:`abbreviated`,context:`formatting`});case`eeeee`:return n.day(i,{width:`narrow`,context:`formatting`});case`eeeeee`:return n.day(i,{width:`short`,context:`formatting`});default:return n.day(i,{width:`wide`,context:`formatting`})}},c:function(e,t,n,r){let i=e.getDay(),a=(i-r.weekStartsOn+8)%7||7;switch(t){case`c`:return String(a);case`cc`:return np(a,t.length);case`co`:return n.ordinalNumber(a,{unit:`day`});case`ccc`:return n.day(i,{width:`abbreviated`,context:`standalone`});case`ccccc`:return n.day(i,{width:`narrow`,context:`standalone`});case`cccccc`:return n.day(i,{width:`short`,context:`standalone`});default:return n.day(i,{width:`wide`,context:`standalone`})}},i:function(e,t,n){let r=e.getDay(),i=r===0?7:r;switch(t){case`i`:return String(i);case`ii`:return np(i,t.length);case`io`:return n.ordinalNumber(i,{unit:`day`});case`iii`:return n.day(r,{width:`abbreviated`,context:`formatting`});case`iiiii`:return n.day(r,{width:`narrow`,context:`formatting`});case`iiiiii`:return n.day(r,{width:`short`,context:`formatting`});default:return n.day(r,{width:`wide`,context:`formatting`})}},a:function(e,t,n){let r=e.getHours()/12>=1?`pm`:`am`;switch(t){case`a`:case`aa`:return n.dayPeriod(r,{width:`abbreviated`,context:`formatting`});case`aaa`:return n.dayPeriod(r,{width:`abbreviated`,context:`formatting`}).toLowerCase();case`aaaaa`:return n.dayPeriod(r,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(r,{width:`wide`,context:`formatting`})}},b:function(e,t,n){let r=e.getHours(),i;switch(i=r===12?ip.noon:r===0?ip.midnight:r/12>=1?`pm`:`am`,t){case`b`:case`bb`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`});case`bbb`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`}).toLowerCase();case`bbbbb`:return n.dayPeriod(i,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(i,{width:`wide`,context:`formatting`})}},B:function(e,t,n){let r=e.getHours(),i;switch(i=r>=17?ip.evening:r>=12?ip.afternoon:r>=4?ip.morning:ip.night,t){case`B`:case`BB`:case`BBB`:return n.dayPeriod(i,{width:`abbreviated`,context:`formatting`});case`BBBBB`:return n.dayPeriod(i,{width:`narrow`,context:`formatting`});default:return n.dayPeriod(i,{width:`wide`,context:`formatting`})}},h:function(e,t,n){if(t===`ho`){let t=e.getHours()%12;return t===0&&(t=12),n.ordinalNumber(t,{unit:`hour`})}return rp.h(e,t)},H:function(e,t,n){return t===`Ho`?n.ordinalNumber(e.getHours(),{unit:`hour`}):rp.H(e,t)},K:function(e,t,n){let r=e.getHours()%12;return t===`Ko`?n.ordinalNumber(r,{unit:`hour`}):np(r,t.length)},k:function(e,t,n){let r=e.getHours();return r===0&&(r=24),t===`ko`?n.ordinalNumber(r,{unit:`hour`}):np(r,t.length)},m:function(e,t,n){return t===`mo`?n.ordinalNumber(e.getMinutes(),{unit:`minute`}):rp.m(e,t)},s:function(e,t,n){return t===`so`?n.ordinalNumber(e.getSeconds(),{unit:`second`}):rp.s(e,t)},S:function(e,t){return rp.S(e,t)},X:function(e,t,n){let r=e.getTimezoneOffset();if(r===0)return`Z`;switch(t){case`X`:return sp(r);case`XXXX`:case`XX`:return cp(r);default:return cp(r,`:`)}},x:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`x`:return sp(r);case`xxxx`:case`xx`:return cp(r);default:return cp(r,`:`)}},O:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`O`:case`OO`:case`OOO`:return`GMT`+op(r,`:`);default:return`GMT`+cp(r,`:`)}},z:function(e,t,n){let r=e.getTimezoneOffset();switch(t){case`z`:case`zz`:case`zzz`:return`GMT`+op(r,`:`);default:return`GMT`+cp(r,`:`)}},t:function(e,t,n){return np(Math.trunc(e/1e3),t.length)},T:function(e,t,n){return np(+e,t.length)}};function op(e,t=``){let n=e>0?`-`:`+`,r=Math.abs(e),i=Math.trunc(r/60),a=r%60;return a===0?n+String(i):n+String(i)+t+np(a,2)}function sp(e,t){return e%60==0?(e>0?`-`:`+`)+np(Math.abs(e)/60,2):cp(e,t)}function cp(e,t=``){let n=e>0?`-`:`+`,r=Math.abs(e),i=np(Math.trunc(r/60),2),a=np(r%60,2);return n+i+t+a}var lp=(e,t)=>{switch(e){case`P`:return t.date({width:`short`});case`PP`:return t.date({width:`medium`});case`PPP`:return t.date({width:`long`});default:return t.date({width:`full`})}},up=(e,t)=>{switch(e){case`p`:return t.time({width:`short`});case`pp`:return t.time({width:`medium`});case`ppp`:return t.time({width:`long`});default:return t.time({width:`full`})}},dp={p:up,P:(e,t)=>{let n=e.match(/(P+)(p+)?/)||[],r=n[1],i=n[2];if(!i)return lp(e,t);let a;switch(r){case`P`:a=t.dateTime({width:`short`});break;case`PP`:a=t.dateTime({width:`medium`});break;case`PPP`:a=t.dateTime({width:`long`});break;default:a=t.dateTime({width:`full`});break}return a.replace(`{{date}}`,lp(r,t)).replace(`{{time}}`,up(i,t))}},fp=/^D+$/,pp=/^Y+$/,mp=[`D`,`DD`,`YY`,`YYYY`];function hp(e){return fp.test(e)}function gp(e){return pp.test(e)}function _p(e,t,n){let r=vp(e,t,n);if(console.warn(r),mp.includes(e))throw RangeError(r)}function vp(e,t,n){let r=e[0]===`Y`?`years`:`days of the month`;return`Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${r} to the input \`${n}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}var yp=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,bp=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,xp=/^'([^]*?)'?$/,Sp=/''/g,Cp=/[a-zA-Z]/;function wp(e,t,n){let r=Ef(),i=n?.locale??r.locale??Xf,a=n?.firstWeekContainsDate??n?.locale?.options?.firstWeekContainsDate??r.firstWeekContainsDate??r.locale?.options?.firstWeekContainsDate??1,o=n?.weekStartsOn??n?.locale?.options?.weekStartsOn??r.weekStartsOn??r.locale?.options?.weekStartsOn??0,s=Cf(e,n?.in);if(!If(s))throw RangeError(`Invalid time value`);let c=t.match(bp).map(e=>{let t=e[0];if(t===`p`||t===`P`){let n=dp[t];return n(e,i.formatLong)}return e}).join(``).match(yp).map(e=>{if(e===`''`)return{isToken:!1,value:`'`};let t=e[0];if(t===`'`)return{isToken:!1,value:Tp(e)};if(ap[t])return{isToken:!0,value:e};if(t.match(Cp))throw RangeError("Format string contains an unescaped latin alphabet character `"+t+"`");return{isToken:!1,value:e}});i.localize.preprocessor&&(c=i.localize.preprocessor(s,c));let l={firstWeekContainsDate:a,weekStartsOn:o,locale:i};return c.map(r=>{if(!r.isToken)return r.value;let a=r.value;(!n?.useAdditionalWeekYearTokens&&gp(a)||!n?.useAdditionalDayOfYearTokens&&hp(a))&&_p(a,t,String(e));let o=ap[a[0]];return o(s,a,i.localize,l)}).join(``)}function Tp(e){let t=e.match(xp);return t?t[1].replace(Sp,`'`):e}var Ep=`/api/v1/planet-position`,Dp=`planet-position-cache-db`,Op=`planet_positions`,kp=1,Ap=()=>new Promise((e,t)=>{let n=indexedDB.open(Dp,kp);n.onupgradeneeded=()=>{let e=n.result;e.objectStoreNames.contains(Op)||e.createObjectStore(Op,{keyPath:`key`})},n.onsuccess=()=>e(n.result),n.onerror=()=>t(n.error)}),jp=async e=>{try{let t=await Ap(),n=await new Promise((n,r)=>{let i=t.transaction(Op,`readonly`).objectStore(Op).get(e);i.onsuccess=()=>n(i.result??null),i.onerror=()=>r(i.error)});return t.close(),n}catch{return null}},Mp=async(e,t)=>{let n={key:e,...t};try{let e=await Ap();await new Promise((t,r)=>{let i=e.transaction(Op,`readwrite`).objectStore(Op).put(n);i.onsuccess=()=>t(),i.onerror=()=>r(i.error)}),e.close()}catch{}},Np=async e=>{try{let t=await Ap();await new Promise((n,r)=>{let i=t.transaction(Op,`readwrite`).objectStore(Op).delete(e);i.onsuccess=()=>n(),i.onerror=()=>r(i.error)}),t.close()}catch{}},Q={lerpFrame:60,accelerationOrbit:1,accelerationRotation:1,sunIntensity:2.1,zoomMinDistance:5,zoomMaxDistance:4500,isAnimating:!1,showOrbits:!0,showLabels:!0,showPlanets:!0},Pp=6.4,Fp=23.4,Ip=`Earth`,Lp=16777215,Rp=Pp/3.7,zp=27.322,Bp=2e-5,Vp=Pp*109/40,Hp=.001,Up=16775311,Wp=16646099,Gp=1.4,Kp=15265791,qp=8e4,Jp=.5,Yp=2.4,Xp=2.1,Zp=`Mercury`,Qp=39423,$p=6.1,em=177.4,tm=`Venus`,nm=16766720,rm=Pp*.53,im=25.2,am=`Mars`,om=16729344,sm=Pp*11,cm=3.13,lm=`Jupiter`,um=39168,dm=Pp*9.4,fm=26.7,pm=`Saturn`,mm=10053120,hm=Pp*4,gm=97.8,_m=`Uranus`,vm=6684825,ym=Pp*3.9,bm=28.3,xm=`Neptune`,Sm=3368703,Cm=1,wm=5,Tm=30,Em=90,Dm=120,Om=180,km=e=>{switch(e){case`JUPITER`:return Tm;case`MARS`:return wm;case`SATURN`:return Em;case`URANUS`:return Dm;case`NEPTUNE`:return Om;default:return Cm}},Am=e=>`${km(e)}days`,jm=e=>{switch(e){case`EARTH`:return Lp;case`MERCURY`:return Qp;case`VENUS`:return nm;case`MARS`:return om;case`JUPITER`:return um;case`SATURN`:return mm;case`URANUS`:return vm;case`NEPTUNE`:return Sm;default:return Lp}},Mm=e=>e*Math.PI/180,Nm=e=>new Promise(t=>setTimeout(t,e)),Pm=e=>/^(?:https?:)?\/\//.test(e)||e.startsWith(`data:`)||e.startsWith(`blob:`)?e:`/three-js-mini-solar-system/${e.replace(/^\.?\//,``)}`,Fm=e=>new Promise((t,n)=>{new td().load(Pm(e),e=>{t(e.scene)},void 0,e=>{n(e)})}),Im=`https://three-js-mini-solar-system.onrender.com`.replace(/\/+$/,``),Lm=`planet-position-cache:v2`,Rm=new Set([429,500,502,503,504]),zm=3,Bm=e=>{if(e.length===0)return e;let t=e[0],n=e[e.length-1];return t.equals(n)?e:[...e,t.clone()]},Vm=async e=>{let t=null;for(let n=0;n<=zm;n++)try{let t=await fetch(e);if(!t.ok){if(Rm.has(t.status)&&n<zm){await Nm(300*(n+1));continue}throw Error(`HTTP error! status: ${t.status}`)}return t}catch(e){if(t=e instanceof Error?e:Error(String(e)),n<zm){await Nm(300*(n+1));continue}}throw t??Error(`Planet position request failed`)},Hm=()=>Zf(new Date),Um=(e,t,n,r)=>`${Lm}:${e}:${t}:${n}:${r}`,Wm=async e=>{try{let t=await jp(e);if(!t)return null;if(!Array.isArray(t.pathPoints))return await Np(e),null;let n=t.pathPoints.map(e=>new U(e.x,e.y,e.z));return{todayRow:Hm(),pathPoints:n}}catch{return null}},Gm=async(e,t)=>{await Mp(e,{pathPoints:t.pathPoints.map(e=>({x:e.x,y:e.y,z:e.z}))})},Km=e=>{switch(e){case`EARTH`:return 365;case`MERCURY`:return 88;case`VENUS`:return 225;case`MARS`:return 687;case`JUPITER`:return 4333;case`SATURN`:return 10759;case`URANUS`:return 30687;case`NEPTUNE`:return 60190;default:return 364}},qm=e=>{switch(e){case`EARTH`:return 1;case`MERCURY`:return 58.6;case`VENUS`:return 243;case`MARS`:return 1.03;case`JUPITER`:return .41;case`SATURN`:return .45;case`URANUS`:return .72;case`NEPTUNE`:return .67;default:return 1}},Jm=async e=>{let t=new Date().getFullYear(),n=new Date(`${t}-01-01`),r=wp(n,`yyyy-MM-dd`),i=wp(wf(n,Km(e)),`yyyy-MM-dd`),a=Am(e),o=Um(e,r,i,a),s=await Wm(o);if(s)return s;await Nm(50);let c=`${Im}${Ep}?START_TIME=${r}&STOP_TIME=${i}&STEP_SIZE=${a}&COMMAND=${e}`,l={todayRow:0,pathPoints:[]};try{let e=await(await Vm(c)).json();if(e.result){let t=e.result.split(`
`).filter(e=>e.includes(`X =`)),n=[];t.forEach((e,t)=>{let r=e.split(/[X,Y,Z, =]/).filter(e=>e.trim()),i=parseFloat(r[0]),a=parseFloat(r[1]),o=parseFloat(r[2]);n.push({x:i,y:a,z:o,day:t+1})}),l.pathPoints=Bm(n.map(e=>new U(e.x*90,e.z*90,e.y*90)).reverse()),l.todayRow=Hm(),await Gm(o,l)}else console.error(`データの取得に失敗しました:`,e)}catch(e){console.error(`API呼び出し中にエラーが発生しました:`,e)}finally{return l}},Ym=({parent:e,commandKey:t,planetPositionsRes:n,radius:r=1,color:i})=>{let a=new ni(new ma(r,32,32),new Wr({color:i??jm(t),depthTest:!1,depthWrite:!1}));a.name=`${t}-current-position`,a.renderOrder=999;let{pathPoints:o,todayRow:s}=n,c=o.length-1,l=s-1,u=km(t),d=Math.floor(l/u)%c,f=(d+1)%c,p=l%u/u,m=o[d],h=o[f],g=new U().fromArray(m.toArray()).lerp(new U().fromArray(h.toArray()),p);return a.position.copy(g),e.add(a),a},$={PLANET_NAME:`Planet`,PLANET_ORBIT_NAME:`PlanetOrbit`,PLANET_RING_NAME:`PlanetRing`,PLANET_AXIS_NAME:`PlanetAxis`,PLANET_SYSTEM_NAME:`PlanetSystem`,PLANET_ATMO_SPHERE_NAME:`PlanetAtmosphere`,PLANET_MOONS_NAME:`PlanetMoons`,PLANET_LABEL_NAME:`PlanetLabel`},Xm={MERCURY:`Mercury（水星）`,VENUS:`Venus（金星）`,EARTH:`Earth（地球）`,MARS:`Mars（火星）`,JUPITER:`Jupiter（木星）`,SATURN:`Saturn（土星）`,URANUS:`Uranus（天王星）`,NEPTUNE:`Neptune（海王星）`,PLUTO:`Pluto（冥王星）`},Zm=(e,t,n,r,i,a,o,s,c,l,u,d=!1)=>{let f=new oo,p;p=a instanceof Fr?a:o?new Da({map:f.load(Pm(a)),bumpMap:f.load(Pm(o)),bumpScale:.7}):new Da({map:f.load(Pm(a))});let m=new ni(new ma(n,32,20),p);m.rotation.z=Mm(r),m.castShadow=!0,m.receiveShadow=!0,m.name=$.PLANET_NAME;let h=new On;h.name=$.PLANET_SYSTEM_NAME;let g=u.pathPoints.length-1,_=u.todayRow-1,v=km(e),y=Math.floor(_/v)%g,b=(y+1)%g,x=_%v/v,S=u.pathPoints[y],C=u.pathPoints[b],w=new U().fromArray(S.toArray()).lerp(new U().fromArray(C.toArray()),x);h.position.copy(w),h.add(m);let T=document.createElement(`div`);T.className=`planet-name-label`,T.textContent=Xm[e]??t;let E=new uf(T);E.name=$.PLANET_LABEL_NAME,E.position.set(0,n+3,0),h.add(E);let D=document.createElement(`div`);D.className=`planet-tilt-label`,D.textContent=`傾き: ${r}°`;let O=new uf(D);O.name=$.PLANET_LABEL_NAME,O.position.set(0,-(n+3),0),h.add(O);{let e=.1,t=new ni(new la(e,e,2.8*n,32),new Wr({color:65280}));t.name=$.PLANET_AXIS_NAME,t.rotation.z=Mm(r),h.add(t)}if(s){let e=new ni(new pa(s.innerRadius,s.outerRadius,30),new Ta({map:f.load(Pm(s.texture)),side:2}));e.name=$.PLANET_RING_NAME,e.rotation.x=Mm(90),e.rotation.y=Mm(r),h.add(e);let t=3.6;e.scale.set(t,t,t)}if(c){let e=new ni(new ma(n+.1,32,20),new Da({map:f.load(Pm(c)),transparent:!0,opacity:.4,depthTest:!0,depthWrite:!1}));e.name=$.PLANET_ATMO_SPHERE_NAME,e.rotation.z=.41,m.add(e)}let k=0;for(let e of l){let t;if(e.texture===void 0)continue;t=e.bump?new Ta({map:f.load(Pm(e.texture)),bumpMap:f.load(Pm(e.bump)),bumpScale:.5}):new Ta({map:f.load(Pm(e.texture))});let r=new ni(new ma(e.size,32,20),t);r.name=`${$.PLANET_MOONS_NAME}_${k}`,r.castShadow=!0,r.receiveShadow=!0,k++;let i=n*1.5;r.position.set(i,0,0),h.add(r),e.mesh=r}let A=new On;A.add(h),A.name=t,A.userData={planetPositionsRes:u};let j=new Gi(new Ar().setFromPoints(u.pathPoints),new Li({color:i,transparent:!0,opacity:.2}));return j.name=$.PLANET_ORBIT_NAME,A.add(j),d&&Ym({parent:A,commandKey:e,planetPositionsRes:u}),A},Qm={MOON:`${$.PLANET_MOONS_NAME}_Moon`},$m=[{size:Rp,texture:`/images/moonmap.jpg`,bump:`/images/moonbump.jpg`,orbitSpeed:.001*Q.accelerationOrbit,orbitRadius:10,orbitalPeriodDays:27.322}],eh=async(e,t)=>{let n=new oo,r=new Ca({uniforms:{dayTexture:{value:n.load(Pm(`/images/earth_daymap.jpg`))},nightTexture:{value:n.load(Pm(`/images/earth_nightmap.jpg`))},sunPosition:{value:e}},vertexShader:`
        varying vec3 vNormal;
        varying vec2 vUv;
      ...
      `}),i=await Jm(`EARTH`),a=Zm(`EARTH`,Ip,Pp,Fp,jm(`EARTH`),r,null,null,`/images/earth_atmosphere.jpg`,$m,i,t),o=a.getObjectByName($.PLANET_SYSTEM_NAME).children.find(e=>e.name.startsWith($.PLANET_MOONS_NAME));return o&&(o.name=Qm.MOON),a},th=(e,t,n)=>{e.position.set(...n),e.up.set(0,1,0),t.target.set(0,0,0),t.update()},nh=(e,t)=>{th(e,t,[190,0,.01])},rh=(e,t)=>{th(e,t,[0,20,122])},ih=(e,t,n)=>{let r=window.innerWidth,i=window.innerHeight;t.setSize(r,i),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),n?.setSize(r,i),e.aspect=r/i,e.updateProjectionMatrix()},ah=e=>{let t=new Date().getFullYear();return wp(wf(new Date(t,0,1),e),`yyyy年MM月dd日`)},oh=(e,t)=>{let n=document.createElement(`div`);n.className=`current-index-label`,n.setAttribute(`aria-live`,`polite`);let r=document.createElement(`div`);r.className=`current-index-label__chip current-index-label__chip--date`;let i=document.createElement(`span`);i.className=`current-index-label__caption`,i.textContent=`現在日付`;let a=document.createElement(`span`);a.className=`current-index-label__value`,a.textContent=ah(e),r.append(i,a);let o=document.createElement(`div`);o.className=`current-index-label__chip current-index-label__chip--zoom`;let s=document.createElement(`span`);s.className=`current-index-label__caption`,s.textContent=`ズーム距離`;let c=document.createElement(`span`);return c.className=`current-index-label__zoom`,c.textContent=`Zoom ${t}`,o.append(s,c),n.append(r,o),n},sh=(e,t)=>{let n=e.querySelector(`.current-index-label__value`);n&&(n.textContent=ah(t))},ch=(e,t)=>{let n=e.querySelector(`.current-index-label__zoom`);n&&(n.textContent=`Zoom ${t}`)},lh={...Q},uh=null,dh=null,fh=null,ph=null,mh=null,hh=null,gh=null,_h=null,vh=!1,yh=0,bh=!1,xh=new U,Sh=e=>e.toFixed(1),Ch=()=>!gh||!_h?0:gh.position.distanceTo(_h.target),wh=()=>{let e=Sh(Ch());hh&&ch(hh,e)},Th=e=>{if(!_h||(_h.minDistance=Q.zoomMinDistance,_h.maxDistance=Q.zoomMaxDistance,!e?.clampCamera||!gh))return;xh.subVectors(gh.position,_h.target),xh.lengthSq()===0&&xh.set(0,0,Q.zoomMinDistance);let t=xh.length(),n=jt.clamp(t,Q.zoomMinDistance,Q.zoomMaxDistance);if(Math.abs(n-t)<2**-52){wh();return}xh.setLength(n),gh.position.copy(_h.target).add(xh),_h.update()},Eh=()=>{!dh||!fh||!ph||(dh.classList.toggle(`is-collapsed`,vh),fh.hidden=vh,ph.classList.toggle(`is-collapsed`,vh),ph.textContent=vh?`設定を展開`:`設定を折りたたむ`,ph.setAttribute(`aria-expanded`,String(!vh)))},Dh=()=>{mh&&(mh.textContent=Q.isAnimating?`アニメーション停止`:`アニメーション再生`,mh.classList.toggle(`is-active`,Q.isAnimating),mh.setAttribute(`aria-pressed`,String(Q.isAnimating)),mh.title=bh?`惑星ズーム中は操作できません`:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,hh?.classList.toggle(`is-animating`,Q.isAnimating))},Oh=e=>{yh=e,hh&&sh(hh,e)},kh=e=>{bh=e,mh&&(mh.disabled=e,mh.classList.toggle(`is-disabled`,e),mh.setAttribute(`aria-disabled`,String(e)),Dh())},Ah=()=>{uh&&(uh.accelerationOrbit.value=String(Q.accelerationOrbit),uh.accelerationOrbitValue.value=String(Q.accelerationOrbit),uh.accelerationOrbitValue.textContent=String(Q.accelerationOrbit),uh.accelerationRotation.value=String(Q.accelerationRotation),uh.accelerationRotationValue.value=String(Q.accelerationRotation),uh.accelerationRotationValue.textContent=String(Q.accelerationRotation),uh.sunIntensity.value=String(Q.sunIntensity),uh.sunIntensityValue.value=String(Q.sunIntensity),uh.sunIntensityValue.textContent=String(Q.sunIntensity),Th({clampCamera:!0}),wh(),Dh(),uh.showOrbits.checked=Q.showOrbits,uh.showLabels.checked=Q.showLabels,Oh(yh),Eh())},jh=e=>{let{label:t,min:n,max:r,step:i,value:a,onChange:o}=e,s=document.createElement(`label`);s.className=`settings-menu__row settings-menu__row--range`;let c=document.createElement(`span`);c.className=`settings-menu__label`,c.textContent=t;let l=document.createElement(`input`);l.type=`range`,l.min=String(n),l.max=String(r),l.step=String(i),l.value=String(a),l.className=`settings-menu__range`;let u=document.createElement(`output`);return u.className=`settings-menu__value`,u.value=String(a),u.textContent=String(a),l.addEventListener(`input`,()=>{let e=Number(l.value);u.value=l.value,u.textContent=l.value,o(e)}),s.append(c,l,u),{row:s,input:l,output:u}},Mh=e=>{let{label:t,checked:n,onChange:r}=e,i=document.createElement(`label`);i.className=`settings-menu__row settings-menu__row--toggle`;let a=document.createElement(`input`);a.type=`checkbox`,a.checked=n,a.className=`settings-menu__checkbox`,a.addEventListener(`change`,()=>r(a.checked));let o=document.createElement(`span`);return o.className=`settings-menu__label`,o.textContent=t,i.append(a,o),{row:i,input:a}},Nh=e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`settings-menu__button`,t.textContent=e.label,t.addEventListener(`click`,e.onClick),t},Ph=e=>{let t=document.createElement(`p`);return t.className=`settings-menu__subtitle`,t.textContent=e,t},Fh=(e,t,n,r)=>{e.setSize(n,r),e.setClearColor(0,1),document.body.appendChild(e.domElement),t.background=new ao().load([Pm(`/images/3.jpg`),Pm(`/images/1.jpg`),Pm(`/images/2.jpg`),Pm(`/images/2.jpg`),Pm(`/images/4.jpg`),Pm(`/images/2.jpg`)]);let i=new gf;i.setSize(n,r),i.domElement.style.position=`absolute`,i.domElement.style.top=`0`,i.domElement.style.left=`0`,i.domElement.style.pointerEvents=`none`,i.domElement.style.zIndex=`10`,document.body.appendChild(i.domElement);let a=new bo(50,n/r,1,5e3);a.position.set(0,20,122),ih(a,e,i),window.addEventListener(`resize`,()=>ih(a,e,i));let o=new Nu(a,e.domElement);o.minDistance=Q.zoomMinDistance,o.maxDistance=Q.zoomMaxDistance,o.rotateSpeed=5,o.zoomSpeed=1.2,o.panSpeed=.8,o.keys=[``,``,``];let s=Lh(e,t,a,n,r);return Ih(t),{camera:a,controls:o,composer:s,labelRenderer:i}},Ih=e=>{let t=new Oo(2236962,10);e.add(t)},Lh=(e,t,n,r,i)=>{let a=new af(e);a.addPass(new sf(t,n));let o=new of(new H(r,i),t,n);o.edgeStrength=3,o.edgeGlow=1,o.visibleEdgeColor.set(16777215),o.hiddenEdgeColor.set(1640965),a.addPass(o);let s=new lf(new H(r,i),1,.4,.85);return s.threshold=1,s.radius=.9,a.addPass(s),a},Rh=e=>{let{sunMesh:t,camera:n,controls:r,onExitPlanetZoom:i,setDayIndex:a,setDayFraction:o,setFrameCount:s,userDataEarthPositionRes:c,currentIndex:l}=e,u=document.createElement(`section`);u.className=`settings-menu`,u.setAttribute(`aria-label`,`表示設定メニュー`);let d=document.createElement(`header`);d.className=`settings-menu__header`;let f=document.createElement(`div`);f.className=`settings-menu__heading`;let p=document.createElement(`p`);p.className=`settings-menu__title`,p.textContent=`表示設定`,f.append(p);let m=oh(l,Sh(n.position.distanceTo(r.target))),h=document.createElement(`button`);h.type=`button`,h.className=`settings-menu__collapse-button`,h.addEventListener(`click`,()=>{vh=!vh,Eh()}),d.append(f,m);let g=document.createElement(`div`);g.className=`settings-menu__sections`;let _=document.createElement(`section`);_.className=`settings-menu__section`;let v=Ph(`アニメーション`),y=jh({label:`公転スピード`,min:0,max:10,step:.1,value:Q.accelerationOrbit,onChange:e=>{Q.accelerationOrbit=e}}),b=jh({label:`自転スピード`,min:0,max:10,step:.1,value:Q.accelerationRotation,onChange:e=>{Q.accelerationRotation=e}}),x=jh({label:`太陽光強度`,min:0,max:10,step:.1,value:Q.sunIntensity,onChange:e=>{Q.sunIntensity=e,t.material.emissiveIntensity=e}}),S=Nh({label:Q.isAnimating?`アニメーション停止`:`アニメーション再生`,onClick:()=>{Q.isAnimating=!Q.isAnimating,Dh()}});S.classList.add(`settings-menu__button--primary`),S.setAttribute(`aria-pressed`,String(Q.isAnimating)),_.append(v,y.row,b.row,x.row,S);let C=document.createElement(`section`);C.className=`settings-menu__section`;let w=Ph(`表示`),T=document.createElement(`div`);T.className=`settings-menu__toggle-group`;let E=Mh({label:`公転軌道`,checked:Q.showOrbits,onChange:e=>{Q.showOrbits=e}}),D=Mh({label:`惑星名`,checked:Q.showLabels,onChange:e=>{Q.showLabels=e}});T.append(E.row,D.row),C.append(w,T);let O=document.createElement(`section`);O.className=`settings-menu__section settings-menu__section--actions`;let k=Ph(`視点`);O.append(k,Nh({label:`トップ`,onClick:()=>{i(),n.position.set(0,190,.01),r.target.set(0,0,0),r.update()}}),Nh({label:`サイド`,onClick:()=>{i(),nh(n,r)}}),Nh({label:`リセット`,onClick:()=>{i(),rh(n,r)}}),Nh({label:`設定を初期化`,onClick:()=>{Q.lerpFrame=lh.lerpFrame,Q.accelerationOrbit=lh.accelerationOrbit,Q.accelerationRotation=lh.accelerationRotation,Q.sunIntensity=lh.sunIntensity,Q.zoomMinDistance=lh.zoomMinDistance,Q.zoomMaxDistance=lh.zoomMaxDistance,Q.isAnimating=lh.isAnimating,Q.showOrbits=lh.showOrbits,Q.showLabels=lh.showLabels,Q.showPlanets=lh.showPlanets,t.material.emissiveIntensity=Q.sunIntensity,i(),rh(n,r);let e=c.todayRow-1;a(e),o(0),s(0),Oh(e),Ah()}})),u.append(d,g,h),g.append(_,O,C),document.body.appendChild(u),dh=u,fh=g,ph=h,mh=S,hh=m,gh=n,_h=r,Oh(l),kh(!1),uh={accelerationOrbit:y.input,accelerationOrbitValue:y.output,accelerationRotation:b.input,accelerationRotationValue:b.output,sunIntensity:x.input,sunIntensityValue:x.output,isAnimating:S,showOrbits:E.input,showLabels:D.input},r.addEventListener(`change`,wh),Ah()},zh={IO:`${$.PLANET_MOONS_NAME}_Io`,EUROPA:`${$.PLANET_MOONS_NAME}_Europa`,GANYMEDE:`${$.PLANET_MOONS_NAME}_Ganymede`,CALLISTO:`${$.PLANET_MOONS_NAME}_Callisto`},Bh=[{size:Pp*.29,texture:`/images/jupiterIo.jpg`,orbitRadius:20,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.8,xPosition:80},{size:Pp*.24,texture:`/images/jupiterEuropa.jpg`,orbitRadius:24,orbitSpeed:25e-5*Q.accelerationOrbit,orbitalPeriodDays:3.5,xPosition:90},{size:Pp*.41,texture:`/images/jupiterGanymede.jpg`,orbitRadius:28,orbitSpeed:125e-6*Q.accelerationOrbit,orbitalPeriodDays:7.1,xPosition:110},{size:Pp*.34,texture:`/images/jupiterCallisto.jpg`,orbitRadius:32,orbitSpeed:6e-5*Q.accelerationOrbit,orbitalPeriodDays:16.7,xPosition:140}],Vh=async e=>{let t=await Jm(`JUPITER`),n=Zm(`JUPITER`,lm,sm,cm,jm(`JUPITER`),`/images/jupiter.jpg`,null,null,null,Bh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=zh.IO),e===1&&(t.name=zh.EUROPA),e===2&&(t.name=zh.GANYMEDE),e===3&&(t.name=zh.CALLISTO),t.position.set(Bh[e].xPosition??0,0,0);return n},Hh={PHOBOS:`${$.PLANET_MOONS_NAME}_Phobos`,DEIMOS:`${$.PLANET_MOONS_NAME}_Deimos`},Uh=[{size:.1,orbitRadius:5,orbitSpeed:.002*Q.accelerationOrbit,orbitalPeriodDays:.319,modelPath:`/images/mars/phobos.glb`,xPosition:6},{size:.1,orbitRadius:12.5,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:1.263,modelPath:`/images/mars/deimos.glb`,xPosition:14}],Wh=async e=>{let t=await Jm(`MARS`),n=Zm(`MARS`,am,rm,im,jm(`MARS`),`/images/marsmap.jpg`,`/images/marsbump.jpg`,null,null,[],t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME);for(let[e,t]of Uh.entries())t.modelPath!==void 0&&(t.mesh=(await Fm(t.modelPath)).children[0],e===0&&(t.mesh.name=Hh.PHOBOS),e===1&&(t.mesh.name=Hh.DEIMOS),t.mesh.scale.set(t.size,t.size,t.size),t.mesh.position.set(t.xPosition??0,0,0),t.mesh.castShadow=!0,t.mesh.receiveShadow=!0,r.add(t.mesh));return n},Gh=async e=>{let t=await Jm(`MERCURY`);return Zm(`MERCURY`,Zp,Yp,Xp,jm(`MERCURY`),`/images/mercurymap.jpg`,`/images/mercurybump.jpg`,null,null,[],t,e)},Kh={TRITON:`${$.PLANET_MOONS_NAME}_Triton`,PROTEUS:`${$.PLANET_MOONS_NAME}_Proteus`,NEREID:`${$.PLANET_MOONS_NAME}_Nereid`},qh=[{size:Pp*.21,texture:`/images/Triton-tok.webp`,orbitRadius:14,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:5.88,xPosition:120,retrograde:!0},{size:Pp*.033,texture:`/images/Proteus.webp`,orbitRadius:10,orbitSpeed:35e-5*Q.accelerationOrbit,orbitalPeriodDays:1.12,xPosition:150},{size:Pp*.053,texture:`/images/Nereidimproved.webp`,orbitRadius:18,orbitSpeed:8e-5*Q.accelerationOrbit,orbitalPeriodDays:360.14,xPosition:210}],Jh=async e=>{let t=await Jm(`NEPTUNE`),n=Zm(`NEPTUNE`,xm,ym,bm,jm(`NEPTUNE`),`/images/neptune.jpg`,null,null,null,qh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Kh.TRITON),e===1&&(t.name=Kh.PROTEUS),e===2&&(t.name=Kh.NEREID),t.position.set(qh[e].xPosition??0,0,0);return n},Yh=e=>{let{renderer:t,camera:n,controls:r,planets:i,onResetView:a}=e,o=new Zo,s=new H,c=null,l=!1,u=Q.isAnimating,d=document.createElement(`button`),f=`PlanetHoverRimLight`,p=new Ca({uniforms:{rimColor:{value:new q(10080767)},rimPower:{value:2.6}},vertexShader:`
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1}),m=e=>{let n=t.domElement.getBoundingClientRect();s.x=(e.clientX-n.left)/n.width*2-1,s.y=-((e.clientY-n.top)/n.height)*2+1};d.type=`button`,d.className=`planet-zoom-close-button`,d.textContent=`視点をリセット`,d.title=`視点をリセット`,d.setAttribute(`aria-label`,`視点をリセット`),d.hidden=!0,d.addEventListener(`click`,()=>{a()}),document.body.appendChild(d);let h=(e,t)=>{let n=e.getObjectByName(f);if(t){if(n)return;let t=new ni(e.geometry,p);t.name=f,t.scale.setScalar(1.04),e.add(t);return}n&&e.remove(n)},g=()=>{c&&=(h(c,!1),null)},_=()=>l?(g(),l=!1,Q.isAnimating=u,Ah(),kh(!1),d.hidden=!0,!0):!1,v=()=>{d.hidden=!1},y=e=>{let t=new U;e.getWorldPosition(t);let i=e.geometry;i.computeBoundingSphere();let a=i.boundingSphere?.radius??1,o=new U;e.getWorldScale(o);let s=a*Math.max(o.x,o.y,o.z)/Math.tan(Mm(n.fov)/2)*1.35,c=new U().subVectors(n.position,r.target);c.lengthSq()===0&&c.set(0,0,1),c.normalize(),n.position.copy(t).add(c.multiplyScalar(s)),r.target.copy(t),r.update()};return{handleDoubleClickPlanetZoom:e=>{m(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1);if(t.length===0)return;let r=t[0].object;l||(u=Q.isAnimating,Q.isAnimating=!1,Ah(),l=!0,kh(!0)),v(),y(r)},handlePlanetHover:e=>{m(e),o.setFromCamera(s,n);let t=o.intersectObjects(i,!1)[0]?.object;if(!(t instanceof ni)){g();return}c!==t&&(g(),c=t,h(t,!0))},clearPlanetHover:g,exitPlanetZoom:_}},Xh={TITAN:`${$.PLANET_MOONS_NAME}_Titan`,RHEA:`${$.PLANET_MOONS_NAME}_Rhea`,IAPETUS:`${$.PLANET_MOONS_NAME}_Iapetus`,MIMAS:`${$.PLANET_MOONS_NAME}_Mimas`,ENCELADUS:`${$.PLANET_MOONS_NAME}_Enceladus`},Zh=[{size:Pp*.4,texture:`/images/RS3_Titan.webp`,orbitRadius:16,orbitSpeed:9e-5*Q.accelerationOrbit,orbitalPeriodDays:15.95,xPosition:137},{size:Pp*.12,texture:`/images/RS3_Rhea.webp`,orbitRadius:12,orbitSpeed:18e-5*Q.accelerationOrbit,orbitalPeriodDays:4.52,xPosition:116},{size:Pp*.115,texture:`/images/LapetusNew.webp`,orbitRadius:22,orbitSpeed:1e-5*Q.accelerationOrbit,orbitalPeriodDays:79.3,xPosition:180},{size:Pp*.031,texture:`/images/RS3_Mimas.webp`,orbitRadius:8,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:.942,xPosition:102},{size:Pp*.04,texture:`/images/Enceladus.webp`,orbitRadius:10,orbitSpeed:45e-5*Q.accelerationOrbit,orbitalPeriodDays:1.37,xPosition:110}],Qh=async e=>{let t=await Jm(`SATURN`),n=Zm(`SATURN`,pm,dm,fm,jm(`SATURN`),`/images/saturnmap.jpg`,null,{innerRadius:18,outerRadius:29,texture:`/images/saturn_ring.png`},null,Zh,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=Xh.TITAN),e===1&&(t.name=Xh.RHEA),e===2&&(t.name=Xh.IAPETUS),e===3&&(t.name=Xh.MIMAS),e===4&&(t.name=Xh.ENCELADUS),t.position.set(Zh[e].xPosition??0,0,0);return n},$h=`Sun`,eg=new Ta({emissive:Up,emissiveMap:new oo().load(Pm(`/images/sun.jpg`)),emissiveIntensity:Q.sunIntensity}),tg=()=>{let e=new ni(new ma(Vp,32,20),eg);e.name=$h;let t=new wo(Wp,100,0,Gp),n=new wo(Kp,20,qp,Jp);return e.add(t),e.add(n),e},ng={MIRANDA:`${$.PLANET_MOONS_NAME}_Miranda`,ARIEL:`${$.PLANET_MOONS_NAME}_Ariel`,UMBRIEL:`${$.PLANET_MOONS_NAME}_Umbriel`,TITANIA:`${$.PLANET_MOONS_NAME}_Titania`,OBERON:`${$.PLANET_MOONS_NAME}_Oberon`},rg=[{size:Pp*.037,texture:`/images/Miranda-0.webp`,orbitRadius:10,orbitSpeed:7e-4*Q.accelerationOrbit,orbitalPeriodDays:1.41,xPosition:58},{size:Pp*.084,texture:`/images/Ariel-0.webp`,orbitRadius:10,orbitSpeed:5e-4*Q.accelerationOrbit,orbitalPeriodDays:2.52,xPosition:90},{size:Pp*.07,texture:`/images/Uranus-0.webp`,orbitRadius:10,orbitSpeed:4e-4*Q.accelerationOrbit,orbitalPeriodDays:4.14,xPosition:120},{size:Pp*.11,texture:`/images/Titaniamap.webp`,orbitRadius:10,orbitSpeed:3e-4*Q.accelerationOrbit,orbitalPeriodDays:8.71,xPosition:150},{size:Pp*.105,texture:`/images/Oberonmap1.webp`,orbitRadius:10,orbitSpeed:2e-4*Q.accelerationOrbit,orbitalPeriodDays:13.46,xPosition:180}],ig=async e=>{let t=await Jm(`URANUS`),n=Zm(`URANUS`,_m,hm,gm,jm(`URANUS`),`/images/uranus.jpg`,null,{innerRadius:8,outerRadius:10,texture:`/images/uranus_ring.png`},null,rg,t,e),r=n.getObjectByName($.PLANET_SYSTEM_NAME).children.filter(e=>e.name.startsWith($.PLANET_MOONS_NAME));for(let[e,t]of r.entries())e===0&&(t.name=ng.MIRANDA),e===1&&(t.name=ng.ARIEL),e===2&&(t.name=ng.UMBRIEL),e===3&&(t.name=ng.TITANIA),e===4&&(t.name=ng.OBERON),t.position.set(rg[e].xPosition??0,0,0);return n},ag=async e=>{let t=await Jm(`VENUS`);return Zm(`VENUS`,tm,$p,em,jm(`VENUS`),`/images/venusmap.jpg`,`/images/venusbump.jpg`,null,`/images/venus_atmosphere.jpg`,[],t,e)};function og(e,t,n){let{earthPlanetSystem:r,earthPlanet:i,earthAtmosphere:a,moon:o}=t;{let t=n.pathPoints.length-1,o=e.dayIndex%t,s=n.pathPoints[o],c=(o+1)%t,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Mm(360/Q.lerpFrame*Q.accelerationRotation);i.rotateY(u),a.rotateY(u+Bp)}{let t=Mm(5),n=Mm(360/(zp*Q.lerpFrame)*Q.accelerationOrbit),r=e.frameCount*n,{orbitRadius:i}=$m[0],a=i*Math.cos(r),s=i*Math.sin(r)*Math.sin(t),c=i*Math.sin(r)*Math.cos(t);o.position.set(-a,s,c);let l=n;o.rotateY(l)}}function sg(e,t,n){let{mercuryPlanetSystem:r,mercuryPlanet:i}=t,a=n.pathPoints.length-1,o=e.dayIndex%a,s=n.pathPoints[o],c=(o+1)%a,l=n.pathPoints[c];e.buf.copy(s).lerp(l,e.dayFraction),r.position.copy(e.buf);let u=Mm(360/(Q.lerpFrame*qm(`MERCURY`))*Q.accelerationRotation);i.rotateY(u)}function cg(e,t,n){let{venusPlanetSystem:r,venusPlanet:i,venusAtmosphere:a}=t,o=n.pathPoints.length-1,s=e.dayIndex%o,c=n.pathPoints[s],l=(s+1)%o,u=n.pathPoints[l];e.buf.copy(c).lerp(u,e.dayFraction),r.position.copy(e.buf);let d=Mm(360/(Q.lerpFrame*qm(`VENUS`))*Q.accelerationRotation);i.rotateY(d),a.rotateY(d*60)}function lg(e,t,n){let{marsPlanetSystem:r,marsPlanet:i,phobos:a,deimos:o}=t,s=km(`MARS`),c=n.pathPoints.length-1,l=e.dayIndex+e.dayFraction,u=Math.floor(l/s)%c,d=n.pathPoints[u],f=(u+1)%c,p=n.pathPoints[f],m=l%s/s;e.buf.copy(d).lerp(p,m),r.position.copy(e.buf);let h=Mm(360/(Q.lerpFrame*qm(`MARS`))*Q.accelerationRotation);i.rotateY(h);let g=Uh[0].orbitRadius,_=Uh[1].orbitRadius,v=e.frameCount*Q.accelerationOrbit*4,y=e.frameCount*Q.accelerationOrbit*1,b=g*Math.cos(v),x=g*Math.sin(v);a.position.set(-b,0,x);let S=_*Math.cos(y),C=_*Math.sin(y);o.position.set(-S,0,C)}function ug(e,t,n){let{jupiterPlanetSystem:r,jupiterPlanet:i,io:a,europa:o,ganymede:s,callisto:c}=t,l=km(`JUPITER`),u=n.pathPoints.length-1,d=e.dayIndex+e.dayFraction,f=Math.floor(d/l)%u,p=n.pathPoints[f],m=(f+1)%u,h=n.pathPoints[m],g=d%l/l;e.buf.copy(p).lerp(h,g),r.position.copy(e.buf);let _=Mm(360/(Q.lerpFrame*qm(`JUPITER`))*Q.accelerationRotation);i.rotateY(_);{let t=Bh[0].orbitRadius+(Bh[0].xPosition??0),n=Bh[1].orbitRadius+(Bh[1].xPosition??0),r=Bh[2].orbitRadius+(Bh[2].xPosition??0),i=Bh[3].orbitRadius+(Bh[3].xPosition??0),l=e.frameCount*Q.accelerationOrbit*(1/Bh[0].orbitalPeriodDays),u=e.frameCount*Q.accelerationOrbit*(1/Bh[1].orbitalPeriodDays),d=e.frameCount*Q.accelerationOrbit*(1/Bh[2].orbitalPeriodDays),f=e.frameCount*Q.accelerationOrbit*(1/Bh[3].orbitalPeriodDays),p=t*Math.cos(l),m=t*Math.sin(l);a.position.set(-p,0,m);let h=n*Math.cos(u),g=n*Math.sin(u);o.position.set(-h,0,g);let _=r*Math.cos(d),v=r*Math.sin(d);s.position.set(-_,0,v);let y=i*Math.cos(f),b=i*Math.sin(f);c.position.set(-y,0,b)}}function dg(e,t,n){let{saturnPlanetSystem:r,saturnPlanet:i,titan:a,rhea:o,iapetus:s,mimas:c,enceladus:l}=t,u=km(`SATURN`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Mm(360/(Q.lerpFrame*qm(`SATURN`))*Q.accelerationRotation);i.rotateY(v);{let t=Mm(fm),n=Zh[0].orbitRadius+(Zh[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/Zh[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=Zh[1].orbitRadius+(Zh[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/Zh[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=Zh[2].orbitRadius+(Zh[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/Zh[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=Zh[3].orbitRadius+(Zh[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/Zh[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=Zh[4].orbitRadius+(Zh[4].xPosition??0),ee=e.frameCount*Q.accelerationOrbit*(1/Zh[4].orbitalPeriodDays),M=-j*Math.cos(ee),te=j*Math.sin(ee),ne=M*Math.cos(t),N=M*Math.sin(t);l.position.set(ne,N,te)}}function fg(e,t,n){let{uranusPlanetSystem:r,uranusPlanet:i,miranda:a,ariel:o,umbriel:s,titania:c,oberon:l}=t,u=km(`URANUS`),d=n.pathPoints.length-1,f=e.dayIndex+e.dayFraction,p=Math.floor(f/u)%d,m=n.pathPoints[p],h=(p+1)%d,g=n.pathPoints[h],_=f%u/u;e.buf.copy(m).lerp(g,_),r.position.copy(e.buf);let v=Mm(360/(Q.lerpFrame*qm(`URANUS`))*Q.accelerationRotation);i.rotateY(v);{let t=Mm(gm),n=rg[0].orbitRadius+(rg[0].xPosition??0),r=e.frameCount*Q.accelerationOrbit*(1/rg[0].orbitalPeriodDays),i=-n*Math.cos(r),u=n*Math.sin(r),d=i*Math.cos(t),f=i*Math.sin(t);a.position.set(d,f,u);let p=rg[1].orbitRadius+(rg[1].xPosition??0),m=e.frameCount*Q.accelerationOrbit*(1/rg[1].orbitalPeriodDays),h=-p*Math.cos(m),g=p*Math.sin(m),_=h*Math.cos(t),v=h*Math.sin(t);o.position.set(_,v,g);let y=rg[2].orbitRadius+(rg[2].xPosition??0),b=e.frameCount*Q.accelerationOrbit*(1/rg[2].orbitalPeriodDays),x=-y*Math.cos(b),S=y*Math.sin(b),C=x*Math.cos(t),w=x*Math.sin(t);s.position.set(C,w,S);let T=rg[3].orbitRadius+(rg[3].xPosition??0),E=e.frameCount*Q.accelerationOrbit*(1/rg[3].orbitalPeriodDays),D=-T*Math.cos(E),O=T*Math.sin(E),k=D*Math.cos(t),A=D*Math.sin(t);c.position.set(k,A,O);let j=rg[4].orbitRadius+(rg[4].xPosition??0),ee=e.frameCount*Q.accelerationOrbit*(1/rg[4].orbitalPeriodDays),M=-j*Math.cos(ee),te=j*Math.sin(ee),ne=M*Math.cos(t),N=M*Math.sin(t);l.position.set(ne,N,te)}}function pg(e,t,n){let{neptunePlanetSystem:r,neptunePlanet:i,triton:a,proteus:o,nereid:s}=t,c=km(`NEPTUNE`),l=n.pathPoints.length-1,u=e.dayIndex+e.dayFraction,d=Math.floor(u/c)%l,f=n.pathPoints[d],p=(d+1)%l,m=n.pathPoints[p],h=u%c/c;e.buf.copy(f).lerp(m,h),r.position.copy(e.buf);let g=Mm(360/(Q.lerpFrame*qm(`NEPTUNE`))*Q.accelerationRotation);i.rotateY(g);{let t=Mm(bm),n=qh[0].orbitRadius+(qh[0].xPosition??0),r=(qh[0].retrograde?-1:1)*e.frameCount*Q.accelerationOrbit*(1/qh[0].orbitalPeriodDays),i=-n*Math.cos(r),c=n*Math.sin(r),l=i*Math.cos(t),u=i*Math.sin(t);a.position.set(l,u,c);let d=qh[1].orbitRadius+(qh[1].xPosition??0),f=e.frameCount*Q.accelerationOrbit*(1/qh[1].orbitalPeriodDays),p=-d*Math.cos(f),m=d*Math.sin(f),h=p*Math.cos(t),g=p*Math.sin(t);o.position.set(h,g,m);let _=qh[2].orbitRadius+(qh[2].xPosition??0),v=e.frameCount*Q.accelerationOrbit*(1/qh[2].orbitalPeriodDays),y=-_*Math.cos(v),b=_*Math.sin(v),x=y*Math.cos(t),S=y*Math.sin(t);s.position.set(x,S,b)}}var mg=5e3,hg=5,gg=185,_g=275,vg=30,yg=class{permutation;constructor(e){this.permutation=this.generatePermutation(e)}generatePermutation(e){let t=Array.from({length:256},(e,t)=>t);for(let n=255;n>0;n--){let r=this.seededRandom(e+n),i=Math.floor(r*(n+1));[t[n],t[i]]=[t[i],t[n]]}return[...t,...t]}seededRandom(e){let t=Math.sin(e)*1e4;return t-Math.floor(t)}fade(e){return e*e*e*(e*(e*6-15)+10)}lerp(e,t,n){return t+e*(n-t)}grad(e,t,n,r){let i=e&15,a=i<8?t:n,o=i<8?n:r;return(i&1?-a:a)+(i&2?-o:o)}noise(e,t,n){let r=Math.floor(e)&255,i=Math.floor(t)&255,a=Math.floor(n)&255,o=e-Math.floor(e),s=t-Math.floor(t),c=n-Math.floor(n),l=this.fade(o),u=this.fade(s),d=this.fade(c),f=this.permutation,p=f[f[f[r]+i]+a],m=f[f[f[r]+i+1]+a],h=f[f[f[r]+i]+a+1],g=f[f[f[r]+i+1]+a+1],_=f[f[f[r+1]+i]+a],v=f[f[f[r+1]+i+1]+a],y=f[f[f[r+1]+i]+a+1],b=f[f[f[r+1]+i+1]+a+1],x=this.grad(p,o,s,c),S=this.grad(_,o-1,s,c),C=this.grad(m,o,s-1,c),w=this.grad(v,o-1,s-1,c),T=this.grad(h,o,s,c-1),E=this.grad(y,o-1,s,c-1),D=this.grad(g,o,s-1,c-1),O=this.grad(b,o-1,s-1,c-1),k=this.lerp(l,x,S),A=this.lerp(l,C,w),j=this.lerp(u,k,A),ee=this.lerp(l,T,E),M=this.lerp(l,D,O),te=this.lerp(u,ee,M);return this.lerp(d,j,te)}fbm(e,t,n,r=4){let i=0,a=1,o=1,s=0;for(let c=0;c<r;c++)i+=a*this.noise(e*o,t*o,n*o),s+=a,a*=.5,o*=2;return i/s}};function bg(e){let t=new da(1,4),n=t.getAttribute(`position`),r=n.array,i=new yg(e);for(let e=0;e<r.length;e+=3){let t=r[e],n=r[e+1],a=r[e+2],o=Math.sqrt(t*t+n*n+a*a),s=t/o,c=n/o,l=a/o,u=i.fbm(t*2,n*2,a*2,3)*.3;r[e]=t+s*u,r[e+1]=n+c*u,r[e+2]=a+l*u}return n.needsUpdate=!0,t.computeVertexNormals(),t}var xg=class{group;instancedMeshes=[];constructor(){this.group=new On,this.group.name=`AsteroidBelt`,this.initAsteroidBelt()}initAsteroidBelt(){let e=[];for(let t=0;t<hg;t++)e.push(bg(t*12345));let t=Math.floor(mg/hg);e.forEach((e,n)=>{let r=new Oi(e,this.createRockMaterial(n),t);r.castShadow=!0,r.receiveShadow=!0;let i=new K;for(let e=0;e<t;e++){let t=Math.random()*Math.PI*2,n=gg+Math.random()*(_g-gg),a=(Math.random()-.5)*vg,o=Math.cos(t)*n,s=Math.sin(t)*n,c=a,l=new Mt;l.setFromEuler(new un(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2));let u=.3+Math.random()*.7,d=u*(.8+Math.random()*.4),f=u*(.8+Math.random()*.4),p=u*(.8+Math.random()*.4);i.compose(new U(o,c,s),l,new U(d,f,p)),r.setMatrixAt(e,i)}r.instanceMatrix.needsUpdate=!0,this.instancedMeshes.push(r),this.group.add(r)})}createRockMaterial(e){let t=[9139029,6908265,8421504,7036244,4868682];return new Ta({color:t[e%t.length],metalness:.3+Math.random()*.2,roughness:.7+Math.random()*.2})}animate(e=.016){this.instancedMeshes.forEach(t=>{t.rotation.y+=e*.015})}getGroup(){return this.group}},Sg=!0,Cg=class{loadingScreen=document.getElementById(`loading-screen`);loadingStatus=document.getElementById(`loading-status`);renderer=new vu;scene=new In;camera;controls;composer;labelRenderer;zoomablePlanets=[];planetInteractionController;sunMesh;earthGroup;mercuryGroup;venusGroup;marsGroup;jupiterGroup;saturnGroup;uranusGroup;neptuneGroup;asteroidBelt;dayFraction=0;dayIndex=0;timer=new Io;frameCount=0;_cachedMeshes;_interpolatedPos=new U;_prevShowOrbits=Q.showOrbits;_prevShowLabels=Q.showLabels;_prevShowPlanets=Q.showPlanets;resetPlanetZoomView=()=>{this.planetInteractionController.exitPlanetZoom()&&rh(this.camera,this.controls)};constructor(){let{camera:e,controls:t,composer:n,labelRenderer:r}=Fh(this.renderer,this.scene,this.width,this.height);this.camera=e,this.controls=t,this.composer=n,this.labelRenderer=r,this.updateLoadingState(`太陽系データを読み込み中...`),this.initPlanets().catch(e=>{this.showLoadingError(`読み込みに失敗しました。ページを再読み込みしてください。`)})}get userDataEarthPositionRes(){return this.earthGroup.userData.planetPositionsRes}get width(){return window.innerWidth}get height(){return window.innerHeight}async initPlanets(){this.updateLoadingState(`太陽と地球を読み込み中...`),this.sunMesh=tg(),this.scene.add(this.sunMesh),this.earthGroup=await eh(this.sunMesh.position,Sg),this.dayIndex=this.userDataEarthPositionRes.todayRow-1,this.scene.add(this.earthGroup),this.updateLoadingState(`水星を読み込み中...`);let e=await Gh(Sg);this.updateLoadingState(`金星を読み込み中...`);let t=await ag(Sg);this.updateLoadingState(`火星を読み込み中...`);let n=await Wh(Sg);this.updateLoadingState(`木星を読み込み中...`);let r=await Vh(Sg);this.updateLoadingState(`土星を読み込み中...`);let i=await Qh(Sg);this.updateLoadingState(`天王星を読み込み中...`);let a=await ig(Sg);this.updateLoadingState(`海王星を読み込み中...`);let o=await Jh(Sg);this.mercuryGroup=e,this.scene.add(e),this.venusGroup=t,this.scene.add(t),this.marsGroup=n,this.scene.add(n),this.jupiterGroup=r,this.scene.add(r),this.saturnGroup=i,this.scene.add(i),this.uranusGroup=a,this.scene.add(a),this.neptuneGroup=o,this.scene.add(o),this.updateLoadingState(`小惑星帯を生成中...`),this.asteroidBelt=new xg,this.scene.add(this.asteroidBelt.getGroup()),this.initDoubleClickZoom(),Rh({sunMesh:this.sunMesh,camera:this.camera,controls:this.controls,onExitPlanetZoom:()=>{this.planetInteractionController.exitPlanetZoom()},setDayIndex:e=>{this.dayIndex=e},setDayFraction:e=>{this.dayFraction=e},setFrameCount:e=>{this.frameCount=e},userDataEarthPositionRes:this.userDataEarthPositionRes,currentIndex:this.dayIndex}),this._initMeshCache(),this.updateLoadingState(`描画を開始中...`),this.renderer.setAnimationLoop(()=>this.render()),this.render(),window.requestAnimationFrame(()=>this.hideLoadingScreen())}updateLoadingState(e){this.loadingStatus&&(this.loadingStatus.textContent=e)}hideLoadingScreen(){this.loadingScreen&&(this.loadingScreen.classList.add(`is-hidden`),window.setTimeout(()=>this.loadingScreen?.remove(),400))}showLoadingError(e){this.loadingScreen&&(this.loadingScreen.classList.add(`is-error`),this.updateLoadingState(e))}_initMeshCache(){this._cachedMeshes={earthPlanetSystem:this.earthGroup.getObjectByName($.PLANET_SYSTEM_NAME),earthPlanet:this.earthGroup.getObjectByName($.PLANET_NAME),earthAtmosphere:this.earthGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),moon:this.earthGroup.getObjectByName(Qm.MOON),mercuryPlanetSystem:this.mercuryGroup.getObjectByName($.PLANET_SYSTEM_NAME),mercuryPlanet:this.mercuryGroup.getObjectByName($.PLANET_NAME),venusPlanetSystem:this.venusGroup.getObjectByName($.PLANET_SYSTEM_NAME),venusPlanet:this.venusGroup.getObjectByName($.PLANET_NAME),venusAtmosphere:this.venusGroup.getObjectByName($.PLANET_ATMO_SPHERE_NAME),marsPlanetSystem:this.marsGroup.getObjectByName($.PLANET_SYSTEM_NAME),marsPlanet:this.marsGroup.getObjectByName($.PLANET_NAME),phobos:this.marsGroup.getObjectByName(Hh.PHOBOS),deimos:this.marsGroup.getObjectByName(Hh.DEIMOS),jupiterPlanetSystem:this.jupiterGroup.getObjectByName($.PLANET_SYSTEM_NAME),jupiterPlanet:this.jupiterGroup.getObjectByName($.PLANET_NAME),io:this.jupiterGroup.getObjectByName(zh.IO),europa:this.jupiterGroup.getObjectByName(zh.EUROPA),ganymede:this.jupiterGroup.getObjectByName(zh.GANYMEDE),callisto:this.jupiterGroup.getObjectByName(zh.CALLISTO),saturnPlanetSystem:this.saturnGroup.getObjectByName($.PLANET_SYSTEM_NAME),saturnPlanet:this.saturnGroup.getObjectByName($.PLANET_NAME),titan:this.saturnGroup.getObjectByName(Xh.TITAN),rhea:this.saturnGroup.getObjectByName(Xh.RHEA),iapetus:this.saturnGroup.getObjectByName(Xh.IAPETUS),mimas:this.saturnGroup.getObjectByName(Xh.MIMAS),enceladus:this.saturnGroup.getObjectByName(Xh.ENCELADUS),uranusPlanetSystem:this.uranusGroup.getObjectByName($.PLANET_SYSTEM_NAME),uranusPlanet:this.uranusGroup.getObjectByName($.PLANET_NAME),miranda:this.uranusGroup.getObjectByName(ng.MIRANDA),ariel:this.uranusGroup.getObjectByName(ng.ARIEL),umbriel:this.uranusGroup.getObjectByName(ng.UMBRIEL),titania:this.uranusGroup.getObjectByName(ng.TITANIA),oberon:this.uranusGroup.getObjectByName(ng.OBERON),neptunePlanetSystem:this.neptuneGroup.getObjectByName($.PLANET_SYSTEM_NAME),neptunePlanet:this.neptuneGroup.getObjectByName($.PLANET_NAME),triton:this.neptuneGroup.getObjectByName(Kh.TRITON),proteus:this.neptuneGroup.getObjectByName(Kh.PROTEUS),nereid:this.neptuneGroup.getObjectByName(Kh.NEREID)}}initDoubleClickZoom(){let e=this.earthGroup.getObjectByName($.PLANET_NAME),t=this.mercuryGroup.getObjectByName($.PLANET_NAME),n=this.venusGroup.getObjectByName($.PLANET_NAME),r=this.marsGroup.getObjectByName($.PLANET_NAME),i=this.jupiterGroup.getObjectByName($.PLANET_NAME),a=this.saturnGroup.getObjectByName($.PLANET_NAME),o=this.uranusGroup.getObjectByName($.PLANET_NAME),s=this.neptuneGroup.getObjectByName($.PLANET_NAME);this.zoomablePlanets=[e,t,n,r,i,a,o,s].filter(e=>e instanceof ni),this.planetInteractionController=Yh({renderer:this.renderer,camera:this.camera,controls:this.controls,planets:this.zoomablePlanets,onResetView:this.resetPlanetZoomView}),this.renderer.domElement.addEventListener(`dblclick`,this.planetInteractionController.handleDoubleClickPlanetZoom),this.renderer.domElement.addEventListener(`pointermove`,this.planetInteractionController.handlePlanetHover),this.renderer.domElement.addEventListener(`pointerleave`,this.planetInteractionController.clearPlanetHover)}render(){this.controls.update(),this.composer.render(),this.labelRenderer.render(this.scene,this.camera),Q.isAnimating&&this.animate(),this.#e()}#e(){(Q.showOrbits!==this._prevShowOrbits||Q.showLabels!==this._prevShowLabels||Q.showPlanets!==this._prevShowPlanets)&&(this._prevShowOrbits=Q.showOrbits,this._prevShowLabels=Q.showLabels,this._prevShowPlanets=Q.showPlanets,[this.earthGroup,this.mercuryGroup,this.venusGroup,this.marsGroup,this.jupiterGroup,this.saturnGroup,this.uranusGroup,this.neptuneGroup].forEach(e=>{let t=e.getObjectByName($.PLANET_ORBIT_NAME);t&&(t.visible=Q.showOrbits),e.traverse(e=>{(e.name===$.PLANET_NAME||e.name===$.PLANET_RING_NAME||e.name===$.PLANET_AXIS_NAME||e.name===$.PLANET_ATMO_SPHERE_NAME||e.name.startsWith($.PLANET_MOONS_NAME)||e.name.endsWith(`-current-position`))&&(e.visible=Q.showPlanets),e.name===$.PLANET_LABEL_NAME&&(e.visible=Q.showLabels)})}))}animate(){this.frameCount++,this.sunMesh.rotateY(Hp*Q.accelerationRotation),Oh(this.dayIndex),this.dayFraction=Number(((this.dayFraction+1/Q.lerpFrame)*Q.accelerationOrbit).toFixed(3)),this.dayFraction>=1&&(this.dayIndex+=1,this.dayFraction=0);let e={dayIndex:this.dayIndex,dayFraction:this.dayFraction,frameCount:this.frameCount,buf:this._interpolatedPos};og(e,this._cachedMeshes,this.userDataEarthPositionRes),sg(e,this._cachedMeshes,this.mercuryGroup.userData.planetPositionsRes),cg(e,this._cachedMeshes,this.venusGroup.userData.planetPositionsRes),lg(e,this._cachedMeshes,this.marsGroup.userData.planetPositionsRes),ug(e,this._cachedMeshes,this.jupiterGroup.userData.planetPositionsRes),dg(e,this._cachedMeshes,this.saturnGroup.userData.planetPositionsRes),fg(e,this._cachedMeshes,this.uranusGroup.userData.planetPositionsRes),pg(e,this._cachedMeshes,this.neptuneGroup.userData.planetPositionsRes),this.asteroidBelt.animate(.016)}};window.addEventListener(`DOMContentLoaded`,()=>{new Cg});